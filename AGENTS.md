...
Current user-directed work is Emerald Studio (tools/studio), a local Codex-browser
development workspace using native libmGBA. Team reviews, the earned playthrough

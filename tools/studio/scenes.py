...
class Recorder:
    ...
    def finish(self,packet,outcome=None):
        ...
        assisted={
            "fixture_win":"automatic wild capture / forced trainer win",
            "fixture_defeat":"forced victory without capture",
            "fixture_loss":"forced loss",
        }.get((outcome or {}).get("battle_resolution"))
        if assisted:
            spec["scope"]=f"Synthetic setup; {assisted}. Native scenes only, NOT combat validation."

...
enum EmeraldChampionsHeadlessScenario
{
    ...
    EC_HEADLESS_SCENARIO_MOVE_REPLACEMENT,
    ...
    EC_HEADLESS_SCENARIO_LEAF_SCENE,
    EC_HEADLESS_SCENARIO_SECRET_BASE_ESTABLISHED,
    EC_HEADLESS_SCENARIO_NEW_MAUVILLE_BUTTONS,
    EC_HEADLESS_SCENARIO_RUSTBORO_GUIDE_RETRY,
    EC_HEADLESS_SCENARIO_STORY_HANDOFF,
    EC_HEADLESS_SCENARIO_RYDEL_RETRY,
    EC_HEADLESS_SCENARIO_ROUTE110_RETRY,
    EC_HEADLESS_SCENARIO_BOOK_RESEARCH,
    EC_HEADLESS_SCENARIO_CAMPAIGN_NATIVE,
    EC_HEADLESS_SCENARIO_BERRY_ECONOMY,
...
{
    EC_HEADLESS_LEAF_COMPLETED,
    EC_HEADLESS_LEAF_PENDING_FULL_BAG,
    EC_HEADLESS_LEAF_INSUFFICIENT_PARTY,
    EC_HEADLESS_LEAF_FIRST_BATTLE,
};
...
enum EmeraldChampionsHeadlessCampaignQuery
{
    ...
    EC_HEADLESS_CAMPAIGN_QUERY_ITEM,
    EC_HEADLESS_CAMPAIGN_QUERY_PC_ITEM,
    EC_HEADLESS_CAMPAIGN_QUERY_LEGENDARY_ELIGIBLE,
    EC_HEADLESS_CAMPAIGN_QUERY_SELL_PRICE,
    EC_HEADLESS_CAMPAIGN_QUERY_ITEM_PRICE,
    EC_HEADLESS_CAMPAIGN_QUERY_MONEY,
    ...
    EC_HEADLESS_CAMPAIGN_QUERY_HARVEST,
};

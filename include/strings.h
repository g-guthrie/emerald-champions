...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_QuickBallDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_TimerBallDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_MaxReviveDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SacredAshDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_DreamBallDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_BeastBallDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_LinkingCordDesc[];
...
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_SweetAppleDesc[];
extern const u8 BattleFrontier_ExchangeServiceCorner_Text_TartAppleDesc[];
...
extern const u8 gText_ShopFree[];
extern const u8 gText_YouWantedVar1NoCharge[];
extern const u8 gText_Var1AndYouWantedVar2NoCharge[];
...
extern const u8 gText_TrainerCardBadges[];
extern const u8 gText_TrainerCardLeadersDefeated[];
extern const u8 gText_TrainerCardMegasWitnessed[];
extern const u8 gText_TrainerCardCircuitBestStreak[];

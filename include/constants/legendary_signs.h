...
enum LegendarySignId
{
    ...
    // Appended with the gate-table refactor: static encounters that predate
    // the Sign ledger, so caught-tracking is uniform. Capacity is 96 ids.
    LEGENDARY_SIGN_MOLTRES,
    LEGENDARY_SIGN_HEATRAN,
    LEGENDARY_SIGN_REGIROCK,
    LEGENDARY_SIGN_REGICE,
    LEGENDARY_SIGN_REGISTEEL,
    LEGENDARY_SIGN_GROUDON,
    LEGENDARY_SIGN_KYOGRE,
    LEGENDARY_SIGN_RAYQUAZA,
    LEGENDARY_SIGN_JIRACHI,
    LEGENDARY_SIGN_DIANCIE,
    LEGENDARY_SIGN_DEOXYS,

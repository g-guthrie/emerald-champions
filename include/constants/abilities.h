...
// Curated Gen 9 abilities. Upstream numeric IDs intentionally are not reused;
// Verdant's custom Mega abilities already occupy that range.
#define ABILITY_ARMOR_TAIL       (ABILITIES_COUNT_CUSTOM + 0)
#define ABILITY_BEADS_OF_RUIN    (ABILITIES_COUNT_CUSTOM + 1)
#define ABILITY_COMMANDER        (ABILITIES_COUNT_CUSTOM + 2)
#define ABILITY_CUD_CHEW         (ABILITIES_COUNT_CUSTOM + 3)
#define ABILITY_GOOD_AS_GOLD     (ABILITIES_COUNT_CUSTOM + 4)
#define ABILITY_PROTOSYNTHESIS   (ABILITIES_COUNT_CUSTOM + 5)
#define ABILITY_PURIFYING_SALT   (ABILITIES_COUNT_CUSTOM + 6)
#define ABILITY_QUARK_DRIVE      (ABILITIES_COUNT_CUSTOM + 7)
#define ABILITY_SUPREME_OVERLORD (ABILITIES_COUNT_CUSTOM + 8)
#define ABILITY_SWORD_OF_RUIN    (ABILITIES_COUNT_CUSTOM + 9)
#define ABILITY_TOXIC_DEBRIS     (ABILITIES_COUNT_CUSTOM + 10)
#define ABILITY_VESSEL_OF_RUIN   (ABILITIES_COUNT_CUSTOM + 11)
#define ABILITY_ZERO_TO_HERO     (ABILITIES_COUNT_CUSTOM + 12)

#define ABILITIES_COUNT_CURATED  (ABILITY_ZERO_TO_HERO + 1)
#define ABILITIES_COUNT ABILITIES_COUNT_CURATED

...
enum
{
    ...
    MULTI_EC_STARTER_ARCHIVE_KANTO,
    MULTI_EC_STARTER_ARCHIVE_JOHTO,
    MULTI_EC_STARTER_ARCHIVE_HOENN,
    MULTI_EC_STARTER_ARCHIVE_SINNOH,
    MULTI_EC_STARTER_ARCHIVE_UNOVA,
    MULTI_EC_STARTER_ARCHIVE_KALOS,
    MULTI_EC_STARTER_ARCHIVE_ALOLA,
    MULTI_EC_STARTER_ARCHIVE_GALAR,
    MULTI_EC_STARTER_ARCHIVE_PALDEA,
};
...
#define STDSTRING_MEGA_STONES      41

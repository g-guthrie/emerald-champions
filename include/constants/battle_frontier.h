...
#define FACILITY_BATTLE_PIKE_ONE_TRAINER 5
#define FACILITY_BATTLE_PIKE_TWO_TRAINERS 6
...
#define EXCHANGE_CORNER_SUPPLY_CLERK     2
#define EXCHANGE_CORNER_EVOLUTION_CLERK  3
...
// Inclement Emerald spells these with an extra BATTLE_, and names the two
// Exchange Corner clerks for what they sold in vanilla. Same slots either way.
#define RANKING_HALL_BATTLE_TOWER_SINGLES      RANKING_HALL_TOWER_SINGLES
#define RANKING_HALL_BATTLE_TOWER_DOUBLES      RANKING_HALL_TOWER_DOUBLES
#define RANKING_HALL_BATTLE_TOWER_MULTIS       RANKING_HALL_TOWER_MULTIS
#define RANKING_HALL_BATTLE_DOME               RANKING_HALL_DOME
#define RANKING_HALL_BATTLE_PALACE             RANKING_HALL_PALACE
#define RANKING_HALL_BATTLE_ARENA              RANKING_HALL_ARENA
#define RANKING_HALL_BATTLE_FACTORY            RANKING_HALL_FACTORY
#define RANKING_HALL_BATTLE_PIKE               RANKING_HALL_PIKE
#define RANKING_HALL_BATTLE_PYRAMID            RANKING_HALL_PYRAMID
#define RANKING_HALL_BATTLE_TOWER_LINK         RANKING_HALL_TOWER_LINK
#define EXCHANGE_CORNER_VITAMIN_CLERK          EXCHANGE_CORNER_SUPPLY_CLERK
#define EXCHANGE_CORNER_HOLD_ITEM_CLERK        EXCHANGE_CORNER_EVOLUTION_CLERK

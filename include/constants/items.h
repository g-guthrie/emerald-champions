...
#include "constants/tms_hms.h" // move lists only; no machine items exist
...
enum __attribute__((packed)) Item
{
    ...
    // Charms
    ITEM_OVAL_CHARM = 582,
    ITEM_SHINY_CHARM = 583,
    ITEM_CATCHING_CHARM = 584,
    ITEM_EXP_CHARM = 585,

    // Form-changing Key Items
    ITEM_ROTOM_CATALOG = 586,
    ITEM_GRACIDEA = 587,
    ITEM_REVEAL_GLASS = 588,
    ITEM_DNA_SPLICERS = 589,
    ITEM_ZYGARDE_CUBE = 590,
    ITEM_PRISON_BOTTLE = 591,
    ITEM_N_SOLARIZER = 592,
    ITEM_N_LUNARIZER = 593,
    ITEM_REINS_OF_UNITY = 594,

    // Battle Mechanic Key Items
    ITEM_MEGA_RING = 595,
    ITEM_Z_POWER_RING = 596,
    ITEM_DYNAMAX_BAND = 597,
    ...
    ITEM_GOOD_ROD = 602,
    ITEM_SUPER_ROD = 603,
    ITEM_DOWSING_MACHINE = 604,
    ITEM_ITEMFINDER = ITEM_DOWSING_MACHINE, // Pre-Gen IV name
    ITEM_DOWSING_MCHN = ITEM_DOWSING_MACHINE, // Gen IV-V name
    ITEM_TOWN_MAP = 605,
    ITEM_VS_SEEKER = 606,
    ITEM_BERRY_POUCH = 607,
    ITEM_POKEMON_BOX_LINK = 608,
    ITEM_POKEMON_BOX = ITEM_POKEMON_BOX_LINK, // Pre-Gen VIII name
    ITEM_COIN_CASE = 609,
    ITEM_POWDER_JAR = 610,
    ITEM_WAILMER_PAIL = 611,
    ITEM_POKE_RADAR = 612,
    ITEM_POKEBLOCK_CASE = 613,
    ITEM_SOOT_SACK = 614,
    ITEM_POKE_FLUTE = 615,
    ITEM_FAME_CHECKER = 616,
    ITEM_TEACHY_TV = 617,

    // Story Key Items
    ITEM_SS_TICKET = 618,
    ITEM_EON_TICKET = 619,
    ITEM_MYSTIC_TICKET = 620,
    ITEM_AURORA_TICKET = 621,
    ITEM_OLD_SEA_MAP = 622,
    ITEM_LETTER = 623,
    ITEM_DEVON_PARTS = 624,
    ITEM_DEVON_GOODS = ITEM_DEVON_PARTS, // Pre-Gen VI name
    ITEM_GO_GOGGLES = 625,
    ITEM_DEVON_SCOPE = 626,
    ITEM_BASEMENT_KEY = 627,
    ITEM_SCANNER = 628,
    ITEM_STORAGE_KEY = 629,
    ITEM_KEY_TO_ROOM_1 = 630,
    ITEM_RM_1_KEY = ITEM_KEY_TO_ROOM_1, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_2 = 631,
    ITEM_RM_2_KEY = ITEM_KEY_TO_ROOM_2, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_4 = 632,
    ITEM_RM_4_KEY = ITEM_KEY_TO_ROOM_4, // Pre-Gen VI name
    ITEM_KEY_TO_ROOM_6 = 633,
    ...
    ITEM_SECRET_KEY = 638,
    ITEM_BIKE_VOUCHER = 639,
    ITEM_GOLD_TEETH = 640,
    ITEM_CARD_KEY = 641,
    ITEM_LIFT_KEY = 642,
    ITEM_SILPH_SCOPE = 643,
    ITEM_TRI_PASS = 644,
    ITEM_RAINBOW_PASS = 645,
    ITEM_TEA = 646,
    ITEM_RUBY = 647,
    ITEM_SAPPHIRE = 648,

    // GEN IX ITEMS
    ITEM_ABILITY_SHIELD = 649,
    ITEM_CLEAR_AMULET = 650,
    ITEM_PUNCHING_GLOVE = 651,
    ITEM_COVERT_CLOAK = 652,
    ITEM_LOADED_DICE = 653,
    ITEM_AUSPICIOUS_ARMOR = 654,
    ITEM_BOOSTER_ENERGY = 655,
    ITEM_BIG_BAMBOO_SHOOT = 656,
    ITEM_GIMMIGHOUL_COIN = 657,
    ITEM_LEADERS_CREST = 658,
    ITEM_MALICIOUS_ARMOR = 659,
    ITEM_MIRROR_HERB = 660,
    ITEM_SCROLL_OF_DARKNESS = 661,
    ITEM_SCROLL_OF_WATERS = 662,
    ITEM_772 = 663,
    ITEM_TINY_BAMBOO_SHOOT = 664,
    ...
    ITEM_ADAMANT_CRYSTAL = 683,
    ITEM_GRISEOUS_CORE = 684,
    ITEM_LUSTROUS_GLOBE = 685,

    ITEM_BLACK_AUGURITE = 686,
    ITEM_LINKING_CORD = 687,
    ITEM_PEAT_BLOCK = 688,
    ITEM_BERSERK_GENE = 689,

    ITEM_FAIRY_FEATHER = 690,
    ITEM_SYRUPY_APPLE = 691,
    ITEM_UNREMARKABLE_TEACUP = 692,
    ITEM_MASTERPIECE_TEACUP = 693,
    ITEM_CORNERSTONE_MASK = 694,
    ITEM_WELLSPRING_MASK = 695,
    ITEM_HEARTHFLAME_MASK = 696,
    ITEM_HEALTH_MOCHI = 697,
    ITEM_MUSCLE_MOCHI = 698,
    ITEM_RESIST_MOCHI = 699,
    ITEM_GENIUS_MOCHI = 700,
    ITEM_CLEVER_MOCHI = 701,
    ITEM_SWIFT_MOCHI = 702,
    ITEM_FRESH_START_MOCHI = 703,
    ITEM_GLIMMERING_CHARM = 704,
    ITEM_METAL_ALLOY = 705,
    ITEM_815 = 706,

    ITEM_JUBILIFE_MUFFIN = 707,
    ITEM_REMEDY = 708,
    ITEM_FINE_REMEDY = 709,
    ITEM_SUPERB_REMEDY = 710,
    ITEM_AUX_EVASION = 711,
    ITEM_AUX_GUARD = 712,
    ITEM_AUX_POWER = 713,
    ITEM_AUX_POWERGUARD = 714,
    ITEM_CHOICE_DUMPLING = 715,
    ITEM_SWAP_SNACK = 716,
    ITEM_TWICE_SPICED_RADISH = 717,
    ITEM_POKESHI_DOLL = 718,

    ITEM_STRANGE_BALL = 719,

    // Legends Z-A Mega Stones
    ITEM_CLEFABLITE = 720,
    ITEM_VICTREEBELITE = 721,
    ITEM_STARMINITE = 722,
    ITEM_DRAGONINITE = 723,
    ITEM_MEGANIUMITE = 724,
    ITEM_FERALIGITE = 725,
    ITEM_SKARMORITE = 726,
    ITEM_FROSLASSITE = 727,
    ITEM_EMBOARITE = 728,
    ITEM_EXCADRITE = 729,
    ITEM_SCOLIPITE = 730,
    ITEM_SCRAFTINITE = 731,
    ITEM_EELEKTROSSITE = 732,
    ITEM_CHANDELURITE = 733,
    ITEM_CHESNAUGHTITE = 734,
    ITEM_DELPHOXITE = 735,
    ITEM_GRENINJITE = 736,
    ITEM_PYROARITE = 737,
    ITEM_FLOETTITE = 738,
    ITEM_MALAMARITE = 739,
    ITEM_BARBARACITE = 740,
    ITEM_DRAGALGITE = 741,
    ITEM_HAWLUCHANITE = 742,
    ITEM_ZYGARDITE = 743,
    ITEM_DRAMPANITE = 744,
    ITEM_FALINKSITE = 745,
    ...
    ITEM_DARKRANITE = 747,
    ITEM_ZERAORITE = 748,
    ITEM_RAICHUNITE_X = 749,
    ITEM_RAICHUNITE_Y = 750,
    ITEM_CHIMECHITE = 751,
    ITEM_ABSOLITE_Z = 752,
    ITEM_STARAPTITE = 753,
    ITEM_GARCHOMPITE_Z = 754,
    ITEM_LUCARIONITE_Z = 755,
    ITEM_GOLURKITE = 756,
    ITEM_MEOWSTICITE = 757,
    ITEM_CRABOMINITE = 758,
    ITEM_GOLISOPITE = 759,
    ITEM_MAGEARNITE = 760,
    ITEM_SCOVILLAINITE = 761,
    ITEM_BAXCALIBRITE = 762,
    ITEM_TATSUGIRINITE = 763,
    ITEM_GLIMMORANITE = 764,

    // Emerald Champions campaign tools
    ITEM_POKE_VIAL = 765,
    ITEM_LEVELER = 766,
    ITEM_MAGMA_STONE = 767,
    ITEM_REPEL_SPRAY = 768,
    ITEM_FLIGHT_BEACON = 769,

...
flag=int(re.search(r'#define FLAG_HIDE_GRANITE_CAVE_STEVEN\s+(0x[0-9A-Fa-f]+|\d+)',const)[1],0)
for param in range(17,22):
 cmd=['build/headless/emerald_champions_mgba_runner','--rom','pokeemerald-dewford-audit-headless.gba','--frames','10000','--screenshot',str(out/f'discovery-{param}-end.png')]
 ...
 for frame in range(1000,9000,160):cmd+=['--key',f'{frame}:2:B']

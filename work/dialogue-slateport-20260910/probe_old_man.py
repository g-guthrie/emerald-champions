...
for param,name,kind in [(32,'FLAG_DEFEATED_WALLY_MAUVILLE',1),(33,'FLAG_DEFEATED_WALLY_MAUVILLE',1)]:
 ...
 for frame in [750,2000,4000,6000,8000]:cmd+=['--screenshot-at',f'{frame}:{out}/mauville-{param}-{frame}.png']

...
def run(case):
 ...
 c=['build/headless/emerald_champions_mgba_runner','--rom','pokeemerald-mauville-audit-headless.gba','--state-in',str(out/'dig-text-base.mgba'),'--frames','10000','--state-out',str(out/(tag+'.mgba')),'--screenshot',str(out/(tag+'-end.png'))]
 ...
 if negative or incompatible:keys=keys[:3]+[(2400,2,'B'),(2750,2,'B'),(3100,2,'B')]

...
for param in params:
 ...
 for f,n,v in [(59,'gEcHeadlessFixtureParam',param),(60,'gEcHeadlessFixtureScenario',71),(70,'gEcHeadlessCampaignQueryKind',2 if param==59 else 4),(70,'gEcHeadlessCampaignQueryId',0x409B if param==59 else 6)]:cmd+=['--write',f'{f}:4:{sy[n]}:{v}']
 ...
 r=subprocess.run(cmd,capture_output=True,text=True);(out/f'vial-inventory-{param}.log').write_text(r.stdout+r.stderr);print(param,r.returncode,r.stdout,r.stderr,flush=True)

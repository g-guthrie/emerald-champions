...
for param in map(int,sys.argv[1:] or ['77']):
 ...
 for stage,(key,delay) in enumerate([('RIGHT',1500),('LEFT',1000),('RIGHT',1500),('LEFT',1000),('RIGHT',8500)]):
  ...
  frame+=delay
 cmd=['build/headless/emerald_champions_mgba_runner','--rom','pokeemerald-mauville-audit-headless.gba','--frames',str(frame+300),'--screenshot',str(out/f'new-mauville-{param}-end.png')]

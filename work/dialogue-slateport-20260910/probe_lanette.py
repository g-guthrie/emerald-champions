...
for param,name,kind in [(40,'FLAG_HIDE_FALLARBOR_POKEMON_CENTER_LANETTE',1),(41,'FLAG_HIDE_FALLARBOR_POKEMON_CENTER_LANETTE',1),(42,'FLAG_HIDE_FALLARBOR_POKEMON_CENTER_LANETTE',1)]:
 ...
 cmd=['build/headless/emerald_champions_mgba_runner','--rom','pokeemerald-mauville-audit-headless.gba','--frames','18000','--screenshot',str(out/f'lanette-{param}-end.png')]
 ...
 cmd+=['--key','300:2:'+{40:'UP',41:'LEFT',42:'RIGHT'}[param],'--key','400:2:A']
 
 for frame in [750,2000,4000,6000,8000]:cmd+=['--screenshot-at',f'{frame}:{out}/lanette-{param}-{frame}.png']
 ...
 result=subprocess.run(cmd,capture_output=True,text=True);(out/f'lanette-{param}.log').write_text(result.stdout+result.stderr);print(param,name,result.returncode,result.stdout,flush=True)

...
start=(32,33,0);todo=deque([start]);prev={start:None};goal=None
while todo:
...
for param in map(int,['77']):
 ...
 for stage,(key,delay) in enumerate([('RIGHT',1500),('LEFT',1000),('RIGHT',1500),('LEFT',1000),('RIGHT',8500)]):
  ...
  frame+=delay
 cmd=['build/headless/emerald_champions_mgba_runner','--rom','pokeemerald-mauville-audit-headless.gba','--frames','3500','--screenshot',str(out/'new-mauville-entry-position.png')]

...
flag=int(re.search(r'#define VAR_ROUTE110_STATE\s+(0x[0-9A-Fa-f]+|\d+)',const)[1],0)
for param in [6,7,8]:
 ...
 for f,n,v in [(59,'gEcHeadlessFixtureParam',param),(60,'gEcHeadlessFixtureScenario',73),(70,'gEcHeadlessCampaignQueryKind',2),(70,'gEcHeadlessCampaignQueryId',flag)]:cmd+=['--write',f'{f}:4:{sy[n]}:{v}']
 cmd+=['--key','300:12:UP']

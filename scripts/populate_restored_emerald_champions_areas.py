...
ITEMS = {
    ...
    "AshenWoods": [
        item(10, 5, "ITEM_PINSIRITE", "FLAG_EC_ITEM_ASHEN_HONEY"),
        item(26, 5, "ITEM_DUSK_STONE", "FLAG_EC_ITEM_ASHEN_DUSK_STONE"),
        item(26, 43, "ITEM_SCOLIPITE", "FLAG_EC_ITEM_ASHEN_QUICK_BALL"),
    ],
    "DewfordManor_1F": [
    ...
    "EmberPath": [
        item(36, 2, "ITEM_BLAZIKENITE", "FLAG_EC_ITEM_EMBER_QUICK_BALL"),
        item(12, 10, "ITEM_MAGMARIZER", "FLAG_EC_ITEM_EMBER_MAGMARIZER"),
        item(25, 35, "ITEM_GARCHOMPITE_Z", "FLAG_EC_ITEM_EMBER_MASTER_BALL"),
    ],
    "PetalburgWoods_2": [
    ...
    "ScorchedSlab_B2F": [
        item(23, 22, "ITEM_CHARIZARDITE_X", "FLAG_EC_ITEM_SCORCHED_BEAST_BALL"),
    ],
    "Seaspray_Cave": [

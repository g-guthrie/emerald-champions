...
ITEMS = {
    ...
    "DewfordManor_1F": [
        item(1, 11, "ITEM_BANETTITE", "FLAG_EC_ITEM_MANOR_BANETTITE"),
    ...
    "EmberPath": [
        item(36, 2, "ITEM_CHARIZARDITE_Y", "FLAG_EC_ITEM_EMBER_CHARIZARDITE_Y"),
    ...
    "ScorchedSlab_B2F": [
        item(23, 22, "ITEM_TYRANITARITE", "FLAG_EC_ITEM_SCORCHED_TYRANITARITE"),
    ],
    "Seaspray_Cave": [
    ...
    "Seaspray_Cave_B1F": [
        ...
        item(11, 12, "ITEM_ABOMASITE", "FLAG_EC_ITEM_SEASPRAY_ABOMASITE"),

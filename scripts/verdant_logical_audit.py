...
questions = [
    ...
    ("Does the player receive Mega access early enough to experiment?", "giveitem ITEM_MEGA_BRACELET" in read("data/maps/GraniteCave_StevensRoom/scripts.inc") and all(stone in read("data/maps/GraniteCave_StevensRoom/scripts.inc") for stone in ("ITEM_SCEPTILITE", "ITEM_BLAZIKENITE", "ITEM_SWAMPERTITE"))),

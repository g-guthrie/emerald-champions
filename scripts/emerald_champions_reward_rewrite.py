...
DIALOGUE = {
    ...
    ("data/maps/Route104/scripts.inc", "Route104_Text_TMsAreOneTimeUse"): ("That LEAF STONE can evolve certain\n", "GRASS POKéMON. Use it when ready.$"),
    ...
    ("data/maps/MauvilleCity/scripts.inc", "MauvilleCity_Text_WattsonThanksTakeTM"): ("WATTSON: Wahahahaha! I knew I'd made\n", "the right choice asking you!\\p", "This ELECTIRIZER came from the old\n", "GENERATOR. You've earned it!$"),
    ...
    ("data/maps/PacifidlogTown_House2/scripts.inc", "PacifidlogTown_House2_Text_GetGoodTMInXDays"): ("In {STR_VAR_1} days, I'll receive more\n", "evolution stones.\\p", "Come see me then, and I'll choose one\n", "that suits your lead POKéMON.$"),
    ...
    ("data/maps/SootopolisCity_House1/scripts.inc", "SootopolisCity_House1_Text_DevelopedThisTM"): ("For thirty years I've remained in\n", "SOOTOPOLIS honing my skills.\\p", "This RAZOR CLAW is just as sharp.\n", "I bequeath it to you!$"),
    ...
    ("data/maps/FortreeCity_House2/scripts.inc", "FortreeCity_House2_Text_ExplainHiddenPower"): ("A DUBIOUS DISC evolves PORYGON2.\n", "Use it from the Bag when ready.$"),
    ...
    ("data/maps/SSTidalRooms/scripts.inc", "SSTidalRooms_Text_ExplainSnatch"): ("A REAPER CLOTH evolves DUSCLOPS.\n", "Use it from the Bag when ready.$"),
    ("data/maps/RustboroCity_PokemonSchool/scripts.inc", "RustboroCity_PokemonSchool_Text_StudentsWhoDontStudyGetQuickClaw"): ("A good TRAINER studies every tool.\\p", "This SUN STONE evolves certain POKéMON.\n", "Show me that you know when to use it.$"),
    ("data/maps/DewfordTown_House2/scripts.inc", "DewfordTown_House2_Text_WantYouToHaveSilkScarf"): ("Gorge your eyes on this rare\n", "REAPER CLOTH! Spooky, yet stylish!\\p", "You appreciate my dazzling taste.\n", "Here, I want you to have it!$"),

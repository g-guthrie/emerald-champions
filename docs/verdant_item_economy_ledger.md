...
|---|---|---|---|
| Roxanne | ITEM_EXPERT_BELT | None | Clean |
| Brawly | ITEM_FLAME_ORB | None | Clean |
| Wattson | ITEM_WISE_GLASSES | None | Clean |
| Flannery | ITEM_EJECT_PACK | None | Clean |
| Norman | ITEM_TOXIC_ORB | None | Clean |
| Winona | ITEM_ADRENALINE_ORB | None | Clean |
| Tate & Liza | ITEM_LIGHT_CLAY | None | Clean |
| Juan | ITEM_UTILITY_UMBRELLA | None | Clean |

## Tested canonical direction

| Boss | Proposed item | Earlier collision | Required action |
|---|---|---|---|
| Brawly | ITEM_FLAME_ORB | None | keep |
| Norman | ITEM_TOXIC_ORB | None | keep |
| Tate & Liza | ITEM_LIGHT_CLAY | None | keep |
| Flannery | ITEM_EJECT_PACK | None | keep |
| Winona | ITEM_ADRENALINE_ORB | None | keep |
| Juan | ITEM_UTILITY_UMBRELLA | None | keep |
...
| ITEM_ADRENALINE_ORB | discovery | FortreeCity_Gym / fixed_gift |
...
| ITEM_AIR_BALLOON | 4 | Route114_FossilManiacsHouse / fixed_gift |
| ITEM_ALAKAZITE | not_in_discovery_shop | SlateportCity / visible_pickup |
| ITEM_ALTARIANITE | not_in_discovery_shop | LilycoveCity / fixed_gift |
...
| ITEM_BLACK_GLASSES | not_in_discovery_shop | Route116 / hidden_item |
| ITEM_BLACK_SLUDGE | discovery | DewfordTown_Hall / fixed_gift |
...
| ITEM_BLUNDER_POLICY | discovery | Route110_TrickHousePuzzle4 / visible_pickup |
| ITEM_BRIGHT_POWDER | discovery | VerdanturfTown_BattleTentLobby / fixed_gift |
...
| ITEM_CHARCOAL | not_in_discovery_shop | LavaridgeTown_HerbShop / fixed_gift |
...
| ITEM_DAMP_ROCK | not_in_discovery_shop | Route119_WeatherInstitute_1F / fixed_bundle |
...
| ITEM_EJECT_PACK | discovery | LavaridgeTown_Gym_1F / fixed_gift |
| ITEM_ELECTRIC_GEM | not_in_discovery_shop | LavaridgeTown_Mart / specialty_shop |
| ITEM_ELECTRIC_SEED | 5 | Route110 / fixed_gift |
...
| ITEM_EXPERT_BELT | discovery | RustboroCity_Gym / fixed_gift |
...
| ITEM_FLAME_ORB | discovery | DewfordTown_Gym / fixed_gift |
...
| ITEM_FOCUS_BAND | discovery | SlateportCity_PokemonFanClub / fixed_gift |
...
| ITEM_LIGHT_CLAY | discovery | MossdeepCity_Gym / fixed_gift |
| ITEM_LOPUNNITE | not_in_discovery_shop | AbandonedShip_Rooms_1F / visible_pickup |
...
| ITEM_METAGROSSITE | not_in_discovery_shop | VictoryRoad_1F / visible_pickup |
| ITEM_METAL_COAT | not_in_discovery_shop | MauvilleCity_Mart / specialty_shop |
| ITEM_METAL_POWDER | not_in_discovery_shop | MauvilleCity_Mart / specialty_shop |
| ITEM_METRONOME | discovery | MauvilleCity / fixed_gift |
...
| ITEM_MILOTICITE | not_in_discovery_shop | MossdeepCity / visible_pickup |
| ITEM_MIRACLE_SEED | not_in_discovery_shop | Route104 / fixed_gift |
| ITEM_MISTY_SEED | 5 | src/item.c / badge_shop |
| ITEM_MUSCLE_BAND | discovery | FallarborTown_Mart / fixed_gift |
...
| ITEM_PROTECTIVE_PADS | discovery | Route114 / visible_pickup |
| ITEM_PSYCHIC_GEM | not_in_discovery_shop | LavaridgeTown_Mart / specialty_shop |
| ITEM_PSYCHIC_SEED | 5 | src/item.c / badge_shop |
| ITEM_QUICK_CLAW | discovery | RustboroCity_PokemonSchool / fixed_gift |
...
| ITEM_RAZOR_CLAW | not_in_discovery_shop | FortreeCity_Mart / specialty_shop |
...
| ITEM_ROOM_SERVICE | discovery | Route110_TrickHouseEnd / fixed_gift |
| ITEM_SABLENITE | not_in_discovery_shop | RusturfTunnel / visible_pickup |
| ITEM_SAFETY_GOGGLES | discovery | LavaridgeTown / fixed_gift |
...
| ITEM_TERRAIN_EXTENDER | discovery | Route110_TrickHousePuzzle5 / visible_pickup |
| ITEM_THICK_CLUB | not_in_discovery_shop | MauvilleCity_Mart / specialty_shop |
| ITEM_THROAT_SPRAY | discovery | SlateportCity / fixed_gift |
| ITEM_TOXIC_ORB | discovery | PetalburgCity_Gym / fixed_gift |
...
| ITEM_UTILITY_UMBRELLA | discovery | SootopolisCity_Gym_1F / fixed_gift |
...
| ITEM_WEAKNESS_POLICY | 6 | VerdanturfTown_Mart / fixed_gift |
| ITEM_WHITE_HERB | 2 | Route104 / fixed_gift |
| ITEM_WIDE_LENS | discovery | GraniteCave_StevensRoom / fixed_bundle |
| ITEM_WISE_GLASSES | discovery | MauvilleCity_Gym / fixed_gift |
...
| ITEM_ZOOM_LENS | discovery | RustboroCity_Mart / fixed_gift |

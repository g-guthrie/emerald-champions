...
- [README](./README.md)
- [Emerald Champions]()
    - [Complete Campaign](./EMERALD_CHAMPIONS_CAMPAIGN_BOOK.md)
    - [Story-Mode Source Audit](./EMERALD_CHAMPIONS_STORY_MODE_AUDIT.md)
    - [Verification Audit](./EMERALD_CHAMPIONS_VERIFICATION_AUDIT.md)
    - [Evidence Ledger](./emerald_champions_migration/FEATURE_PARITY.md)
    - [Save Compatibility](./emerald_champions_migration/SAVE_COMPATIBILITY.md)
    ...
    - [Core Preparation and Economy](./emerald_champions_migration/CORE_SERVICES.md)
    - [Story Bible](./emerald_champions_migration/STORY_BIBLE.md)
    - [Historical Migration Checkpoints]()
        - [Source Lock](./emerald_champions_migration/SOURCE_LOCK.md)
        - [Baseline Builds](./emerald_champions_migration/BASELINE_BUILDS.md)
        - [Champions Battle Parity](./emerald_champions_migration/CHAMPIONS_PARITY.md)
        - [Pre-Story-Rebuild Checkpoint](./emerald_champions_migration/PRE_STORY_REBUILD_CHECKPOINT.md)

...
**Historical, superseded by the final Gen 9 / fixed31 migration.** The completion
claims, ratings and stat/latency benchmarks below belong to the old formula.
[The current E0001 review is OPEN](e0001_gen9_2026_09_09.md); these earlier
scenarios do not count as completion of the restarted encounter pass.

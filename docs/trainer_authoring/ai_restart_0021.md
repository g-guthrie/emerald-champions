> Historical flat-stat review. See the [current Gen9 practical review](e0021_gen9_2026_09_09.md)
> for actual current speed order, pressure preference and observed sequences.
> The old Dance payoff and stats below are not current execution evidence.

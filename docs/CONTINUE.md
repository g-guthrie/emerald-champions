...
Still compiled but unreachable: src/contest*.c, pokeblock, berry_blender, roulette, slot_machine, apprentice, the Frontier facility maps and Trainer Hill maps, ITEM_MACH_BIKE and ITEM_COIN_CASE definitions. Deleting them is a later cleanup, not a player-facing gap.

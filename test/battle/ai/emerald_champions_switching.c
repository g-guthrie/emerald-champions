...
AI_DOUBLE_BATTLE_TEST("EC switching: Cynthia's Lucario keeps a useless lock rather than spend an ace that falls on entry")
{
    ...
    GIVEN {
        ...
        SwitchPlayer(SPECIES_FLUTTER_MANE, 85, 0, SET(MOVE_MOONBLAST, MOVE_SHADOW_BALL, MOVE_DAZZLING_GLEAM, MOVE_PROTECT, NATURE_TIMID, ABILITY_PROTOSYNTHESIS, ITEM_BOOSTER_ENERGY, 4, 0, 0, 252, 0, 252));
        SwitchPlayer(SPECIES_KARTANA, 85, 208, SET(MOVE_LEAF_BLADE, MOVE_SACRED_SWORD, MOVE_SMART_STRIKE, MOVE_PROTECT, NATURE_JOLLY, ABILITY_BEAST_BOOST, ITEM_LIFE_ORB, 4, 252, 0, 0, 0, 252));
        SwitchPlayer(SPECIES_AMOONGUSS, 85, 0, SET(MOVE_SPORE, MOVE_RAGE_POWDER, MOVE_POLLEN_PUFF, MOVE_PROTECT, NATURE_RELAXED, ABILITY_REGENERATOR, ITEM_ROCKY_HELMET, 252, 0, 252, 0, 4, 0));

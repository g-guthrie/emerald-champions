...
const u16 gTitleScreenEmeraldVersionPal[]  = INCGFX_U16("graphics/title_screen/emerald_champions_version.png", ".gbapal");
...
const u32 gTitleScreenEmeraldVersionGfx[]  = INCGFX_U32("graphics/title_screen/emerald_champions_version.png", ".8bpp.smol", "-mwidth 8 -mheight 4");

...
const u8 *const gMonIconTable[] =
{
    ...
    [SPECIES_MEGANIUM_MEGA] = gMonIcon_MeganiumMega,
    [SPECIES_FERALIGATR_MEGA] = gMonIcon_FeraligatrMega,
    [SPECIES_EMBOAR_MEGA] = gMonIcon_EmboarMega,
    [SPECIES_RAICHU_MEGA_X] = gMonIcon_RaichuMegaX,
    [SPECIES_RAICHU_MEGA_Y] = gMonIcon_RaichuMegaY,
    [SPECIES_DRAGONITE_MEGA] = gMonIcon_DragoniteMega,
    [SPECIES_EXCADRILL_MEGA] = gMonIcon_ExcadrillMega,
    [SPECIES_MALAMAR_MEGA] = gMonIcon_MalamarMega,
    [SPECIES_CHANDELURE_MEGA] = gMonIcon_ChandelureMega,
    [SPECIES_HAWLUCHA_MEGA] = gMonIcon_HawluchaMega,
    [SPECIES_GRENINJA_MEGA] = gMonIcon_GreninjaMega,
...
#include "data/pokemon_graphics/verdant_gen9_icon_table.h"
...
const u8 gMonIconPaletteIndices[] =
{
    ...
    [SPECIES_FERALIGATR_MEGA] = 0,
    [SPECIES_EMBOAR_MEGA] = 5,
...
#include "data/pokemon_graphics/verdant_gen9_icon_palettes.h"
    [SPECIES_EGG] = 1,
};
...
{
    u8 spriteId;
    u16 iconSpecies = species >= NUM_SPECIES ? INVALID_ICON_SPECIES : species;
    struct MonIconSpriteTemplate iconTemplate =
    {
        .oam = &sMonIconOamData,
        .image = GetMonIconPtr(iconSpecies, personality),
        .anims = sMonIconAnims,
        .affineAnims = sMonIconAffineAnims,
        .callback = callback,
        .paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndices[iconSpecies],
    };

    if (SpeciesHasGenderDifference[iconSpecies] && GetGenderFromSpeciesAndPersonality(iconSpecies, personality) == MON_FEMALE)
        iconTemplate.paletteTag = POKE_ICON_BASE_PAL_TAG + gMonIconPaletteIndicesFemale[iconSpecies];
...
{
    u8 palIndex;
    palIndex = GetValidMonIconPalIndex(species);
    FreeSpritePaletteByTag(gMonIconPaletteTable[palIndex].tag);
}
...
{
    return GetValidMonIconPalIndex(species);
}

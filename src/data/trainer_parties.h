...
static const struct TrainerMonItemCustomMoves sParty_WallyVR2[] = {
    ...
    .moves = MOVE_FOLLOW_ME, MOVE_HELPING_HAND, MOVE_EXPANDING_FORCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_WALLY_VR_2 */,
    {
    .lvl = 1,
    .species = SPECIES_GALLADE,
    .heldItem = ITEM_GALLADITE,
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PSYCHO_CUT, MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_PROTECT
    } /* Verdant polish: TRAINER_WALLY_VR_2 */,
    {
    .lvl = 1,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FAKE_OUT, MOVE_FLARE_BLITZ, MOVE_SNARL, MOVE_PARTING_SHOT
    } /* Verdant polish: TRAINER_WALLY_VR_2 */,
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR3[] = {
    ...
    } /* Verdant polish: TRAINER_WALLY_VR_3 */,
    {
    .lvl = 1,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_FOLLOW_ME, MOVE_AIR_SLASH, MOVE_TAILWIND, MOVE_HELPING_HAND
    } /* Verdant polish: TRAINER_WALLY_VR_3 */,
    {
    .lvl = 1,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLEEP_POWDER, MOVE_SLUDGE_BOMB, MOVE_LEAF_STORM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_WALLY_VR_3 */,
    {
    .lvl = 2,
    .species = SPECIES_GALLADE,
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR4[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_TAILWIND, MOVE_HURRICANE, MOVE_SCALD, MOVE_PROTECT
    } /* Verdant polish: TRAINER_WALLY_VR_4 */,
    {
    .lvl = 2,
    .species = SPECIES_ZAPDOS,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDER, MOVE_HURRICANE, MOVE_HEAT_WAVE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_WALLY_VR_4 */,
    {
    .lvl = 3,
    ...
    .moves = MOVE_POWER_WHIP, MOVE_GYRO_BALL, MOVE_LEECH_SEED, MOVE_PROTECT
    } /* Verdant polish: TRAINER_WALLY_VR_4 */,
    {
    .lvl = 4,
    .species = SPECIES_DRAGAPULT,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DRACO_METEOR, MOVE_SHADOW_BALL, MOVE_THUNDER, MOVE_U_TURN
    } /* Verdant polish: TRAINER_WALLY_VR_4 */,
    {
    .lvl = 4,
    .species = SPECIES_GALLADE,
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR5[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FOLLOW_ME, MOVE_ICY_WIND, MOVE_IRON_HEAD, MOVE_HELPING_HAND
    } /* Verdant polish: TRAINER_WALLY_VR_5 */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_ELECTROWEB, MOVE_FLASH_CANNON, MOVE_THUNDERBOLT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_WALLY_VR_5 */,
    {
    .lvl = 4,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_TAILWIND, MOVE_DRACO_METEOR, MOVE_PSYCHIC, MOVE_HEAL_PULSE
    } /* Verdant polish: TRAINER_WALLY_VR_5 */,
    {
    .lvl = 4,
    .species = SPECIES_GALLADE,
...
static const struct TrainerMonItemCustomMoves sParty_WallyVR1[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_FOLLOW_ME, MOVE_TAILWIND, MOVE_AIR_SLASH, MOVE_HELPING_HAND
    } /* Verdant polish: TRAINER_WALLY_VR_1 */,
    {
    .lvl = 1,
    .species = SPECIES_GARCHOMP,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute103Mudkip[] = {
    ...
    .moves = MOVE_GRASS_PLEDGE, MOVE_RETURN, MOVE_TOXIC, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_ROUTE_103_MUDKIP */
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute103Treecko[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_0_EV,
    .moves = MOVE_FIRE_PLEDGE, MOVE_RETURN, MOVE_TOXIC, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_ROUTE_103_TREECKO */
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute103Torchic[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_0_EV,
    .moves = MOVE_WATER_PLEDGE, MOVE_RETURN, MOVE_TOXIC, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_ROUTE_103_TORCHIC */
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroTreecko[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_RUSTBORO_TREECKO */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_FEINT, MOVE_KNOCK_OFF, MOVE_ICE_PUNCH
    } /* Verdant polish: TRAINER_BRENDAN_RUSTBORO_TREECKO */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_VOLT_SWITCH, MOVE_WILL_O_WISP, MOVE_HEX, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_RUSTBORO_TREECKO */
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroMudkip[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_RUSTBORO_MUDKIP */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_HASTY,
    .moves = MOVE_GRASS_PLEDGE, MOVE_SOLAR_BEAM, MOVE_SEED_BOMB, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_RUSTBORO_MUDKIP */,
    {
    .lvl = 1,
    .species = SPECIES_SNEASEL,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRustboroTorchic[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_RAIN_DANCE, MOVE_WEATHER_BALL, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_RUSTBORO_TORCHIC */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_HASTY,
    .moves = MOVE_WATER_PLEDGE, MOVE_ICY_WIND, MOVE_WATERFALL, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_RUSTBORO_TORCHIC */,
    {
    .lvl = 1,
    .species = SPECIES_SNEASEL,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute110Mudkip[] = {
    ...
    } /* Verdant polish: TRAINER_BRENDAN_ROUTE_110_MUDKIP */,
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute110Treecko[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_MIXED,
    .moves = MOVE_TRI_ATTACK, MOVE_ICY_WIND, MOVE_U_TURN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_ROUTE_110_TREECKO */,
    {
    .lvl = 2,
    .species = SPECIES_DRACOVISH,
    .heldItem = ITEM_CHOICE_BAND,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanRoute110Torchic[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_MIXED,
    .moves = MOVE_TRI_ATTACK, MOVE_ICY_WIND, MOVE_U_TURN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_ROUTE_110_TORCHIC */,
    {
    .lvl = 2,
    .species = SPECIES_DRACOVISH,
    .heldItem = ITEM_CHOICE_BAND,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLilycoveTreecko[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_LIQUIDATION, MOVE_LEECH_LIFE, MOVE_ICE_FANG, MOVE_STICKY_WEB
    } /* Verdant polish: TRAINER_BRENDAN_LILYCOVE_TREECKO */,
    {
    .lvl = 1,
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_FLAME_ORB,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_FLARE_BLITZ, MOVE_HIGH_JUMP_KICK, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDAN_LILYCOVE_TREECKO */
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute103Mudkip[] = {
    ...
    .spread = SPREAD_31_IV_0_EV,
    .moves = MOVE_GRASS_PLEDGE, MOVE_RETURN, MOVE_TOXIC, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAY_ROUTE_103_MUDKIP */
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute103Treecko[] = { // May Route 103
    ...
    .spread = SPREAD_31_IV_0_EV,
    .moves = MOVE_FIRE_PLEDGE, MOVE_RETURN, MOVE_TOXIC, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAY_ROUTE_103_TREECKO */
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute103Torchic[] = { // May Route 103
    ...
    .spread = SPREAD_31_IV_0_EV,
    .moves = MOVE_WATER_PLEDGE, MOVE_RETURN, MOVE_TOXIC, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAY_ROUTE_103_TORCHIC */
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRustboroMudkip[] = { // May Rustboro
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAY_RUSTBORO_MUDKIP */,
    {
    .lvl = 2,
    .species = SPECIES_GROVYLE,
    .heldItem = ITEM_EVIOLITE,
...
static const struct TrainerMonItemCustomMoves sParty_MayRustboroTreecko[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAY_RUSTBORO_TREECKO */,
    {
    .lvl = 2,
    .species = SPECIES_COMBUSKEN,
    .heldItem = ITEM_EVIOLITE,
...
static const struct TrainerMonItemCustomMoves sParty_MayRustboroTorchic[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_RAIN_DANCE, MOVE_WEATHER_BALL, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAY_RUSTBORO_TORCHIC */,
    {
    .lvl = 2,
    .species = SPECIES_MARSHTOMP,
    .heldItem = ITEM_EVIOLITE,
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute110Mudkip[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_MIXED,
    .moves = MOVE_TRI_ATTACK, MOVE_ICY_WIND, MOVE_U_TURN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAY_ROUTE_110_MUDKIP */,
    {
    .lvl = 2,
    .species = SPECIES_DRACOVISH,
    .heldItem = ITEM_CHOICE_BAND,
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute110Treecko[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_MIXED,
    .moves = MOVE_TRI_ATTACK, MOVE_ICY_WIND, MOVE_U_TURN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAY_ROUTE_110_TREECKO */,
    {
    .lvl = 2,
    .species = SPECIES_DRACOVISH,
    .heldItem = ITEM_CHOICE_BAND,
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute110Torchic[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_MIXED,
    .moves = MOVE_TRI_ATTACK, MOVE_ICY_WIND, MOVE_U_TURN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAY_ROUTE_110_TORCHIC */,
    {
    .lvl = 2,
    .species = SPECIES_DRACOVISH,
    .heldItem = ITEM_CHOICE_BAND,
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute119Mudkip[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HURRICANE, MOVE_BOOMBURST, MOVE_HEAT_WAVE, MOVE_U_TURN
    } /* Verdant polish: TRAINER_MAY_ROUTE_119_MUDKIP */,
    {
    .lvl = 0,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FRENZY_PLANT, MOVE_DRAGON_PULSE, MOVE_PROTECT, MOVE_GRASSY_TERRAIN
    } /* Verdant polish: TRAINER_MAY_ROUTE_119_MUDKIP */
};
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute119Treecko[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HURRICANE, MOVE_BOOMBURST, MOVE_HEAT_WAVE, MOVE_U_TURN
    } /* Verdant polish: TRAINER_MAY_ROUTE_119_TREECKO */,
    {
    .lvl = 0,
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SHADOW_CLAW, MOVE_PLAY_ROUGH, MOVE_PROTECT, MOVE_SHADOW_SNEAK
    } /* Verdant polish: TRAINER_MAY_ROUTE_119_TREECKO */,
    {
    .lvl = 0,
    .species = SPECIES_VIKAVOLT,
...
static const struct TrainerMonItemCustomMoves sParty_MayRoute119Torchic[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HURRICANE, MOVE_BOOMBURST, MOVE_HEAT_WAVE, MOVE_U_TURN
    } /* Verdant polish: TRAINER_MAY_ROUTE_119_TORCHIC */,
    {
    .lvl = 0,
    .species = SPECIES_RAPIDASH,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_MayLilycoveTreecko[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDERBOLT, MOVE_BUG_BUZZ, MOVE_ENERGY_BALL, MOVE_STICKY_WEB
    } /* Verdant polish: TRAINER_MAY_LILYCOVE_TREECKO */,
    {
    .lvl = 1,
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_FLAME_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt14[] = { // Slateport Museum
    ...
    } /* Verdant polish: TRAINER_GRUNT_MUSEUM_1 */,
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt15[] = { // Slateport
    ...
    } /* Verdant polish: TRAINER_GRUNT_MUSEUM_2 */,
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_Grunt24[] = { // Mt. Chimney
    ...
    .moves = MOVE_STONE_EDGE, MOVE_BODY_PRESS, MOVE_HEAVY_SLAM, MOVE_WIDE_GUARD
    } /* Verdant polish: TRAINER_GRUNT_MT_CHIMNEY_1 */,
    {
    .lvl = 3,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HEAT_WAVE, MOVE_SHADOW_BALL, MOVE_PSYCHIC, MOVE_FLAMETHROWER
    } /* Verdant polish: TRAINER_GRUNT_MT_CHIMNEY_1 */,
    {
    .lvl = 4,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_EARTH_POWER, MOVE_SHADOW_BALL, MOVE_SHORE_UP, MOVE_GIGA_DRAIN
    } /* Verdant polish: TRAINER_GRUNT_MT_CHIMNEY_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Grunt30[] = { // Jagged Pass
    ...
    .moves = MOVE_STOMPING_TANTRUM, MOVE_SNAP_TRAP, MOVE_YAWN, MOVE_STEALTH_ROCK
    } /* Verdant polish: TRAINER_GRUNT_JAGGED_PASS */,
    {
    .lvl = 2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DARK_PULSE, MOVE_PSYCHIC, MOVE_SNARL, MOVE_PARTING_SHOT
    } /* Verdant polish: TRAINER_GRUNT_JAGGED_PASS */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_STONE_EDGE, MOVE_SUCKER_PUNCH, MOVE_NIGHT_SLASH
    } /* Verdant polish: TRAINER_GRUNT_JAGGED_PASS */
};
...
static const struct TrainerMonItemCustomMoves sParty_Grunt31[] = { // Mt. Chimney
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DYNAMIC_PUNCH, MOVE_HIGH_HORSEPOWER, MOVE_POLTERGEIST, MOVE_ICE_PUNCH
    } /* Verdant polish: TRAINER_GRUNT_MT_CHIMNEY_2 */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_GLARE, MOVE_COIL, MOVE_BODY_PRESS
    } /* Verdant polish: TRAINER_GRUNT_MT_CHIMNEY_2 */,
    {
    .lvl = 4,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_KNOCK_OFF, MOVE_TAUNT, MOVE_STONE_EDGE
    } /* Verdant polish: TRAINER_GRUNT_MT_CHIMNEY_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Archie1[] = { // Slateport
    ...
    } /* Verdant polish: TRAINER_ARCHIE_SLATEPORT */,
    {
    .lvl = 1,
...
static const struct TrainerMonItemCustomMoves sParty_Calvin1[] = {
    ...
    } /* Verdant polish: TRAINER_CALVIN_1 */,
    {
    .lvl = 0,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FACADE, MOVE_FIRE_PUNCH, MOVE_SWORDS_DANCE, MOVE_CLOSE_COMBAT
    } /* Verdant custom: Route 102 — Verdant custom: Route 102 / Normal-rule breaker */
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy1[] = {
    ...
    } /* Verdant polish: TRAINER_CINDY_1 */,
    {
    .lvl = 1,
...
static const struct TrainerMonItemCustomMoves sParty_Cindy2[] = {
    ...
    } /* Verdant polish: TRAINER_CINDY_2 */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PSYCHIC, MOVE_LEAF_STORM, MOVE_HIDDEN_POWER, MOVE_TOXIC
    } /* Verdant polish: TRAINER_CINDY_2 */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ELECTROWEB, MOVE_VOLT_SWITCH, MOVE_LEAF_STORM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CINDY_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Cindy4[] = {
    ...
    } /* Verdant polish: TRAINER_CINDY_4 */,
    {
    .lvl = -2,
    .species = SPECIES_FURRET,
    .heldItem = ITEM_SITRUS_BERRY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SEED_BOMB, MOVE_GUNK_SHOT, MOVE_KNOCK_OFF, MOVE_THUNDER_WAVE
    } /* Verdant polish: TRAINER_CINDY_4 */,
    {
    .lvl = -2,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_EARTH_POWER, MOVE_PROTECT, MOVE_GIGA_DRAIN, MOVE_HIDDEN_POWER
    } /* Verdant custom: Route 104 — Verdant custom: Route 104 / Normal-rule breaker */,
    {
    .lvl = -2,
...
static const struct TrainerMonItemCustomMoves sParty_Winston4[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SWORDS_DANCE, MOVE_QUICK_ATTACK, MOVE_CRUNCH, MOVE_AQUA_JET
    } /* Verdant polish: TRAINER_WINSTON_4 */,
    {
    .lvl = -2,
    .species = SPECIES_PIDGEOT,
    .heldItem = ITEM_NUGGET,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HURRICANE, MOVE_ROOST, MOVE_TAILWIND, MOVE_FEATHER_DANCE
    } /* Verdant polish: TRAINER_WINSTON_4 */,
    {
    .lvl = -2,
    .species = SPECIES_LUXRAY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_WILD_CHARGE, MOVE_CRUNCH, MOVE_PLAY_ROUGH, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_WINSTON_4 */,
    {
    .lvl = -2,
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_BODY_SLAM, MOVE_CURSE, MOVE_PROTECT
    } /* Verdant custom: Route 104 — Verdant custom: Route 104 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_GinaAndMia1[] = {
    ...
    } /* Verdant polish: TRAINER_GINA_AND_MIA_1 */,
    {
    .lvl = 1,
    ...
    },
{
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_MEGAHORN, MOVE_KNOCK_OFF, MOVE_ROCK_SLIDE, MOVE_CLOSE_COMBAT
    } /* Verdant custom: Petalburg Woods — Verdant custom: Petalburg Woods / Bug swarm utility */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jose[] = { // Route 116
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_POWDER, MOVE_HURRICANE, MOVE_SLEEP_POWDER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOSE */,
    {
    .lvl = 2,
    .species = SPECIES_CHARJABUG,
    .heldItem = ITEM_EVIOLITE,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_ELECTROWEB, MOVE_VOLT_SWITCH, MOVE_STRUGGLE_BUG, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOSE */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DUAL_WINGBEAT, MOVE_BUG_BITE, MOVE_QUICK_ATTACK, MOVE_BRICK_BREAK
    } /* Verdant polish: TRAINER_JOSE */
};
...
static const struct TrainerMonItemCustomMoves sParty_Karen1[] = { // Route 116
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_WONDER_ROOM, MOVE_PSYCHIC, MOVE_ENERGY_BALL, MOVE_SIMPLE_BEAM
    } /* Verdant polish: TRAINER_KAREN_1 */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_IRON_TAIL, MOVE_DRAGON_TAIL
    } /* Verdant polish: TRAINER_KAREN_1 */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SCALD, MOVE_AIR_SLASH, MOVE_ICE_BEAM, MOVE_AQUA_RING
    } /* Verdant polish: TRAINER_KAREN_1 */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SHADOW_SNEAK, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH, MOVE_THUNDER_PUNCH
    } /* Verdant polish: TRAINER_KAREN_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Karen4[] = {
    ...
    } /* Verdant polish: TRAINER_KAREN_4 */,
    {
    .lvl = -2,
    .species = SPECIES_LUCARIO,
    .heldItem = ITEM_NORMAL_GEM,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_FAKE_OUT, MOVE_LEAF_STORM, MOVE_PROTECT, MOVE_TAUNT
    } /* Verdant polish: TRAINER_KAREN_4 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Clark[] = { // Route 116
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_GRAVITY, MOVE_BODY_PRESS, MOVE_MOONBLAST, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CLARK */,
    {
    .lvl = 3,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_STONE_EDGE, MOVE_MEGAHORN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CLARK */,
    {
    .lvl = 4,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_HASTY,
    .moves = MOVE_CHARGE_BEAM, MOVE_POWER_GEM, MOVE_DAZZLING_GLEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CLARK */
};
...
static const struct TrainerMonItemCustomMoves sParty_Devan[] = { // Route 116
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_YAWN, MOVE_HIGH_HORSEPOWER, MOVE_WHIRLWIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_DEVAN */,
    {
    .lvl = 2,
    .species = SPECIES_DRILBUR,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_ROCK_SLIDE, MOVE_X_SCISSOR, MOVE_PROTECT
    } /* Verdant polish: TRAINER_DEVAN */,
    {
    .lvl = 2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SEED_BOMB, MOVE_SUCKER_PUNCH, MOVE_DRAIN_PUNCH, MOVE_LEECH_SEED
    } /* Verdant polish: TRAINER_DEVAN */,
    {
    .lvl = 3,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HEAVY_SLAM, MOVE_BODY_PRESS, MOVE_METAL_BURST, MOVE_PROTECT
    } /* Verdant polish: TRAINER_DEVAN */
};
...
static const struct TrainerMonItemCustomMoves sParty_Johnson[] = { // Route 116
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_GRAVITY, MOVE_FOLLOW_ME, MOVE_HELPING_HAND, MOVE_MOONBLAST
    } /* Verdant polish: TRAINER_JOHNSON */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BRAVE_BIRD, MOVE_ROCK_SLIDE, MOVE_SUPERPOWER, MOVE_U_TURN
    } /* Verdant polish: TRAINER_JOHNSON */,
    {
    .lvl = 4,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ICE_PUNCH, MOVE_ZEN_HEADBUTT, MOVE_HAMMER_ARM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOHNSON */
};
...
static const struct TrainerMonItemCustomMoves sParty_Sarah[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_TRICK_ROOM, MOVE_DIAMOND_STORM, MOVE_DAZZLING_GLEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SARAH */,
    {
    .lvl = 1,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_SHADOW_BALL, MOVE_THIEF, MOVE_SUBSTITUTE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SARAH */
};
...
static const struct TrainerMonItemCustomMoves sParty_Dawson[] = { // Route 116
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_FAKE_OUT, MOVE_IRON_HEAD, MOVE_KNOCK_OFF, MOVE_U_TURN
    } /* Verdant polish: TRAINER_DAWSON */,
    {
    .lvl = 3,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_DEFENSE_CURL, MOVE_ROLLOUT, MOVE_DOUBLE_EDGE, MOVE_REST
    } /* Verdant polish: TRAINER_DAWSON */,
    {
    .lvl = 4,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_TAIL_SLAP, MOVE_BULLET_SEED, MOVE_TRIPLE_AXEL, MOVE_U_TURN
    } /* Verdant polish: TRAINER_DAWSON */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jerry1[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_GEAR_GRIND, MOVE_WILD_CHARGE, MOVE_RETURN, MOVE_ROCK_SMASH
    } /* Verdant polish: TRAINER_JERRY_1 */,
    {
    .lvl = 2,
    .species = SPECIES_TOGEDEMARU,
    .heldItem = ITEM_AIR_BALLOON,
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_ZING_ZAP, MOVE_ENCORE, MOVE_SPIKY_SHIELD
    } /* Verdant polish: TRAINER_JERRY_1 */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_THUNDER_PUNCH, MOVE_ICE_PUNCH, MOVE_CROSS_CHOP, MOVE_VOLT_SWITCH
    } /* Verdant polish: TRAINER_JERRY_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jerry2[] = {
    ...
    } /* Verdant polish: TRAINER_JERRY_2 */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_KARATE_CHOP, MOVE_WORK_UP, MOVE_COMET_PUNCH, MOVE_SKY_UPPERCUT
    } /* Verdant polish: TRAINER_JERRY_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jerry4[] = {
    ...
    } /* Verdant polish: TRAINER_JERRY_4 */,
    {
    .lvl = -2,
    .species = SPECIES_BANETTE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HAMMER_ARM, MOVE_CRUNCH, MOVE_ROCK_SLIDE, MOVE_PARTING_SHOT
    } /* Verdant polish: TRAINER_JERRY_4 */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SLEEP_POWDER, MOVE_POWER_WHIP, MOVE_LEECH_SEED, MOVE_RETURN
    } /* Verdant polish: TRAINER_JERRY_4 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Janice[] = { // Route 116
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_RISING_VOLTAGE, MOVE_DISCHARGE, MOVE_SCALD, MOVE_RECOVER
    } /* Verdant polish: TRAINER_JANICE */,
    {
    .lvl = 2,
    .species = SPECIES_MIMIKYU,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SHADOW_CLAW, MOVE_PLAY_ROUGH, MOVE_SHADOW_SNEAK, MOVE_DRAIN_PUNCH
    } /* Verdant polish: TRAINER_JANICE */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BELLY_DRUM, MOVE_PLAY_ROUGH, MOVE_RETURN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JANICE */
};
...
static const struct TrainerMonItemCustomMoves sParty_Grunt10[] = { // Aqua
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_ORDER_UP, MOVE_WAVE_CRASH, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GRUNT_RUSTURF_TUNNEL */,
    {
    .lvl = 1,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_MUDDY_WATER, MOVE_DRAGON_PULSE, MOVE_TAUNT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GRUNT_RUSTURF_TUNNEL */,
    {
    .lvl = 1,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FAKE_OUT, MOVE_TOXIC, MOVE_VENOSHOCK, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GRUNT_RUSTURF_TUNNEL */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_VENOSHOCK, MOVE_WIDE_GUARD, MOVE_RECOVER, MOVE_HAZE
    } /* Verdant polish: TRAINER_GRUNT_RUSTURF_TUNNEL */
};
...
static const struct TrainerMonItemCustomMoves sParty_Mike2[] = { // Actually the first and only Mike
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_CURSE, MOVE_BODY_PRESS
    } /* Verdant polish: TRAINER_MIKE_2 */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CLOSE_COMBAT, MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_BULK_UP
    } /* Verdant polish: TRAINER_MIKE_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne1[] = {
    ...
    } /* Verdant polish: TRAINER_ROXANNE_1 */,
    {
    .lvl = 3,
...
static const struct TrainerMonItemCustomMoves sParty_Roxanne2[] = { // Singles
    ...
    } /* Verdant polish: TRAINER_ROXANNE_2 */,
    {
    .lvl = 0,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BRAVE_BIRD, MOVE_ROCK_SLIDE, MOVE_EARTHQUAKE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_ROXANNE_2 */,
    {
    .lvl = 0,
...
static const struct TrainerMonItemCustomMoves sParty_Ned[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_RAIN_DANCE, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_U_TURN
    } /* Verdant polish: TRAINER_NED */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_FREEZE_DRY, MOVE_BRINE, MOVE_ENCORE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_NED */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SURF, MOVE_HURRICANE, MOVE_ICE_BEAM, MOVE_ROOST
    } /* Verdant polish: TRAINER_NED */
};
...
static const struct TrainerMonItemCustomMoves sParty_Elliot1[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_WHIRLPOOL, MOVE_NIGHT_SHADE, MOVE_RECOVER, MOVE_TAUNT
    },
    {
    .lvl = 2,
    .species = SPECIES_CLAUNCHER,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_WATER_PULSE, MOVE_DRAGON_PULSE, MOVE_ICE_BEAM, MOVE_SLUDGE_BOMB
    },
    {
    .lvl = 3,
...
static const struct TrainerMonItemCustomMoves sParty_Elliot4[] = {
    ...
    } /* Verdant polish: TRAINER_ELLIOT_4 */,
    {
    .lvl = -3,
    .species = SPECIES_JELLICENT,
    .heldItem = ITEM_NONE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_TAIL_GLOW, MOVE_MUDDY_WATER, MOVE_ICE_BEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_ELLIOT_4 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jocelyn[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_FAKE_OUT, MOVE_TAUNT, MOVE_FAKE_TEARS, MOVE_FOUL_PLAY
    } /* Verdant polish: TRAINER_JOCELYN */,
    {
    .lvl = 3,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPERSPACE_HOLE, MOVE_DARK_PULSE, MOVE_FOCUS_BLAST, MOVE_THUNDERBOLT
    } /* Verdant polish: TRAINER_JOCELYN */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_IRON_HEAD, MOVE_KNOCK_OFF, MOVE_SUCKER_PUNCH, MOVE_BRICK_BREAK
    } /* Verdant polish: TRAINER_JOCELYN */,
    {
    .lvl = 2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PSYCHIC, MOVE_HEAT_WAVE, MOVE_GIGA_DRAIN, MOVE_ROOST
    } /* Verdant polish: TRAINER_JOCELYN */
};
...
static const struct TrainerMonItemCustomMoves sParty_Laura[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_U_TURN, MOVE_DRAIN_PUNCH, MOVE_ACROBATICS
    } /* Verdant polish: TRAINER_LAURA */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_CLOSE_COMBAT, MOVE_HEAVY_SLAM, MOVE_KNOCK_OFF, MOVE_WIDE_GUARD
    } /* Verdant polish: TRAINER_LAURA */,
    {
    .lvl = 1,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_GUNK_SHOT, MOVE_DRAIN_PUNCH, MOVE_SUCKER_PUNCH, MOVE_ICE_PUNCH
    } /* Verdant polish: TRAINER_LAURA */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_RETURN, MOVE_CRUNCH, MOVE_EARTHQUAKE, MOVE_FIRE_FANG
    } /* Verdant polish: TRAINER_LAURA */
};
...
static const struct TrainerMonItemCustomMoves sParty_Brenden[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BRICK_BREAK, MOVE_IRON_HEAD, MOVE_AERIAL_ACE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRENDEN */,
    {
    .lvl = 3,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PSYCHIC, MOVE_ENERGY_BALL, MOVE_SHADOW_BALL, MOVE_RECOVER
    } /* Verdant polish: TRAINER_BRENDEN */,
    {
    .lvl = 2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BRICK_BREAK, MOVE_ICE_PUNCH, MOVE_SUCKER_PUNCH, MOVE_WATERFALL
    } /* Verdant polish: TRAINER_BRENDEN */
};
...
static const struct TrainerMonItemCustomMoves sParty_Lilith[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_ZEN_HEADBUTT, MOVE_DRAIN_PUNCH, MOVE_THUNDER_PUNCH
    },
    {
    .lvl = 2,
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FAKE_OUT, MOVE_DRAIN_PUNCH, MOVE_KNOCK_OFF, MOVE_HEADBUTT
    },
    {
    .lvl = 3,
    ...
    .ability = 0, // Fluffy
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BRICK_BREAK, MOVE_ROCK_SLIDE, MOVE_BRUTAL_SWING, MOVE_WIDE_GUARD
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Cristian[] = {
    ...
    .ability = 2, // Prankster
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BULK_UP, MOVE_DRAIN_PUNCH, MOVE_CRUNCH, MOVE_POISON_JAB
    },
    {
    .lvl = 2,
    ...
    .ability = 2, // Scrappy
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_LEAF_BLADE, MOVE_NIGHT_SLASH, MOVE_BRAVE_BIRD, MOVE_BRICK_BREAK
    },
    {
    .lvl = 3,
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SUPERPOWER, MOVE_STONE_EDGE, MOVE_KNOCK_OFF, MOVE_POISON_JAB
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Takao[] = {
    ...
    .heldItem = ITEM_SCOPE_LENS,
    .ability = 0, // Guts; No Guard remains reserved for Brawly
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FOCUS_ENERGY, MOVE_CROSS_CHOP, MOVE_KNOCK_OFF, MOVE_ICE_PUNCH
    },
    {
    .lvl = 2,
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FORCE_PALM, MOVE_ROCK_SLIDE, MOVE_POISON_JAB, MOVE_THUNDER_PUNCH
    },
    {
    .lvl = 3,
    .species = SPECIES_JANGMO_O,
    .heldItem = ITEM_ROSELI_BERRY,
    .ability = 0, // Bulletproof
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DRAGON_CLAW, MOVE_BRICK_BREAK, MOVE_IRON_HEAD, MOVE_PROTECT
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly1[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_FOLLOW_ME, MOVE_NUZZLE, MOVE_SUPER_FANG, MOVE_HELPING_HAND
    },
    {
    .lvl = 3,
    ...
    .ability = 2, // Defiant
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_NO_RETREAT, MOVE_CLOSE_COMBAT, MOVE_ROCK_SLIDE, MOVE_POISON_JAB
    },
    {
    .lvl = 3,
    .species = SPECIES_HITMONTOP,
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DAZZLING_GLEAM, MOVE_PSYCHIC, MOVE_WILL_O_WISP, MOVE_HELPING_HAND
    },
    {
    .lvl = 4,
    .species = SPECIES_BRELOOM,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FACADE, MOVE_MACH_PUNCH, MOVE_SEED_BOMB, MOVE_ROCK_TOMB
    },
    {
    .lvl = 5,
    .species = SPECIES_HAWLUCHA,
    .heldItem = ITEM_HAWLUCHANITE,
    .ability = 1, // Unburden before Mega; No Guard after Mega
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HIGH_JUMP_KICK, MOVE_STONE_EDGE, MOVE_BRAVE_BIRD, MOVE_FEINT
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Brawly2[] = { // singles
    ...
    } /* Verdant polish: TRAINER_BRAWLY_2 */,
    {
    .lvl = 0,
    ...
    },
{
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_IRON_HEAD, MOVE_CLOSE_COMBAT, MOVE_U_TURN, MOVE_PLAY_ROUGH
    },
{
    .lvl = 3,
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_POWER_WHIP, MOVE_POLTERGEIST, MOVE_ANCHOR_SHOT, MOVE_EARTHQUAKE
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Edmond[] = {
    ...
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_FUTURE_SIGHT, MOVE_SCALD, MOVE_SLACK_OFF, MOVE_THUNDER_WAVE
    },
    {
    .lvl = 2,
    ...
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SLUDGE_BOMB, MOVE_WILL_O_WISP, MOVE_FLAMETHROWER, MOVE_PAIN_SPLIT
    },
    {
    .lvl = 3,
    ...
    .ability = 2, // Reckless
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_BRAVE_BIRD, MOVE_DOUBLE_EDGE, MOVE_U_TURN, MOVE_STEEL_WING
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Hailey[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_LIGHT_SCREEN, MOVE_DISCHARGE, MOVE_POWER_GEM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_HAILEY */,
    {
    .lvl = 2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_MUDDY_WATER, MOVE_EARTH_POWER, MOVE_SLUDGE_WAVE, MOVE_ICY_WIND
    } /* Verdant polish: TRAINER_HAILEY */,
    {
    .lvl = 2,
    .species = SPECIES_AZUMARILL,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_LIQUIDATION, MOVE_PLAY_ROUGH, MOVE_KNOCK_OFF, MOVE_ICE_PUNCH
    } /* Verdant polish: TRAINER_HAILEY */,
    {
    .lvl = 3,
    .species = SPECIES_BIBAREL,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_RETURN, MOVE_WATERFALL, MOVE_CRUNCH, MOVE_SUPERPOWER
    } /* Verdant polish: TRAINER_HAILEY */
};
...
static const struct TrainerMonItemCustomMoves sParty_Ricky1[] = {
    ...
    .heldItem = ITEM_FIGY_BERRY,
    .ability = 0, // Cheek Pouch
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BODY_SLAM, MOVE_PAYBACK, MOVE_SEED_BOMB, MOVE_GYRO_BALL
    },
    {
    .lvl = 3,
    ...
    },
{
    ...
    } /* Verdant custom: Route 109 — Verdant custom: Route 109 / Normal-rule breaker */,
    {
    .lvl = -1,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PROTECT, MOVE_U_TURN, MOVE_SKY_DROP, MOVE_HURRICANE
    } /* Verdant custom: Route 109 — Verdant custom: Route 109 / Normal-rule breaker */
};
...
static const struct TrainerMonItemCustomMoves sParty_Lola1[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SUNNY_DAY, MOVE_WEATHER_BALL, MOVE_HELPING_HAND, MOVE_DAZZLING_GLEAM
    } /* Verdant polish: TRAINER_LOLA_1 */,
    {
    .lvl = 2,
    .species = SPECIES_LEAFEON,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_LEAF_BLADE, MOVE_DOUBLE_EDGE, MOVE_KNOCK_OFF, MOVE_X_SCISSOR
    } /* Verdant polish: TRAINER_LOLA_1 */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_GIGA_DRAIN, MOVE_DRAINING_KISS, MOVE_FLORAL_HEALING, MOVE_TAUNT
    } /* Verdant polish: TRAINER_LOLA_1 */,
    {
    .lvl = 3,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SEED_FLARE, MOVE_EARTH_POWER, MOVE_AIR_SLASH, MOVE_PSYCHIC
    } /* Verdant polish: TRAINER_LOLA_1 */
};
...

{
    ...
    .ability = 0, // Hydration
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_RAIN_DANCE, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_REST
    },
{
    .lvl = 2,
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDER, MOVE_VOLT_SWITCH, MOVE_SIGNAL_BEAM, MOVE_HIDDEN_POWER
    },
{
    .lvl = 3,
    ...
    .ability = 0, // Levitate
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FREEZE_DRY, MOVE_FLASH_CANNON, MOVE_ANCIENT_POWER, MOVE_SIGNAL_BEAM
    }
};
...
static const struct TrainerMonItemCustomMoves sParty_Johanna[] = {
    ...
    } /* Verdant polish: TRAINER_JOHANNA */,
    {
    .lvl = 2,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_THUNDER_WAVE, MOVE_MAGNET_RISE, MOVE_HIDDEN_POWER, MOVE_FLASH_CANNON
    } /* Verdant custom: Route 110 — Verdant custom: Route 110 / Electric terrain */
};
...
static const struct TrainerMonItemCustomMoves sParty_Isabel3[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_VOLT_TACKLE, MOVE_FAKE_OUT, MOVE_BRICK_BREAK, MOVE_IRON_TAIL
    },
    {
    .lvl = -3,
    .species = SPECIES_PACHIRISU,
...
static const struct TrainerMonItemCustomMoves sParty_Edwin1[] = {
    ...
    } /* Verdant polish: TRAINER_EDWIN_1 */,
    {
    .lvl = 1,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SKY_UPPERCUT, MOVE_SUBSTITUTE, MOVE_FLARE_BLITZ, MOVE_SWORDS_DANCE
    ...
    },
{
    ...
    } /* Verdant custom: Route 103 — Verdant custom: Route 103 / Sun offense */,
    {
    .lvl = -2,
    .species = SPECIES_CHERRIM,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ENERGY_BALL, MOVE_POLLEN_PUFF, MOVE_PROTECT, MOVE_AROMATHERAPY
    } /* Verdant custom: Route 103 — Verdant custom: Route 103 / Sun offense */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_WISH, MOVE_THUNDERBOLT, MOVE_HEAL_BELL, MOVE_FIRE_BLAST
    } /* Verdant custom: Route 103 — Verdant custom: Route 103 / Balanced disruption */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_TAUNT, MOVE_ENCORE, MOVE_TOXIC, MOVE_LEECH_SEED
    } /* Verdant custom: Route 103 — Verdant custom: Route 103 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FOCUS_BLAST, MOVE_THUNDERBOLT, MOVE_DAZZLING_GLEAM, MOVE_CLOSE_COMBAT
    } /* Verdant custom: Route 103 — Verdant explicit team design */,
    {
    .lvl = -2,
    .species = SPECIES_SMEARGLE,
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_SPIKES, MOVE_STEALTH_ROCK, MOVE_SPORE, MOVE_DESTINY_BOND
    } /* Verdant custom: Route 103 — Verdant explicit team design */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_LOW_KICK, MOVE_U_TURN, MOVE_ICE_PUNCH, MOVE_FAKE_OUT
    } /* Verdant custom: Route 103 — Verdant custom: Route 103 / Normal-rule breaker */,
    {
    .lvl = -2,
...
static const struct TrainerMonItemCustomMoves sParty_Miguel4[] = {
    ...
    } /* Verdant polish: TRAINER_MIGUEL_4 */,
    {
    .lvl = -2,
    .species = SPECIES_PERSIAN,
    .heldItem = ITEM_SITRUS_BERRY,
...
static const struct TrainerMonItemCustomMoves sParty_Andrew[] = {
    ...
    .ability = 0,
    .spread = SPREAD_10_IV_0_EV,
    .moves = MOVE_SCALD, MOVE_ICE_BEAM, MOVE_DRAGON_BREATH, MOVE_SMOKESCREEN
    } /* Verdant polish: TRAINER_ANDREW */,
    {
    .lvl = -3,
    .species = SPECIES_QWILFISH,
    ...
    },
{
    ...
    } /* Verdant custom: Route 110 Trick House Puzzle 2 — Verdant custom: Route 110 Trick House Puzzle 2 / Balanced disruption */,
    {
    .lvl = -2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_HEAT_CRASH, MOVE_HEAVY_SLAM
    } /* Verdant custom: Route 110 Trick House Puzzle 2 — Verdant custom: Route 110 Trick House Puzzle 2 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Georgia[] = {
    ...
    } /* Verdant polish: TRAINER_GEORGIA */,
    {
    .lvl = -2,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PSYCHIC_FANGS, MOVE_PROTECT, MOVE_BULLET_PUNCH, MOVE_IRON_HEAD
    } /* Verdant custom: Route 110 Trick House Puzzle 3 — Verdant custom: Route 110 Trick House Puzzle 3 / Trick Room control */
};
...
static const struct TrainerMonItemCustomMoves sParty_Martha[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_VOLT_SWITCH, MOVE_OVERHEAT, MOVE_ELECTROWEB, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MARTHA */
};
...
static const struct TrainerMonItemCustomMoves sParty_Alan[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_RECOVER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_ALAN */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 110 Trick House Puzzle 4 — Verdant hand-authored competitive core */,
    {
    .lvl = -2,
    .species = SPECIES_TERRAKION,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ROCK_SLIDE, MOVE_CLOSE_COMBAT, MOVE_QUICK_GUARD, MOVE_PROTECT
    } /* Verdant custom: Route 110 Trick House Puzzle 4 — Verdant hand-authored competitive core */
};
...
static const struct TrainerMonItemCustomMoves sParty_Sebastian[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BULLET_PUNCH, MOVE_SWORDS_DANCE, MOVE_BUG_BITE, MOVE_ROOST
    } /* Verdant polish: TRAINER_SEBASTIAN */,
    {
    .lvl = -2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_RAGE_POWDER, MOVE_SLUDGE_BOMB, MOVE_SPORE, MOVE_GIGA_DRAIN
    } /* Verdant polish: TRAINER_SEBASTIAN */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 110 Trick House Puzzle 6 — Verdant custom: Route 110 Trick House Puzzle 6 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Benny[] = {
    ...
    } /* Verdant custom: individual diversity replacement for TRAINER_BENNY */,
{
    .lvl = -3,
    .species = SPECIES_XATU,
    ...
    },
{
    ...
    } /* Verdant custom: Route 110 Trick House Puzzle 7 — Verdant custom: Route 110 Trick House Puzzle 7 / Balanced disruption */,
    {
    .lvl = -3,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_OVERHEAT, MOVE_STEALTH_ROCK, MOVE_HIDDEN_POWER, MOVE_FAKE_OUT
    } /* Verdant custom: Route 110 Trick House Puzzle 7 — Verdant custom: Route 110 Trick House Puzzle 7 / Balanced disruption */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 110 Trick House Puzzle 7 — Verdant explicit team design */,
    {
    .lvl = -3,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_TRICK_ROOM, MOVE_PSYCHIC, MOVE_SIGNAL_BEAM, MOVE_PROTECT
    } /* Verdant custom: Route 110 Trick House Puzzle 7 — Verdant custom: Route 110 Trick House Puzzle 7 / Psychic terrain */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SOLAR_BEAM, MOVE_PROTECT, MOVE_WEATHER_BALL, MOVE_HEAT_WAVE
    } /* Verdant custom: Route 110 Trick House Puzzle 7 — Verdant explicit team design */,
    {
    .lvl = -3,
    .species = SPECIES_LILLIGANT,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_AFTER_YOU, MOVE_SLEEP_POWDER, MOVE_SOLAR_BEAM, MOVE_PROTECT
    } /* Verdant custom: Route 110 Trick House Puzzle 7 — Verdant explicit team design */
};
...
static const struct TrainerMonItemCustomMoves sParty_Vincent[] = {
    ...
    } /* Verdant polish: TRAINER_VINCENT */,
    {
    .lvl = 0,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_TAILWIND, MOVE_QUIVER_DANCE
    } /* Verdant polish: TRAINER_VINCENT */,
    {
    .lvl = 0,
...
static const struct TrainerMonItemCustomMoves sParty_Keira[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EXPLOSION, MOVE_TOXIC, MOVE_STEALTH_ROCK, MOVE_POWER_GEM
    } /* Verdant polish: TRAINER_KEIRA */,
    {
    .lvl = -100,
    .species = SPECIES_ARON,
    .heldItem = ITEM_BERRY_JUICE,
    ...
    .moves = MOVE_ENDEAVOR, MOVE_SANDSTORM, MOVE_TOXIC, MOVE_PROTECT
    } /* Verdant polish: TRAINER_KEIRA */,
    {
    .lvl = -100,
    ...
    .ability = 1,
    .spread = SPREAD_0_IV_EV,
    .moves = MOVE_RECYCLE, MOVE_TOXIC, MOVE_PROTECT, MOVE_SHOCK_WAVE
    } /* Verdant polish: TRAINER_KEIRA */,
    {
    .lvl = -100,
    .species = SPECIES_SWINUB,
    ...
    .ability = 0,
    .spread = SPREAD_0_IV_EV,
    .moves = MOVE_ENDEAVOR, MOVE_ICE_SHARD, MOVE_STEALTH_ROCK, MOVE_PROTECT
    } /* Verdant polish: TRAINER_KEIRA */,
    {
    .lvl = 0,
    .species = SPECIES_WHIMSICOTT,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_IRON_DEFENSE, MOVE_BODY_PRESS, MOVE_TAILWIND, MOVE_BRAVE_BIRD
    } /* Verdant custom: Route 118 — Verdant custom: Route 118 / Balanced disruption */
};
...
/*     {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PLAY_ROUGH, MOVE_SNARL, MOVE_PROTECT, MOVE_CRUNCH
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_NO_RETREAT, MOVE_IRON_HEAD, MOVE_KNOCK_OFF, MOVE_CLOSE_COMBAT
    } /* Verdant custom: Route 117 — Verdant custom: Route 117 / Balanced disruption */,
    {
    .lvl = 0,
    .species = SPECIES_SAWK,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_PROTECT, MOVE_ROCK_SLIDE
    } /* Verdant custom: Route 117 — Verdant custom: Route 117 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_AnnaAndMeg3[] = {
    ...
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_TAIL_SLAP, MOVE_BULLET_SEED, MOVE_ROCK_BLAST, MOVE_AQUA_TAIL
    } /* Verdant polish: TRAINER_ANNA_AND_MEG_3 */,
    {
    .lvl = 0,
    .species = SPECIES_CONKELDURR,
    .heldItem = ITEM_NONE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_STORM_THROW, MOVE_PROTECT, MOVE_KNOCK_OFF, MOVE_POISON_JAB
    } /* Verdant polish: TRAINER_ANNA_AND_MEG_3 */,
    {
    .lvl = 0,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PROTECT, MOVE_POISON_JAB, MOVE_KNOCK_OFF, MOVE_CLOSE_COMBAT
    } /* Verdant polish: TRAINER_ANNA_AND_MEG_3 */
};
...
static const struct TrainerMonItemCustomMoves sParty_AnnaAndMeg4[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_TAIL_SLAP, MOVE_BULLET_SEED, MOVE_ROCK_BLAST, MOVE_AQUA_TAIL
    } /* Verdant polish: TRAINER_ANNA_AND_MEG_4 */,
    {
    .lvl = 0,
    .species = SPECIES_CONKELDURR,
    .heldItem = ITEM_NONE,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SUCKER_PUNCH, MOVE_STONE_EDGE, MOVE_CLOSE_COMBAT, MOVE_RAPID_SPIN
    } /* Verdant polish: TRAINER_ANNA_AND_MEG_4 */,
    {
    .lvl = 0,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_STONE_EDGE, MOVE_RAPID_SPIN, MOVE_SUBSTITUTE, MOVE_MACH_PUNCH
    } /* Verdant polish: TRAINER_ANNA_AND_MEG_4 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Isaac4[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HEAD_SMASH, MOVE_CURSE, MOVE_SUCKER_PUNCH, MOVE_LOW_KICK
    } /* Verdant polish: TRAINER_ISAAC_4 */,
    {
    .lvl = -1,
    .species = SPECIES_SYLVEON,
    .heldItem = ITEM_THROAT_SPRAY,
...
static const struct TrainerMonItemCustomMoves sParty_Lydia1[] = {
    ...
    } /* Verdant polish: TRAINER_LYDIA_1 */,
    {
    .lvl = 1,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FAKE_OUT, MOVE_NASTY_PLOT, MOVE_THUNDERBOLT, MOVE_GRASS_KNOT
    } /* Verdant polish: TRAINER_LYDIA_1 */,
    {
    .lvl = 2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_FIRE_PUNCH, MOVE_MACH_PUNCH, MOVE_THUNDER_PUNCH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_LYDIA_1 */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FAKE_OUT, MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_SHADOW_BALL
    } /* Verdant polish: TRAINER_LYDIA_1 */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_HELPING_HAND, MOVE_CHARM, MOVE_LIGHT_SCREEN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_LYDIA_1 */,
    {
    .lvl = 4,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_DRAGON_DANCE, MOVE_DRAGON_RUSH, MOVE_EXTREME_SPEED, MOVE_PROTECT
    } /* Verdant polish: TRAINER_LYDIA_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Lydia4[] = {
    ...
    } /* Verdant polish: TRAINER_LYDIA_4 */,
    {
    .lvl = -1,
    .species = SPECIES_ELECTIVIRE,
    .heldItem = ITEM_NONE,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_EXTREME_SPEED, MOVE_WATERFALL, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_LYDIA_4 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Derek[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_GIGA_DRAIN, MOVE_BUG_BUZZ, MOVE_QUIVER_DANCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_DEREK */,
    {
    .lvl = 2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_ROCK_BLAST, MOVE_SUCKER_PUNCH, MOVE_BUG_BITE
    } /* Verdant polish: TRAINER_DEREK */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_FLASH_CANNON, MOVE_BUG_BUZZ, MOVE_IRON_DEFENSE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_DEREK */,
    {
    .lvl = 4,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_QUIVER_DANCE, MOVE_BUG_BUZZ, MOVE_AIR_SLASH, MOVE_PSYCHIC
    } /* Verdant polish: TRAINER_DEREK */
};
...
static const struct TrainerMonItemCustomMoves sParty_Brandi[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPEED_TIMID,
    .moves = MOVE_REFLECT, MOVE_LIGHT_SCREEN, MOVE_PSYCHIC, MOVE_HELPING_HAND
    } /* Verdant polish: TRAINER_BRANDI */,
    {
    .lvl = 3,
    .species = SPECIES_MUSHARNA,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_PSYCHIC, MOVE_MOONBLAST, MOVE_YAWN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRANDI */
};
...
static const struct TrainerMonItemCustomMoves sParty_Melina[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FLARE_BLITZ, MOVE_HIGH_HORSEPOWER, MOVE_WILD_CHARGE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MELINA */,
    {
    .lvl = 3,
    .species = SPECIES_BOLTUND,
    .heldItem = ITEM_MAGNET,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_THUNDER_FANG, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS, MOVE_PLAY_ROUGH
    } /* Verdant polish: TRAINER_MELINA */
};
...
static const struct TrainerMonItemCustomMoves sParty_Victor[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BRAVE_BIRD, MOVE_CLOSE_COMBAT, MOVE_U_TURN, MOVE_QUICK_ATTACK
    } /* Verdant polish: TRAINER_VICTOR */,
    {
    .lvl = 0,
    .species = SPECIES_DIGGERSBY,
    .heldItem = ITEM_SOFT_SAND,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_QUICK_ATTACK, MOVE_SWORDS_DANCE, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_VICTOR */,
    {
    .lvl = 1,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FACADE, MOVE_KNOCK_OFF, MOVE_OBSTRUCT, MOVE_CROSS_CHOP
    } /* Verdant polish: TRAINER_VICTOR */,
    {
    .lvl = 1,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_BODY_SLAM, MOVE_MILK_DRINK, MOVE_ZEN_HEADBUTT, MOVE_CURSE
    } /* Verdant polish: TRAINER_VICTOR */
};
...
static const struct TrainerMonItemCustomMoves sParty_Victoria[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_PETAL_DANCE, MOVE_QUIVER_DANCE, MOVE_GIGA_DRAIN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_VICTORIA */,
    {
    .lvl = 0,
    .species = SPECIES_WHIMSICOTT,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPEED_TIMID,
    .moves = MOVE_MOONBLAST, MOVE_LEECH_SEED, MOVE_ENCORE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_VICTORIA */,
    {
    .lvl = 1,
    .species = SPECIES_BLISSEY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_SOFT_BOILED, MOVE_SEISMIC_TOSS, MOVE_THUNDER_WAVE, MOVE_LIGHT_SCREEN
    } /* Verdant polish: TRAINER_VICTORIA */,
    {
    .lvl = 1,
    .species = SPECIES_ROSERADE,
...
static const struct TrainerMonItemCustomMoves sParty_Vivi[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_LEAF_STORM, MOVE_SUPERPOWER, MOVE_LEAF_BLADE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_VIVI */,
    {
    .lvl = 1,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_EARTH_POWER, MOVE_HEAT_WAVE, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_VIVI */,
    {
    .lvl = 2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_WATERFALL, MOVE_ICE_PUNCH, MOVE_EARTHQUAKE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_VIVI */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_VIVI */
};
...
static const struct TrainerMonItemCustomMoves sParty_Tyron[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SWORDS_DANCE, MOVE_DUAL_WINGBEAT, MOVE_BUG_BITE, MOVE_QUICK_ATTACK
    } /* Verdant polish: TRAINER_TYRON */,
    {
    .lvl = 3,
...
static const struct TrainerMonItemCustomMoves sParty_Celina[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_GASTRO_ACID, MOVE_LEAF_STORM, MOVE_SLUDGE_BOMB, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CELINA */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DOUBLE_EDGE, MOVE_HIGH_HORSEPOWER, MOVE_PLAY_ROUGH, MOVE_SUCKER_PUNCH
    } /* Verdant polish: TRAINER_CELINA */,
    {
    .lvl = 3,
    .species = SPECIES_GOLISOPOD,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_IRON_HEAD, MOVE_X_SCISSOR, MOVE_SUPERPOWER, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_CELINA */
};
...
static const struct TrainerMonItemCustomMoves sParty_Bianca[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_SHADOW_BALL, MOVE_ENERGY_BALL, MOVE_TRICK_ROOM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BIANCA */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL, MOVE_DAZZLING_GLEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BIANCA */,
    {
    .lvl = 3,
    .species = SPECIES_SUDOWOODO,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HEAD_SMASH, MOVE_LOW_KICK, MOVE_SUCKER_PUNCH, MOVE_EARTHQUAKE
    } /* Verdant polish: TRAINER_BIANCA */,
    {
    .lvl = 4,
    .species = SPECIES_MAGMORTAR,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HEAT_WAVE, MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_FOCUS_BLAST
    } /* Verdant polish: TRAINER_BIANCA */
};
...
static const struct TrainerMonItemCustomMoves sParty_Hayden[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_FACADE, MOVE_KNOCK_OFF, MOVE_PROTECT
    } /* Verdant polish: TRAINER_HAYDEN */,
    {
    .lvl = 2,
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_TOXIC_ORB,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CROSS_POISON, MOVE_NIGHT_SLASH, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_HAYDEN */
};
...
static const struct TrainerMonItemCustomMoves sParty_GabbyAndTy1[] = {
    ...
    } /* Verdant polish: TRAINER_GABBY_AND_TY_1 */,
    {
    .lvl = -1,
    ...
    .ability = 0,
    .spread = SPREAD_15_IV_0_EV,
    .moves = MOVE_UPROAR, MOVE_EXTRASENSORY, MOVE_WORK_UP, MOVE_HYPER_VOICE
    } /* Verdant polish: TRAINER_GABBY_AND_TY_1 */,
    {
    .lvl = -1,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_ROOST, MOVE_DRAGON_CLAW, MOVE_PROTECT, MOVE_ICE_BEAM
    } /* Verdant custom: Unmapped — Verdant custom: Unmapped / Balanced disruption */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SWORDS_DANCE, MOVE_PROTECT, MOVE_RETURN, MOVE_SHADOW_CLAW
    } /* Verdant custom: Unmapped — Verdant custom: Unmapped / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_GabbyAndTy3[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_TAILWIND, MOVE_BOOMBURST, MOVE_HEAT_WAVE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABBY_AND_TY_3 */,
    {
    .lvl = -1,
    .species = SPECIES_KRICKETUNE,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_STICKY_WEB, MOVE_HELPING_HAND, MOVE_X_SCISSOR, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABBY_AND_TY_3 */,
    {
    .lvl = 0,
    .species = SPECIES_EXPLOUD,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HYPER_VOICE, MOVE_HELPING_HAND, MOVE_MYSTICAL_FIRE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABBY_AND_TY_3 */
};
...
static const struct TrainerMonItemCustomMoves sParty_GabbyAndTy4[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_TAILWIND, MOVE_BOOMBURST, MOVE_DRACO_METEOR, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABBY_AND_TY_4 */,
    {
    .lvl = 0,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_CHOICE_SPECS,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_FLASH_CANNON, MOVE_THUNDERBOLT, MOVE_ELECTROWEB, MOVE_VOLT_SWITCH
    } /* Verdant polish: TRAINER_GABBY_AND_TY_4 */,
    {
    .lvl = 2,
    .species = SPECIES_SYLVEON,
...
static const struct TrainerMonItemCustomMoves sParty_GabbyAndTy5[] = {
    ...
    } /* Verdant polish: TRAINER_GABBY_AND_TY_5 */,
    {
    .lvl = 0,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_CLANGING_SCALES, MOVE_CLANGOROUS_SOUL, MOVE_AURA_SPHERE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABBY_AND_TY_5 */,
    {
    .lvl = 1,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_TAILWIND, MOVE_FIRE_BLAST, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABBY_AND_TY_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_GabbyAndTy6[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_RELIC_SONG, MOVE_PSYCHIC, MOVE_HYPER_VOICE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABBY_AND_TY_6 */,
    {
    .lvl = 0,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_ASSAULT_VEST,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_PSYSHOCK, MOVE_MYSTICAL_FIRE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABBY_AND_TY_6 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Irene[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HORN_LEECH, MOVE_POLTERGEIST, MOVE_WILL_O_WISP, MOVE_PROTECT
    } /* Verdant polish: TRAINER_IRENE */,
    {
    .lvl = 3,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SOLAR_BEAM, MOVE_PSYCHIC, MOVE_SLUDGE_BOMB, MOVE_PROTECT
    } /* Verdant polish: TRAINER_IRENE */
};
...
static const struct TrainerMonItemCustomMoves sParty_Travis[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ACROBATICS, MOVE_ROCK_SLIDE, MOVE_U_TURN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TRAVIS */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SHELL_SMASH, MOVE_ROCK_SLIDE, MOVE_LIQUIDATION, MOVE_WIDE_GUARD
    } /* Verdant polish: TRAINER_TRAVIS */,
    {
    .lvl = 3,
    .species = SPECIES_GOLURK,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SHADOW_PUNCH, MOVE_DRAIN_PUNCH, MOVE_ICE_PUNCH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TRAVIS */,
    {
    .lvl = 4,
    .species = SPECIES_GOGOAT,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HORN_LEECH, MOVE_BULK_UP, MOVE_HIGH_HORSEPOWER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TRAVIS */
};
...
static const struct TrainerMonItemCustomMoves sParty_Wilton1[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_TRICK_ROOM, MOVE_BODY_PRESS
    } /* Verdant polish: TRAINER_WILTON_1 */,
    {
    .lvl = 3,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_PSYCHIC, MOVE_FOCUS_BLAST, MOVE_RECOVER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_WILTON_1 */,
    {
    .lvl = 4,
    .species = SPECIES_GARCHOMP,
...
static const struct TrainerMonItemCustomMoves sParty_Wilton2[] = {
    ...
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_TRICK_ROOM, MOVE_BODY_PRESS
    } /* Verdant polish: TRAINER_WILTON_2 */,
    {
    .lvl = 2,
    .species = SPECIES_REUNICLUS,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Wilton3[] = {
    ...
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_TRICK_ROOM, MOVE_BODY_PRESS
    } /* Verdant polish: TRAINER_WILTON_3 */,
    {
    .lvl = 2,
    .species = SPECIES_REUNICLUS,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Wilton4[] = {
    ...
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SHADOW_BALL, MOVE_WILL_O_WISP, MOVE_TRICK_ROOM, MOVE_BODY_PRESS
    } /* Verdant polish: TRAINER_WILTON_4 */,
    {
    .lvl = 2,
    .species = SPECIES_REUNICLUS,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Brooke1[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SCALD, MOVE_FLASH_CANNON, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BROOKE_1 */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_CLOSE_COMBAT, MOVE_FIRE_PUNCH, MOVE_MACH_PUNCH
    } /* Verdant polish: TRAINER_BROOKE_1 */,
    {
    .lvl = 3,
    .species = SPECIES_ROSERADE,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLUDGE_BOMB, MOVE_GIGA_DRAIN, MOVE_EXTRASENSORY, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BROOKE_1 */,
    {
    .lvl = 4,
...
static const struct TrainerMonItemCustomMoves sParty_Brooke2[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_CLOSE_COMBAT, MOVE_FIRE_PUNCH, MOVE_MACH_PUNCH
    } /* Verdant polish: TRAINER_BROOKE_2 */,
    {
    .lvl = 1,
    .species = SPECIES_EMPOLEON,
    .heldItem = ITEM_SITRUS_BERRY,
...
static const struct TrainerMonItemCustomMoves sParty_Brooke3[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SCALD, MOVE_FLASH_CANNON, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BROOKE_3 */,
    {
    .lvl = 2,
    .species = SPECIES_INFERNAPE,
    .heldItem = ITEM_FOCUS_SASH,
...
static const struct TrainerMonItemCustomMoves sParty_Brooke4[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SCALD, MOVE_FLASH_CANNON, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BROOKE_4 */,
    {
    .lvl = 2,
    .species = SPECIES_INFERNAPE,
    .heldItem = ITEM_FOCUS_SASH,
...
static const struct TrainerMonItemCustomMoves sParty_Daisuke[] = {
    ...
    } /* Verdant polish: TRAINER_DAISUKE */,
    {
    .lvl = 3,
    .species = SPECIES_SHEDINJA,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SPECTRAL_THIEF, MOVE_CLOSE_COMBAT, MOVE_SHADOW_SNEAK, MOVE_ICE_PUNCH
    } /* Verdant polish: TRAINER_DAISUKE */
};
...
static const struct TrainerMonItemCustomMoves sParty_Heidi[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_WOOD_HAMMER, MOVE_HORN_LEECH, MOVE_CLOSE_COMBAT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_HEIDI */,
    {
    .lvl = 2,
    .species = SPECIES_HAWLUCHA,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_ACROBATICS, MOVE_CLOSE_COMBAT, MOVE_SWORDS_DANCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_HEIDI */,
    {
    .lvl = 3,
    .species = SPECIES_MUDSDALE,
...
static const struct TrainerMonItemCustomMoves sParty_Beau[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPEED_TIMID,
    .moves = MOVE_FAKE_OUT, MOVE_PARTING_SHOT, MOVE_FOUL_PLAY, MOVE_TAUNT
    } /* Verdant polish: TRAINER_BEAU */,
    {
    .lvl = 2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPDEF_CAREFUL,
    .moves = MOVE_TAILWIND, MOVE_FOUL_PLAY, MOVE_SNARL, MOVE_ROOST
    } /* Verdant polish: TRAINER_BEAU */,
    {
    .lvl = 3,
    .species = SPECIES_GASTRODON,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SCALD, MOVE_EARTH_POWER, MOVE_RECOVER, MOVE_ICY_WIND
    } /* Verdant polish: TRAINER_BEAU */,
    {
    .lvl = 4,
    .species = SPECIES_LYCANROC_DUSK,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ACCELEROCK, MOVE_ROCK_SLIDE, MOVE_CLOSE_COMBAT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BEAU */
};
...
static const struct TrainerMonItemCustomMoves sParty_Drew[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SWORDS_DANCE, MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_SHADOW_CLAW
    } /* Verdant polish: TRAINER_DREW */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SUCKER_PUNCH, MOVE_SEED_BOMB, MOVE_DRAIN_PUNCH, MOVE_SPIKY_SHIELD
    } /* Verdant polish: TRAINER_DREW */,
    {
    .lvl = 4,
    .species = SPECIES_DUNSPARCE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPDEF_CAREFUL,
    .moves = MOVE_COIL, MOVE_GLARE, MOVE_HEADBUTT, MOVE_ROOST
    } /* Verdant polish: TRAINER_DREW */
};
...
static const struct TrainerMonItemCustomMoves sParty_Becky[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SIMPLE_BEAM, MOVE_ICY_WIND, MOVE_SCALD, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BECKY */,
    {
    .lvl = 2,
    .species = SPECIES_KOMMO_O,
    .heldItem = ITEM_ROSELI_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DRAGON_DANCE, MOVE_DRAGON_CLAW, MOVE_DRAIN_PUNCH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BECKY */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPEED_TIMID,
    .moves = MOVE_COTTON_SPORE, MOVE_STRENGTH_SAP, MOVE_ENCORE, MOVE_U_TURN
    } /* Verdant polish: TRAINER_BECKY */,
    {
    .lvl = 4,
    .species = SPECIES_LYCANROC,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_STONE_EDGE, MOVE_CLOSE_COMBAT, MOVE_ACCELEROCK, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BECKY */
};
...
static const struct TrainerMonItemCustomMoves sParty_Celia[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_RAIN_DANCE, MOVE_GIGA_DRAIN, MOVE_HYDRO_PUMP, MOVE_ICE_BEAM
    } /* Verdant polish: TRAINER_CELIA */,
    {
    .lvl = 3,
    .species = SPECIES_PARASECT,
    .heldItem = ITEM_FOCUS_SASH,
...
static const struct TrainerMonItemCustomMoves sParty_Bryan[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPDEF_CAREFUL,
    .moves = MOVE_SNARL, MOVE_WILL_O_WISP, MOVE_PAIN_SPLIT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRYAN */,
    {
    .lvl = 2,
    .species = SPECIES_TYRANTRUM,
    .heldItem = ITEM_CHOICE_SCARF,
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HEAD_SMASH, MOVE_DRAGON_CLAW, MOVE_HIGH_HORSEPOWER, MOVE_PSYCHIC_FANGS
    } /* Verdant polish: TRAINER_BRYAN */,
    {
    .lvl = 3,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SHELL_SMASH, MOVE_ROCK_SLIDE, MOVE_LIQUIDATION, MOVE_AQUA_JET
    } /* Verdant polish: TRAINER_BRYAN */
};
...
static const struct TrainerMonItemCustomMoves sParty_Branden[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_IRON_HEAD, MOVE_FAKE_OUT, MOVE_CLOSE_COMBAT, MOVE_U_TURN
    } /* Verdant polish: TRAINER_BRANDEN */,
    {
    .lvl = 2,
    .species = SPECIES_DHELMISE,
    .heldItem = ITEM_COLBUR_BERRY,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_METEOR_ASSAULT, MOVE_BRAVE_BIRD, MOVE_LEAF_BLADE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRANDEN */,
    {
    .lvl = 4,
    .species = SPECIES_KARTANA,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_LEAF_BLADE, MOVE_SACRED_SWORD, MOVE_NIGHT_SLASH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRANDEN */
};
...
static const struct TrainerMonItemCustomMoves sParty_Dusty1[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DYNAMIC_PUNCH, MOVE_HIGH_HORSEPOWER, MOVE_POLTERGEIST, MOVE_ICE_PUNCH
    } /* Verdant polish: TRAINER_DUSTY_1 */,
    {
    .lvl = 3,
    .species = SPECIES_SIGILYPH,
    .heldItem = ITEM_FLAME_ORB,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_METAL_BURST, MOVE_FLASH_CANNON, MOVE_SHORE_UP, MOVE_PROTECT
    } /* Verdant polish: TRAINER_DUSTY_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Dusty2[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HEAD_SMASH, MOVE_EARTHQUAKE, MOVE_ZEN_HEADBUTT, MOVE_CRUNCH
    } /* Verdant polish: TRAINER_DUSTY_2 */,
    {
    .lvl = 3,
    .species = SPECIES_ARMALDO,
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_STONE_EDGE, MOVE_X_SCISSOR, MOVE_AQUA_JET, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_DUSTY_2 */,
    {
    .lvl = 4,
    .species = SPECIES_FLYGON,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DRAGON_CLAW, MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_DUSTY_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Dusty3[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DYNAMIC_PUNCH, MOVE_HIGH_HORSEPOWER, MOVE_POLTERGEIST, MOVE_ICE_PUNCH
    } /* Verdant polish: TRAINER_DUSTY_3 */,
    {
    .lvl = 2,
    .species = SPECIES_SIGILYPH,
    .heldItem = ITEM_FLAME_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Dusty4[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DYNAMIC_PUNCH, MOVE_HIGH_HORSEPOWER, MOVE_POLTERGEIST, MOVE_ICE_PUNCH
    } /* Verdant polish: TRAINER_DUSTY_4 */,
    {
    .lvl = 2,
    .species = SPECIES_SIGILYPH,
    .heldItem = ITEM_FLAME_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Wattson3[] = { //Legendaries
    ...
    } /* Verdant polish: TRAINER_WATTSON_3 */,
    {
    .lvl = 0,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_VOLT_SWITCH, MOVE_FLAMETHROWER, MOVE_PROTECT, MOVE_THUNDER
    } /* Verdant polish: TRAINER_WATTSON_3 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Larry[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_LEAF_BLADE, MOVE_POISON_JAB, MOVE_SUCKER_PUNCH, MOVE_SWORDS_DANCE
    } /* Verdant polish: TRAINER_LARRY */,
    {
    .lvl = 4,
    .species = SPECIES_CACTURNE,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_SEED_BOMB, MOVE_DRAIN_PUNCH, MOVE_SUCKER_PUNCH, MOVE_SPIKY_SHIELD
    } /* Verdant polish: TRAINER_LARRY */
};
...
static const struct TrainerMonItemCustomMoves sParty_Carol[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_AIR_SLASH, MOVE_PSYCHIC, MOVE_HEAT_WAVE
    } /* Verdant polish: TRAINER_CAROL */,
    {
    .lvl = 4,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_MOONBLAST, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CAROL */
};
...
static const struct TrainerMonItemCustomMoves sParty_Brice[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_IRON_HEAD, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE
    } /* Verdant polish: TRAINER_BRICE */,
    {
    .lvl = 4,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SHELL_SMASH, MOVE_X_SCISSOR, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRICE */
};
...
static const struct TrainerMonItemCustomMoves sParty_Trent1[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_ICE_SHARD, MOVE_KNOCK_OFF, MOVE_RAPID_SPIN
    } /* Verdant polish: TRAINER_TRENT_1 */,
    {
    .lvl = 1,
    .species = SPECIES_AURORUS,
    .heldItem = ITEM_THROAT_SPRAY,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HYPER_VOICE, MOVE_ICY_WIND, MOVE_POWER_GEM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TRENT_1 */,
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_Trent2[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_EXPLOSION, MOVE_EARTHQUAKE, MOVE_HEAVY_SLAM, MOVE_STONE_EDGE
    } /* Verdant polish: TRAINER_TRENT_2 */,
    {
    .lvl = -2,
    .species = SPECIES_GOLEM,
    .heldItem = ITEM_NONE,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_EXPLOSION, MOVE_WILD_CHARGE, MOVE_STONE_EDGE, MOVE_ROCK_POLISH
    } /* Verdant polish: TRAINER_TRENT_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Trent3[] = {
    ...
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_EXPLOSION, MOVE_EARTHQUAKE, MOVE_HEAVY_SLAM, MOVE_STONE_EDGE
    } /* Verdant polish: TRAINER_TRENT_3 */,
    {
    .lvl = -2,
    .species = SPECIES_GOLEM,
    .heldItem = ITEM_NONE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PROTECT, MOVE_STONE_EDGE, MOVE_EXPLOSION, MOVE_SUPERPOWER
    } /* Verdant polish: TRAINER_TRENT_3 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Trent4[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_TRICK_ROOM, MOVE_WILL_O_WISP, MOVE_HELPING_HAND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TRENT_4 */,
    {
    .lvl = 0,
    .species = SPECIES_GOLEM,
    .heldItem = ITEM_CHOICE_BAND,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_TRICK_ROOM, MOVE_INSTRUCT, MOVE_PSYCHIC, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TRENT_4 */,
    {
    .lvl = 1,
    .species = SPECIES_GOLEM_ALOLAN,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_EXPLOSION, MOVE_WILD_CHARGE, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TRENT_4 */,
    {
    .lvl = 2,
    .species = SPECIES_GIGALITH,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_EXPLOSION, MOVE_ROCK_SLIDE, MOVE_WIDE_GUARD, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TRENT_4 */,
    {
    .lvl = 2,
    .species = SPECIES_GOLEM,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE, MOVE_EXPLOSION, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TRENT_4 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Lawrence[] = {
    ...
    } /* Verdant polish: TRAINER_LAWRENCE */,
    {
    .lvl = 2,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_WILL_O_WISP, MOVE_HEAT_WAVE, MOVE_PROTECT, MOVE_FAKE_OUT
    } /* Verdant custom: Route 113 — Verdant custom: Route 113 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Madeline1[] = {
    ...
    } /* Verdant polish: TRAINER_MADELINE_1 */,
    {
    .lvl = 2,
    .species = SPECIES_MIENFOO,
    .heldItem = ITEM_BLACK_BELT,
    ...
    },
{
    ...
    } /* Verdant custom: Route 113 — Verdant custom: Route 113 / Sun offense */
};
...
static const struct TrainerMonItemCustomMoves sParty_ToriAndTia[] = {
    ...
    } /* Verdant polish: TRAINER_TORI_AND_TIA */,
    {
    .lvl = 2,
    .species = SPECIES_ORICORIO_POM_POM,
    .heldItem = ITEM_SHARP_BEAK,
...
static const struct TrainerMonItemCustomMoves sParty_MagikarpGuy[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FLAIL, MOVE_HYDRO_PUMP, MOVE_BOUNCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAGIKARP_GUY */,
    {
    .lvl = 0,
    .species = SPECIES_FEEBAS,
    .heldItem = ITEM_EVIOLITE,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SCALD, MOVE_ICE_BEAM, MOVE_MIRROR_COAT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAGIKARP_GUY */,
    {
    .lvl = 1,
    .species = SPECIES_WISHIWASHI,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_WATER_SPOUT, MOVE_ICE_BEAM, MOVE_EARTHQUAKE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAGIKARP_GUY */,
    {
    .lvl = 1,
    .species = SPECIES_DITTO,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_TRANSFORM, MOVE_TACKLE, MOVE_COPYCAT, MOVE_MIMIC
    } /* Verdant polish: TRAINER_MAGIKARP_GUY */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_WATERFALL, MOVE_CRUNCH, MOVE_POWER_WHIP, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAGIKARP_GUY */
};
...
static const struct TrainerMonItemCustomMoves sParty_Charlotte[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_TRICK_ROOM, MOVE_PSYCHIC, MOVE_THUNDERBOLT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CHARLOTTE */,
    {
    .lvl = 1,
    .species = SPECIES_KOMALA,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_TyraAndIvy[] = {
    ...
    } /* Verdant polish: TRAINER_TYRA_AND_IVY */,
    {
    .lvl = 2,
    .species = SPECIES_PANGORO,
    .heldItem = ITEM_WEAKNESS_POLICY,
...
static const struct TrainerMonItemCustomMoves sParty_Steve1[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HEAD_SMASH, MOVE_DRAGON_CLAW, MOVE_CLOSE_COMBAT, MOVE_CRUNCH
    } /* Verdant polish: TRAINER_STEVE_1 */,
    {
    .lvl = 2,
    .species = SPECIES_COPPERAJAH,
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_HEAVY_SLAM, MOVE_HIGH_HORSEPOWER, MOVE_POWER_WHIP, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_STEVE_1 */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_RETURN, MOVE_ROCK_SLIDE, MOVE_HEAVY_SLAM, MOVE_FIRE_PUNCH
    } /* Verdant polish: TRAINER_STEVE_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Steve2[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_EARTH_POWER, MOVE_SLUDGE_BOMB, MOVE_ICE_BEAM, MOVE_FLAMETHROWER
    } /* Verdant polish: TRAINER_STEVE_2 */,
    {
    .lvl = 2,
    .species = SPECIES_COPPERAJAH,
    .heldItem = ITEM_ASSAULT_VEST,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_MEGAHORN, MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_PROTECT
    } /* Verdant polish: TRAINER_STEVE_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Steve3[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_SHELL_SMASH, MOVE_HEAT_WAVE, MOVE_DRAGON_PULSE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_STEVE_3 */,
    {
    .lvl = 2,
    .species = SPECIES_GOLEM_ALOLAN,
    .heldItem = ITEM_CHOICE_BAND,
...
static const struct TrainerMonItemCustomMoves sParty_Steve4[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_HEAVY_SLAM, MOVE_HIGH_HORSEPOWER, MOVE_POWER_WHIP, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_STEVE_4 */,
    {
    .lvl = 1,
    .species = SPECIES_NIDOKING,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PIN_MISSILE, MOVE_ROCK_BLAST, MOVE_ARM_THRUST, MOVE_BULLET_SEED
    } /* Verdant polish: TRAINER_STEVE_4 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Bernie1[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_HEAT_WAVE, MOVE_DARK_PULSE, MOVE_WILL_O_WISP
    } /* Verdant polish: TRAINER_BERNIE_1 */,
    {
    .lvl = 2,
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_EXPERT_BELT,
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SCALD, MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_ENCORE
    } /* Verdant polish: TRAINER_BERNIE_1 */,
    {
    .lvl = 3,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_WATER_PULSE, MOVE_ICE_BEAM, MOVE_HELPING_HAND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BERNIE_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Bernie2[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_CLOSE_COMBAT, MOVE_FIRE_PUNCH, MOVE_MACH_PUNCH
    } /* Verdant polish: TRAINER_BERNIE_2 */,
    {
    .lvl = 2,
    .species = SPECIES_VAPOREON,
    .heldItem = ITEM_LEFTOVERS,
...
static const struct TrainerMonItemCustomMoves sParty_Bernie3[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_FLARE_BLITZ, MOVE_POLTERGEIST, MOVE_BONEMERANG, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BERNIE_3 */,
    {
    .lvl = 2,
    .species = SPECIES_VAPOREON,
    .heldItem = ITEM_LEFTOVERS,
...
static const struct TrainerMonItemCustomMoves sParty_Bernie4[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_HEAT_WAVE, MOVE_DARK_PULSE, MOVE_WILL_O_WISP
    } /* Verdant polish: TRAINER_BERNIE_4 */,
    {
    .lvl = 1,
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_EXPERT_BELT,
...
static const struct TrainerMonItemCustomMoves sParty_Lucas[] = {
    ...
    } /* Verdant polish: TRAINER_LUCAS_1 */,
    {
    .lvl = 3,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ICICLE_CRASH, MOVE_CLOSE_COMBAT, MOVE_AQUA_JET, MOVE_PROTECT
    } /* Verdant polish: TRAINER_LUCAS_1 */,
    {
    .lvl = 4,
...
static const struct TrainerMonItemCustomMoves sParty_Angelina[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HAIL, MOVE_BLIZZARD, MOVE_FREEZE_DRY, MOVE_PROTECT
    } /* Verdant polish: TRAINER_ANGELINA */,
    {
    .lvl = 3,
    .species = SPECIES_SANDSLASH_ALOLAN,
    .heldItem = ITEM_WEAKNESS_POLICY,
...
static const struct TrainerMonItemCustomMoves sParty_GruntMeteorFalls[] = {
    ...
    } /* Verdant polish: TRAINER_GRUNT_METEOR_FALLS */,
    {
    .lvl = 2,
    .species = SPECIES_MINIOR,
    .heldItem = ITEM_WHITE_HERB,
...
static const struct TrainerMonItemCustomMoves sParty_Courtney_MeteorFalls[] = {
    ...
    } /* Verdant polish: TRAINER_COURTNEY_METEOR_FALLS */,
    {
    .lvl = 2,
    .species = SPECIES_JIRACHI,
    .heldItem = ITEM_CHOICE_SCARF,
...
static const struct TrainerMonItemCustomMoves sParty_MayTreeckoMeteorFalls[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HEAT_WAVE, MOVE_AURA_SPHERE, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: MAY_TREECKO_METEOR_FALLS */,
    {
    .lvl = 0,
    .species = SPECIES_STARMIE,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SCALD, MOVE_PSYCHIC, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: MAY_TREECKO_METEOR_FALLS */,
    {
    .lvl = 0,
    .species = SPECIES_MIMIKYU,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PLAY_ROUGH, MOVE_SHADOW_SNEAK, MOVE_WILL_O_WISP, MOVE_PROTECT
    } /* Verdant polish: MAY_TREECKO_METEOR_FALLS */
};
...
static const struct TrainerMonItemCustomMoves sParty_MayTorchicMeteorFalls[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_MUDDY_WATER, MOVE_ROCK_SLIDE, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: MAY_TORCHIC_METEOR_FALLS */,
    {
    .lvl = 0,
    .species = SPECIES_RAPIDASH,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FLARE_BLITZ, MOVE_DRILL_RUN, MOVE_WILD_CHARGE, MOVE_PROTECT
    } /* Verdant polish: MAY_TORCHIC_METEOR_FALLS */,
    {
    .lvl = 0,
    .species = SPECIES_MIMIKYU,
...
static const struct TrainerMonItemCustomMoves sParty_MayMudkipMeteorFalls[] = {
    ...
    } /* Verdant polish: MAY_MUDKIP_METEOR_FALLS */,
    {
    .lvl = 0,
    .species = SPECIES_RAPIDASH,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanTreeckoMeteorFalls[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HEAT_WAVE, MOVE_AURA_SPHERE, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: BRENDAN_TREECKO_METEOR_FALLS */,
    {
    .lvl = 0,
    .species = SPECIES_ARAQUANID,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_LIQUIDATION, MOVE_ICY_WIND, MOVE_WIDE_GUARD, MOVE_LEECH_LIFE
    } /* Verdant polish: BRENDAN_TREECKO_METEOR_FALLS */,
    {
    .lvl = 0,
    .species = SPECIES_MIMIKYU,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanTorchicMeteorFalls[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_MUDDY_WATER, MOVE_ROCK_SLIDE, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: BRENDAN_TORCHIC_METEOR_FALLS */,
    {
    .lvl = 0,
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_SITRUS_BERRY,
...
static const struct TrainerMonItemCustomMoves sParty_BrendanMudkipMeteorFalls[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_LEAF_STORM, MOVE_DRAGON_PULSE, MOVE_FOCUS_BLAST, MOVE_PROTECT
    } /* Verdant polish: BRENDAN_MUDKIP_METEOR_FALLS */,
    {
    .lvl = 0,
    .species = SPECIES_ARCANINE,
    .heldItem = ITEM_SITRUS_BERRY,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_POWER_WHIP, MOVE_SPIKES, MOVE_THUNDER_WAVE, MOVE_PROTECT
    } /* Verdant custom: Route 115 — Verdant custom: Route 115 / Balanced disruption */,
    {
    .lvl = -3,
    .species = SPECIES_ROSELIA,
    .heldItem = ITEM_BLACK_SLUDGE,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_TAILWIND, MOVE_EARTHQUAKE, MOVE_PROTECT, MOVE_HIDDEN_POWER
    } /* Verdant custom: Route 115 — Verdant custom: Route 115 / Balanced disruption */,
    {
    .lvl = -3,
    .species = SPECIES_LOPUNNY,
...
static const struct TrainerMonItemCustomMoves sParty_Cyndy4[] = {
    ...
    } /* Verdant polish: TRAINER_CYNDY_4 */,
    {
    .lvl = -2,
    .species = SPECIES_KOMMO_O,
    .heldItem = ITEM_WHITE_HERB,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DRAIN_PUNCH, MOVE_DOUBLE_EDGE, MOVE_ROCK_SLIDE, MOVE_BULK_UP
    } /* Verdant polish: TRAINER_CYNDY_4 */,
    {
    .lvl = -3,
    .species = SPECIES_MEDICHAM,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_LEAF_BLADE, MOVE_TAUNT, MOVE_CLOSE_COMBAT, MOVE_SWORDS_DANCE
    } /* Verdant polish: TRAINER_CYNDY_4 */,
    {
    .lvl = 0,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_RECOVER, MOVE_CALM_MIND, MOVE_FIRE_BLAST, MOVE_JUDGMENT
    } /* Verdant polish: TRAINER_CYNDY_4 */
};
...
/*     {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_FIRE_BLAST, MOVE_FLASH_CANNON, MOVE_AIR_SLASH, MOVE_EARTHQUAKE
    } /* Verdant custom: Route 115 — Verdant custom: Route 115 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Timothy3[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_CLOSE_COMBAT, MOVE_HEAVY_SLAM, MOVE_FAKE_OUT, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_TIMOTHY_3 */,
    {
    .lvl = -1,
    .species = SPECIES_DUSCLOPS,
    .heldItem = ITEM_EVIOLITE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_MUDDY_WATER, MOVE_PROTECT, MOVE_HYDRO_PUMP, MOVE_SECRET_SWORD
    } /* Verdant polish: TRAINER_TIMOTHY_3 */,
    {
    .lvl = 1,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_MEGAHORN, MOVE_PROTECT, MOVE_SWORDS_DANCE, MOVE_IRON_HEAD
    } /* Verdant polish: TRAINER_TIMOTHY_3 */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FLARE_BLITZ, MOVE_SUCKER_PUNCH, MOVE_CLOSE_COMBAT, MOVE_PROTECT
    } /* Verdant custom: Route 115 — Verdant explicit team design */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PLAY_ROUGH, MOVE_KNOCK_OFF, MOVE_PROTECT, MOVE_SWORDS_DANCE
    } /* Verdant custom: Route 115 — Verdant explicit team design */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ICY_WIND, MOVE_PSYSHOCK, MOVE_THUNDER_WAVE, MOVE_PROTECT
    } /* Verdant custom: Route 115 — Verdant explicit team design */
};
// Mt. Chimney
...
static const struct TrainerMonItemCustomMoves sParty_TabithaMtChimney[] = {
    ...
    } /* Verdant polish: TRAINER_TABITHA_MT_CHIMNEY */,
    {
    .lvl = 1,
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMtChimney[] = {
    ...
    } /* Verdant polish: TRAINER_MAXIE_MT_CHIMNEY */,
    {
    .lvl = 1,
    .species = SPECIES_CROBAT,
    .heldItem = ITEM_SITRUS_BERRY,
...
static const struct TrainerMonItemCustomMoves sParty_Sheila[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_TAIL_SLAP, MOVE_BULLET_SEED, MOVE_ROCK_BLAST, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SHEILA */,
    {
    .lvl = 3,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_IRON_HEAD, MOVE_KNOCK_OFF, MOVE_SUCKER_PUNCH, MOVE_SWORDS_DANCE
    } /* Verdant polish: TRAINER_SHEILA */,
    {
    .lvl = 4,
    .species = SPECIES_ESCAVALIER,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_MEGAHORN, MOVE_IRON_HEAD, MOVE_KNOCK_OFF, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SHEILA */
};
...
static const struct TrainerMonItemCustomMoves sParty_Shirley[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_DECORATE, MOVE_DAZZLING_GLEAM, MOVE_HELPING_HAND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SHIRLEY */,
    {
    .lvl = 2,
    .species = SPECIES_MELOETTA,
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_HASTY,
    .moves = MOVE_HYPER_VOICE, MOVE_PSYCHIC, MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_SHIRLEY */,
    {
    .lvl = 3,
    .species = SPECIES_NIHILEGO,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_POWER_GEM, MOVE_SLUDGE_WAVE, MOVE_GRASS_KNOT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SHIRLEY */,
    {
    .lvl = 4,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FREEZE_DRY, MOVE_PSYCHIC, MOVE_FOCUS_BLAST, MOVE_ICY_WIND
    } /* Verdant polish: TRAINER_SHIRLEY */
};
...
static const struct TrainerMonItemCustomMoves sParty_Melissa[] = {
    ...
    } /* Verdant polish: TRAINER_MELISSA */,
    {
    .lvl = 3,
    .species = SPECIES_FURFROU,
    .heldItem = ITEM_CHOPLE_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_RETURN, MOVE_COTTON_GUARD, MOVE_SUCKER_PUNCH, MOVE_REST
    } /* Verdant polish: TRAINER_MELISSA */,
    {
    .lvl = 4,
    .species = SPECIES_LOPUNNY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SWITCHEROO, MOVE_FAKE_OUT, MOVE_RETURN, MOVE_HIGH_JUMP_KICK
    } /* Verdant polish: TRAINER_MELISSA */,
    {
    .lvl = 5,
    .species = SPECIES_DIANCIE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_MOONBLAST, MOVE_DIAMOND_STORM, MOVE_EARTH_POWER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MELISSA */
};
...
static const struct TrainerMonItemCustomMoves sParty_Sawyer1[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_ROCK_SLIDE, MOVE_BODY_PRESS, MOVE_WIDE_GUARD, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SAWYER_1 */,
    {
    .lvl = 2,
...
static const struct TrainerMonItemCustomMoves sParty_Sawyer2[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_ROCK_SLIDE, MOVE_BODY_PRESS, MOVE_WIDE_GUARD, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SAWYER_2 */,
    {
    .lvl = 3,
    .species = SPECIES_DRACOZOLT,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Sawyer3[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_GIGA_DRAIN, MOVE_POWER_GEM, MOVE_RECOVER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SAWYER_3 */,
    {
    .lvl = 4,
    .species = SPECIES_EXCADRILL,
    .heldItem = ITEM_EXCADRITE,
...
static const struct TrainerMonItemCustomMoves sParty_Sawyer4[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_ROCK_SLIDE, MOVE_BODY_PRESS, MOVE_WIDE_GUARD, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SAWYER_4 */,
    {
    .lvl = 2,
    .species = SPECIES_DRACOZOLT,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DRACO_METEOR, MOVE_DARK_PULSE, MOVE_HEAT_WAVE, MOVE_TAILWIND
    } /* Verdant polish: TRAINER_SAWYER_4 */,
    {
    .lvl = 6,
    .species = SPECIES_ROTOM_FROST,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_FREEZE_DRY, MOVE_THUNDERBOLT, MOVE_WILL_O_WISP, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SAWYER_4 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Shelby1[] = {
    ...
    } /* Verdant polish: TRAINER_SHELBY_1 */,
    {
    .lvl = 2,
    .species = SPECIES_WOBBUFFET,
    .heldItem = ITEM_MENTAL_HERB,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SCALD, MOVE_ICY_WIND, MOVE_SLACK_OFF, MOVE_PSYSHOCK
    } /* Verdant polish: TRAINER_SHELBY_1 */,
    {
    .lvl = 4,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_KINGS_SHIELD, MOVE_SHADOW_BALL, MOVE_FLASH_CANNON, MOVE_WIDE_GUARD
    } /* Verdant polish: TRAINER_SHELBY_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Shelby2[] = {
    ...
    } /* Verdant polish: TRAINER_SHELBY_2 */,
    {
    .lvl = 3,
    .species = SPECIES_SLOWBRO,
    .heldItem = ITEM_COLBUR_BERRY,
...
static const struct TrainerMonItemCustomMoves sParty_Shelby3[] = {
    ...
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_COUNTER, MOVE_MIRROR_COAT, MOVE_ENCORE, MOVE_DESTINY_BOND
    } /* Verdant polish: TRAINER_SHELBY_3 */,
    {
    .lvl = 2,
    .species = SPECIES_AEGISLASH,
    .heldItem = ITEM_WEAKNESS_POLICY,
...
static const struct TrainerMonItemCustomMoves sParty_Shelby4[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_U_TURN
    } /* Verdant polish: TRAINER_SHELBY_4 */,
    {
    .lvl = 2,
    .species = SPECIES_WOBBUFFET,
    .heldItem = ITEM_MENTAL_HERB,
...
static const struct TrainerMonItemCustomMoves sParty_Eric[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_STONE_EDGE, MOVE_EARTHQUAKE, MOVE_CRUNCH, MOVE_DRAGON_DANCE
    } /* Verdant polish: TRAINER_ERIC */,
    {
    .lvl = 3,
    .species = SPECIES_METANG,
    .heldItem = ITEM_OCCA_BERRY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_CLOSE_COMBAT, MOVE_DRAGON_CLAW, MOVE_IRON_HEAD, MOVE_TAUNT
    } /* Verdant polish: TRAINER_ERIC */
};
...
static const struct TrainerMonItemCustomMoves sParty_Autumn[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_SPIKY_SHIELD, MOVE_BODY_PRESS, MOVE_SEED_BOMB, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_AUTUMN */,
    {
    .lvl = 2,
    .species = SPECIES_CONKELDURR,
    .heldItem = ITEM_FLAME_ORB,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_AVALANCHE, MOVE_BODY_PRESS, MOVE_HIGH_HORSEPOWER, MOVE_RECOVER
    } /* Verdant polish: TRAINER_AUTUMN */
};
...
static const struct TrainerMonItemCustomMoves sParty_Julio[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDERBOLT, MOVE_SHADOW_BALL, MOVE_HYPER_VOICE, MOVE_VOLT_SWITCH
    } /* Verdant polish: TRAINER_JULIO */,
    {
    .lvl = 3,
    .species = SPECIES_DODRIO,
...
static const struct TrainerMonItemCustomMoves sParty_Diana1[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FAKE_OUT, MOVE_ICY_WIND, MOVE_FREEZE_DRY, MOVE_WATER_PULSE
    } /* Verdant polish: TRAINER_DIANA_1 */,
    {
    .lvl = 2,
    .species = SPECIES_VESPIQUEN,
    .heldItem = ITEM_ROCKY_HELMET,
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_ATTACK_ORDER, MOVE_TAILWIND, MOVE_HEAL_ORDER, MOVE_DEFEND_ORDER
    } /* Verdant polish: TRAINER_DIANA_1 */,
    {
    .lvl = 3,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SHADOW_BALL, MOVE_GIGA_DRAIN, MOVE_WILL_O_WISP, MOVE_LEECH_SEED
    } /* Verdant polish: TRAINER_DIANA_1 */,
    {
    .lvl = 4,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_GIGA_DRAIN, MOVE_VOLT_SWITCH
    } /* Verdant polish: TRAINER_DIANA_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Diana2[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FAKE_OUT, MOVE_ICY_WIND, MOVE_FREEZE_DRY, MOVE_WATER_PULSE
    } /* Verdant polish: TRAINER_DIANA_2 */,
    {
    .lvl = 2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FREEZE_DRY, MOVE_FLASH_CANNON, MOVE_WATER_PULSE, MOVE_ICY_WIND
    } /* Verdant polish: TRAINER_DIANA_2 */,
    {
    .lvl = 4,
    .species = SPECIES_EELEKTROSS,
...
static const struct TrainerMonItemCustomMoves sParty_Diana3[] = {
    ...
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_ATTACK_ORDER, MOVE_TAILWIND, MOVE_HEAL_ORDER, MOVE_DEFEND_ORDER
    } /* Verdant polish: TRAINER_DIANA_3 */,
    {
    .lvl = 2,
    .species = SPECIES_VANILLUXE,
    .heldItem = ITEM_WISE_GLASSES,
...
static const struct TrainerMonItemCustomMoves sParty_Diana4[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FAKE_OUT, MOVE_ICY_WIND, MOVE_FREEZE_DRY, MOVE_WATER_PULSE
    } /* Verdant polish: TRAINER_DIANA_4 */,
    {
    .lvl = 1,
    .species = SPECIES_POLTEAGEIST,
    .heldItem = ITEM_WHITE_HERB,
...
static const struct TrainerMonItemCustomMoves sParty_Ethan1[] = {
    ...
    } /* Verdant polish: TRAINER_ETHAN_1 */,
    {
    .lvl = 2,
    .species = SPECIES_BOUFFALANT,
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HEAD_CHARGE, MOVE_HIGH_HORSEPOWER, MOVE_CLOSE_COMBAT, MOVE_WILD_CHARGE
    } /* Verdant polish: TRAINER_ETHAN_1 */,
    {
    .lvl = 3,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_FAKE_OUT, MOVE_DRUM_BEATING, MOVE_GRASSY_GLIDE, MOVE_HIGH_HORSEPOWER
    } /* Verdant polish: TRAINER_ETHAN_1 */,
    {
    .lvl = 4,
    .species = SPECIES_MR_RIME,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ENCORE, MOVE_FREEZE_DRY, MOVE_PSYCHIC, MOVE_FOCUS_BLAST
    } /* Verdant polish: TRAINER_ETHAN_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Ethan2[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_FAKE_OUT, MOVE_DRUM_BEATING, MOVE_GRASSY_GLIDE, MOVE_HIGH_HORSEPOWER
    } /* Verdant polish: TRAINER_ETHAN_2 */,
    {
    .lvl = 2,
    .species = SPECIES_MR_RIME,
    .heldItem = ITEM_EXPERT_BELT,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SWORDS_DANCE, MOVE_X_SCISSOR, MOVE_KNOCK_OFF, MOVE_AERIAL_ACE
    } /* Verdant polish: TRAINER_ETHAN_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Ethan3[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BOOMBURST, MOVE_OVERDRIVE, MOVE_SLUDGE_BOMB, MOVE_VOLT_SWITCH
    } /* Verdant polish: TRAINER_ETHAN_3 */,
    {
    .lvl = 2,
    .species = SPECIES_BOUFFALANT,
    .heldItem = ITEM_ASSAULT_VEST,
...
static const struct TrainerMonItemCustomMoves sParty_Ethan4[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BOOMBURST, MOVE_OVERDRIVE, MOVE_SLUDGE_BOMB, MOVE_VOLT_SWITCH
    } /* Verdant polish: TRAINER_ETHAN_4 */,
    {
    .lvl = 1,
    .species = SPECIES_BOUFFALANT,
    .heldItem = ITEM_ASSAULT_VEST,
...
static const struct TrainerMonItemCustomMoves sParty_Cole[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FAKE_OUT, MOVE_FLARE_BLITZ, MOVE_DARKEST_LARIAT, MOVE_DRAIN_PUNCH
    } /* Verdant polish: TRAINER_COLE */,
    {
    .lvl = 3,
    .species = SPECIES_SIMISEAR,
...
static const struct TrainerMonItemCustomMoves sParty_Gerald[] = { // double with Cole
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HEAT_WAVE, MOVE_AIR_SLASH, MOVE_DRAGON_PULSE, MOVE_ROOST
    } /* Verdant polish: TRAINER_GERALD */,
    {
    .lvl = 3,
    .species = SPECIES_RESHIRAM,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_BLUE_FLARE, MOVE_DRACO_METEOR, MOVE_EARTH_POWER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GERALD */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jeff[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPEED_TIMID,
    .moves = MOVE_SKILL_SWAP, MOVE_FAKE_OUT, MOVE_ICY_WIND, MOVE_HELPING_HAND
    } /* Verdant polish: TRAINER_JEFF */,
    {
    .lvl = 3,
    .species = SPECIES_PYROAR,
    .heldItem = ITEM_IRON_BALL,
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_OVERHEAT, MOVE_HYPER_VOICE, MOVE_DARK_PULSE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JEFF */,
    {
    .lvl = 4,
    .species = SPECIES_CINDERACE,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PYRO_BALL, MOVE_HIGH_JUMP_KICK, MOVE_SUCKER_PUNCH, MOVE_TAUNT
    } /* Verdant polish: TRAINER_JEFF */,
    {
    .lvl = 5,
    .species = SPECIES_CENTISKORCH,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FIRE_LASH, MOVE_POWER_WHIP, MOVE_LEECH_LIFE, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_JEFF */
};
...
static const struct TrainerMonItemCustomMoves sParty_Axle[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ACROBATICS, MOVE_POLTERGEIST, MOVE_WILL_O_WISP, MOVE_DESTINY_BOND
    } /* Verdant polish: TRAINER_AXLE */,
    {
    .lvl = 2,
    .species = SPECIES_MAGCARGO,
    .heldItem = ITEM_WHITE_HERB,
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SHELL_SMASH, MOVE_LAVA_PLUME, MOVE_POWER_GEM, MOVE_EARTH_POWER
    } /* Verdant polish: TRAINER_AXLE */,
    {
    .lvl = 3,
    .species = SPECIES_HEATMOR,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_OVERHEAT, MOVE_FIRE_LASH, MOVE_SUCKER_PUNCH, MOVE_GIGA_DRAIN
    } /* Verdant polish: TRAINER_AXLE */,
    {
    .lvl = 4,
...
static const struct TrainerMonItemCustomMoves sParty_Jace[] = { // double with Eli
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_INFERNO, MOVE_SHADOW_BALL, MOVE_ENERGY_BALL, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JACE */,
    {
    .lvl = 3,
    .species = SPECIES_FLAREON,
    .heldItem = ITEM_TOXIC_ORB,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BURNING_BULWARK, MOVE_RAGING_FURY, MOVE_DRAGON_CLAW, MOVE_MORNING_SUN
    } /* Verdant polish: TRAINER_JACE */,
    {
    .lvl = 6,
    .species = SPECIES_MAROWAK_ALOLAN,
...
static const struct TrainerMonItemCustomMoves sParty_Eli[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_GRAVITY, MOVE_EARTH_POWER, MOVE_ROCK_SLIDE, MOVE_LIGHT_SCREEN
    } /* Verdant polish: TRAINER_ELI */,
    {
    .lvl = 4,
    .species = SPECIES_COALOSSAL,
    .heldItem = ITEM_PASSHO_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_TAR_SHOT, MOVE_HEAT_WAVE, MOVE_POWER_GEM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_ELI */,
    {
    .lvl = 6,
    .species = SPECIES_TURTONATOR,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SHELL_TRAP, MOVE_DRACO_METEOR, MOVE_HEAT_WAVE, MOVE_WIDE_GUARD
    } /* Verdant polish: TRAINER_ELI */,
    {
    .lvl = 7,
    .species = SPECIES_GARGANACL,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_SALT_CURE, MOVE_RECOVER, MOVE_WIDE_GUARD, MOVE_HEAVY_SLAM
    } /* Verdant polish: TRAINER_ELI */
};
static const struct TrainerMonItemCustomMoves sParty_Keegan[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BULK_UP, MOVE_BRICK_BREAK, MOVE_NIGHT_SLASH, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_KEEGAN */,
    {
    .lvl = 2,
    .species = SPECIES_MAGMORTAR,
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_FIRE_BLAST, MOVE_THUNDERBOLT, MOVE_PSYCHIC, MOVE_FOCUS_BLAST
    } /* Verdant polish: TRAINER_KEEGAN */,
    {
    .lvl = 3,
    .species = SPECIES_TYPHLOSION,
...
static const struct TrainerMonItemCustomMoves sParty_Danielle[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_REVELATION_DANCE, MOVE_AIR_SLASH, MOVE_HELPING_HAND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_DANIELLE */,
    {
    .lvl = 2,
    .species = SPECIES_VOLCARONA,
    .heldItem = ITEM_LUM_BERRY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FLARE_BLITZ, MOVE_WILD_CHARGE, MOVE_JUMP_KICK, MOVE_POISON_JAB
    } /* Verdant polish: TRAINER_DANIELLE */,
    {
    .lvl = 4,
    .species = SPECIES_FROSLASS,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FROST_BREATH, MOVE_ICY_WIND, MOVE_TAUNT, MOVE_DESTINY_BOND
    } /* Verdant polish: TRAINER_DANIELLE */
};
...
static const struct TrainerMonItemCustomMoves sParty_Flannery1[] = {
    ...
    } /* Verdant polish: TRAINER_FLANNERY_1 */,
    {
    .lvl = 1,
    .species = SPECIES_LILLIGANT,
    .heldItem = ITEM_FOCUS_SASH,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery2[] = { // singles
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HEAT_WAVE, MOVE_STEALTH_ROCK, MOVE_YAWN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_FLANNERY_2 */,
    {
    .lvl = 0,
    .species = SPECIES_HOUNDOOM,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Flannery3[] = { // singles with legendaries
    ...
    } /* Verdant polish: TRAINER_FLANNERY_3 */,
    {
    .lvl = 0,
    .species = SPECIES_RESHIRAM,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_FIERY_DANCE, MOVE_GIGA_DRAIN, MOVE_QUIVER_DANCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_FLANNERY_3 */,
    {
    .lvl = 0,
    .species = SPECIES_BLAZIKEN,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_STONE_EDGE, MOVE_THUNDER_WAVE, MOVE_STEALTH_ROCK
    } /* Verdant custom: Ashen Woods — Verdant custom: Ashen Woods / Sand and spread */,
    {
    .lvl = -2,
    .species = SPECIES_SHUCKLE,
    .heldItem = ITEM_CHESTO_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_REST, MOVE_ACUPRESSURE, MOVE_ROLLOUT, MOVE_POWER_SPLIT
    } /* Verdant custom: Ashen Woods — Verdant custom: Ashen Woods / Sand and spread */
};
...
static const struct TrainerMonItemCustomMoves sParty_Martin[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_KNOCK_OFF, MOVE_POWER_WHIP, MOVE_CLOSE_COMBAT, MOVE_U_TURN
    } /* Verdant polish: TRAINER_MARTIN */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_GRASSY_GLIDE, MOVE_FAKE_OUT, MOVE_U_TURN, MOVE_WOOD_HAMMER
    } /* Verdant custom: Petalburg City Gym — Verdant custom: Petalburg City Gym / Sun offense */
};
...
static const struct TrainerMonItemCustomMoves sParty_Mary[] = { // Accuracy Room
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_HURRICANE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MARY */,
    {
    .lvl = 0,
    ...
    },
{
    ...
    } /* Verdant custom: Petalburg City Gym — Verdant custom: Petalburg City Gym / Normal-rule breaker */
};
...
static const struct TrainerMonItemCustomMoves sParty_Alexia[] = { // Defense Room
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BRAVE_BIRD, MOVE_SWORDS_DANCE, MOVE_CLOSE_COMBAT, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_ALEXIA */
};
...
static const struct TrainerMonItemCustomMoves sParty_George[] = { // Recovery Room
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_JUDGMENT, MOVE_DAZZLING_GLEAM, MOVE_RECOVER, MOVE_CALM_MIND
    } /* Verdant polish: TRAINER_GEORGE */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_ENCORE, MOVE_EXPANDING_FORCE, MOVE_PROTECT
    } /* Verdant custom: Petalburg City Gym — Verdant custom: Petalburg City Gym / Normal-rule breaker */
};
...
static const struct TrainerMonItemCustomMoves sParty_Berke[] = { // OHKO Room
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_BELLY_DRUM, MOVE_EXPLOSION, MOVE_MUDDY_WATER, MOVE_FIRE_BLAST
    } /* Verdant polish: TRAINER_BERKE */,
    {
    .lvl = 0,
    .species = SPECIES_SNORLAX,
    .heldItem = ITEM_NORMAL_GEM,
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_FISSURE, MOVE_SELF_DESTRUCT, MOVE_BODY_SLAM, MOVE_CURSE
    } /* Verdant polish: TRAINER_BERKE */,
    {
    .lvl = 0,
    .species = SPECIES_URSARING,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_PROTECT, MOVE_GIGA_IMPACT, MOVE_FACADE, MOVE_FIRE_PUNCH
    } /* Verdant polish: TRAINER_BERKE */,
    {
    .lvl = 0,
    .species = SPECIES_OBSTAGOON,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FACADE, MOVE_OBSTRUCT, MOVE_PARTING_SHOT, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_BERKE */
};
...
static const struct TrainerMonItemCustomMoves sParty_Norman1[] = {
    ...
    } /* Verdant doubles: special wallbreaker */,
    {
    .lvl = 0,
    .species = SPECIES_SWELLOW,
    .heldItem = ITEM_FLAME_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FACADE, MOVE_BRAVE_BIRD, MOVE_CLOSE_COMBAT, MOVE_QUICK_ATTACK
    } /* Verdant doubles: speed check */,
    {
    .lvl = 0,
    .species = SPECIES_ZOROARK,
    .heldItem = ITEM_FOCUS_SASH,
    ...
    } /* Verdant doubles: information trap */,
    {
    .lvl = 1,
    .species = SPECIES_KANGASKHAN,
    .heldItem = ITEM_KANGASKHANITE,
    ...
    } /* Verdant doubles: rare endurance test */,
    {
    .lvl = 2,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_GIGA_IMPACT, MOVE_EARTHQUAKE, MOVE_SUCKER_PUNCH, MOVE_SLACK_OFF
    } /* Verdant doubles: prediction ace */
};
...
static const struct TrainerMonItemCustomMoves sParty_Dominik[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_TAILWIND, MOVE_RAIN_DANCE, MOVE_SURF
    } /* Verdant custom: individual diversity replacement for TRAINER_DOMINIK */,
{
    .lvl = -3,
    .species = SPECIES_BRUXISH,
    .spread = SPREAD_31_IV_60_EV,
...
/*     {
    ...
    } /* Verdant custom: Route 105 — Verdant custom: Route 105 / Balanced disruption */
};
...
/*     {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HIDDEN_POWER, MOVE_HYDRO_PUMP, MOVE_AQUA_JET, MOVE_HELPING_HAND
    } /* Verdant custom: Route 105 — Verdant custom: Route 105 / Balanced disruption */
};
...
/*    {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PSYSHOCK, MOVE_NASTY_PLOT, MOVE_ICE_BEAM, MOVE_PROTECT
    } /* Verdant custom: Route 105 — Verdant custom: Route 105 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_TOXAPEX,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HEAT_WAVE, MOVE_RETURN, MOVE_WORK_UP, MOVE_BRAVE_BIRD
    } /* Verdant custom: Route 105 — Verdant custom: Route 105 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYDRO_PUMP, MOVE_WILL_O_WISP, MOVE_THUNDERBOLT, MOVE_PROTECT
    } /* Verdant custom: Route 107 — Verdant custom: Route 107 / Rain pressure */,
    {
    .lvl = -2,
    .species = SPECIES_QUAGSIRE,
    .heldItem = ITEM_LEFTOVERS,
...
static const struct TrainerMonItemCustomMoves sParty_Darrin[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLUDGE_WAVE, MOVE_MUDDY_WATER, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_DARRIN */,
    {
    .lvl = 1,
    .species = SPECIES_BARRASKEWDA,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_THUNDER, MOVE_HYDRO_PUMP, MOVE_VOLT_SWITCH, MOVE_WILL_O_WISP
    } /* Verdant polish: TRAINER_DARRIN */,
    {
    .lvl = 2,
    .species = SPECIES_KINGDRA,
...

{
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_MUDDY_WATER, MOVE_DRACO_METEOR, MOVE_HURRICANE, MOVE_PROTECT
    } /* Verdant custom: Route 107 — Verdant hand-authored competitive core */,
    {
    .lvl = 0,
    .species = SPECIES_SWAMPERT,
    .heldItem = ITEM_SWAMPERTITE,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_WATERFALL, MOVE_HIGH_HORSEPOWER, MOVE_ICE_PUNCH, MOVE_PROTECT
    } /* Verdant custom: Route 107 — Verdant hand-authored competitive core */,
    {
    .lvl = 0,
    .species = SPECIES_RAICHU,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FAKE_OUT, MOVE_THUNDER, MOVE_ENCORE, MOVE_PROTECT
    } /* Verdant custom: Route 107 — Verdant hand-authored competitive core */
};
    ...
    },
{
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_REVELATION_DANCE, MOVE_HURRICANE, MOVE_HEAT_WAVE, MOVE_QUIVER_DANCE
    } /* Verdant custom: Route 107 — Verdant custom: Route 107 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_CRYOGONAL,
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HIDDEN_POWER, MOVE_ICY_WIND, MOVE_RECOVER, MOVE_PROTECT
    } /* Verdant custom: Route 107 — Verdant custom: Route 107 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PAIN_SPLIT, MOVE_TRICK, MOVE_WILL_O_WISP, MOVE_OVERHEAT
    } /* Verdant custom: Route 107 — Verdant custom: Route 107 / Balanced disruption */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 109 — Verdant custom: Route 109 / Rain pressure */,
    {
    .lvl = -2,
    .species = SPECIES_SEALEO,
    .heldItem = ITEM_LEFTOVERS,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HIDDEN_POWER, MOVE_ICE_BEAM, MOVE_STEALTH_ROCK, MOVE_YAWN
    } /* Verdant custom: Route 109 — Verdant custom: Route 109 / Shadow disruption */,
    {
    .lvl = -2,
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_FIRE_BLAST, MOVE_HYPER_VOICE, MOVE_BATON_PASS, MOVE_NASTY_PLOT
    } /* Verdant custom: Route 109 — Verdant custom: Route 109 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_VANILLISH,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_ICE_BEAM, MOVE_EXPLOSION, MOVE_AUTOTOMIZE, MOVE_HIDDEN_POWER
    } /* Verdant custom: Route 109 — Verdant custom: Route 109 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_U_TURN, MOVE_WISH, MOVE_PLUCK, MOVE_DETECT
    } /* Verdant custom: Route 109 — Verdant custom: Route 109 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_SIGILYPH,
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BUG_BUZZ, MOVE_BATON_PASS, MOVE_SUBSTITUTE, MOVE_THUNDER_WAVE
    } /* Verdant custom: Route 109 — Verdant custom: Route 109 / Bug swarm utility */,
    {
    .lvl = -2,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_MEGAHORN, MOVE_AQUA_TAIL, MOVE_SUBSTITUTE, MOVE_PROTECT
    } /* Verdant custom: Abandoned Ship Rooms 2 1 F — Verdant custom: Abandoned Ship Rooms 2 1 F / Bug swarm utility */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PROTECT, MOVE_QUIVER_DANCE, MOVE_HYDRO_PUMP, MOVE_AIR_SLASH
    } /* Verdant custom: Abandoned Ship Rooms 2 1 F — Verdant custom: Abandoned Ship Rooms 2 1 F / Bug swarm utility */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ENCORE, MOVE_FOCUS_BLAST, MOVE_YAWN, MOVE_GIGA_DRAIN
    } /* Verdant custom: Abandoned Ship Rooms 2 1 F — Verdant custom: Abandoned Ship Rooms 2 1 F / Bug swarm utility */,
    {
    .lvl = 0,
    .species = SPECIES_PARASECT,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_ENERGY_BALL, MOVE_HIDDEN_POWER, MOVE_STRENGTH_SAP
    } /* Verdant custom: Route 118 — Verdant custom: Route 118 / Balanced disruption */,
    {
    .lvl = -2,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BULK_UP, MOVE_DYNAMIC_PUNCH, MOVE_ICE_PUNCH, MOVE_BULLET_PUNCH
    } /* Verdant custom: Route 118 — Verdant custom: Route 118 / Balanced disruption */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 123 — Verdant custom: Route 123 / Bug swarm utility */,
    {
    .lvl = -2,
...
static const struct TrainerMonItemCustomMoves sParty_Jazmyn[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDER, MOVE_SHADOW_BALL, MOVE_AURORA_BEAM, MOVE_ELECTROWEB
    } /* Verdant polish: TRAINER_JAZMYN */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_LEECH_SEED, MOVE_EARTHQUAKE, MOVE_STEALTH_ROCK, MOVE_WOOD_HAMMER
    } /* Verdant custom: Route 123 — Verdant custom: Route 123 / Balanced disruption */,
    {
    .lvl = -3,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PROTECT, MOVE_SMART_STRIKE, MOVE_SWORDS_DANCE, MOVE_LEAF_BLADE
    } /* Verdant custom: Route 119 — Verdant explicit team design */,
    {
    .lvl = -2,
    .species = SPECIES_BEEDRILL,
    .heldItem = ITEM_BEEDRILLITE,
    ...
    } /* Verdant custom: Route 119 — Verdant custom: Route 119 / Bug swarm utility */
};
...
static const struct TrainerMonItemCustomMoves sParty_Catherine1[] = {
    ...
    } /* Verdant polish: TRAINER_CATHERINE_1 */,
    {
    .lvl = -2,
    .species = SPECIES_NOIVERN,
    .heldItem = ITEM_PETAYA_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HURRICANE, MOVE_TAILWIND, MOVE_DRAGON_PULSE, MOVE_BOOMBURST
    } /* Verdant polish: TRAINER_CATHERINE_1 */,
    {
    .lvl = -2,
    .species = SPECIES_BEARTIC,
...
static const struct TrainerMonItemCustomMoves sParty_Catherine2[] = {
    ...
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_QUIVER_DANCE, MOVE_MOONBLAST, MOVE_GIGA_DRAIN, MOVE_SLEEP_POWDER
    } /* Verdant polish: TRAINER_CATHERINE_2 */,
    {
    .lvl = -2,
    .species = SPECIES_NOIVERN,
    .heldItem = ITEM_PETAYA_BERRY,
    ...
    },
{
    ...
    } /* Verdant custom: Route 119 — Verdant custom: Route 119 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Catherine4[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_QUIVER_DANCE, MOVE_MOONBLAST, MOVE_GIGA_DRAIN, MOVE_RAGE_POWDER
    } /* Verdant polish: TRAINER_CATHERINE_4 */,
    {
    .lvl = 0,
    .species = SPECIES_NOIVERN,
    .heldItem = ITEM_PETAYA_BERRY,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_SCALD, MOVE_PROTECT, MOVE_SHELL_SMASH, MOVE_AQUA_RING
    } /* Verdant polish: TRAINER_CATHERINE_4 */,
    {
    .lvl = 0,
    .species = SPECIES_AUDINO,
...
static const struct TrainerMonItemCustomMoves sParty_Jackson1[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_TAILWIND, MOVE_ROOST
    } /* Verdant polish: TRAINER_JACKSON_1 */,
    {
    .lvl = -2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_LIQUIDATION, MOVE_MUDDY_WATER, MOVE_CURSE, MOVE_REST
    } /* Verdant polish: TRAINER_JACKSON_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jackson2[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_MUDDY_WATER, MOVE_ROOST
    } /* Verdant polish: TRAINER_JACKSON_2 */,
    {
    .lvl = -2,
    .species = SPECIES_ROTOM_FAN,
    .heldItem = ITEM_SALAC_BERRY,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SUCKER_PUNCH, MOVE_BRAVE_BIRD, MOVE_TAILWIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JACKSON_2 */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ASTRAL_BARRAGE, MOVE_PSYCHIC, MOVE_DRAINING_KISS, MOVE_PROTECT
    } /* Verdant custom: Route 119 — Verdant custom: Route 119 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_ATTACK_ORDER, MOVE_TAILWIND, MOVE_STRING_SHOT, MOVE_STRUGGLE_BUG
    } /* Verdant custom: Route 119 — Verdant custom: Route 119 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_KNOCK_OFF, MOVE_THUNDERBOLT, MOVE_FOCUS_BLAST, MOVE_HIDDEN_POWER
    } /* Verdant custom: Route 119 — Verdant explicit team design */,
    {
    .lvl = -2,
    .species = SPECIES_GOURGEIST,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_TOXIC, MOVE_EARTH_POWER, MOVE_SHADOW_BALL
    } /* Verdant custom: Route 119 — Verdant explicit team design */,
    {
    .lvl = -2,
    .species = SPECIES_MUDSDALE,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_STONE_EDGE, MOVE_HEAVY_SLAM, MOVE_STEALTH_ROCK
    } /* Verdant custom: Route 119 — Verdant explicit team design */
};
...
static const struct TrainerMonItemCustomMoves sParty_Hugh[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_60_EV,
    .moves = MOVE_DRILL_PECK, MOVE_DRILL_RUN, MOVE_FOCUS_ENERGY, MOVE_DOUBLE_EDGE
    } /* Verdant polish: TRAINER_HUGH */,
    {
    .lvl = -3,
    .species = SPECIES_TROPIUS,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_LEECH_SEED, MOVE_SUBSTITUTE, MOVE_ENDEAVOR, MOVE_HIDDEN_POWER
    } /* Verdant custom: Route 119 — Verdant custom: Route 119 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_ARCHEOPS,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_U_TURN, MOVE_DUAL_WINGBEAT, MOVE_EARTHQUAKE, MOVE_ROCK_SLIDE
    } /* Verdant custom: Route 119 — Verdant custom: Route 119 / Balanced disruption */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 119 Weather Institute 1 F — Verdant custom: Route 119 Weather Institute 1 F / Balanced disruption */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 119 Weather Institute 2 F — Verdant custom: Route 119 Weather Institute 2 F / Rain pressure */,
    {
    .lvl = -1,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SCALD, MOVE_HYDRO_PUMP, MOVE_MUDDY_WATER, MOVE_ICE_BEAM
    } /* Verdant custom: Route 119 Weather Institute 2 F — Verdant custom: Route 119 Weather Institute 2 F / Rain pressure */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SWORDS_DANCE, MOVE_SUPERPOWER, MOVE_ROOST, MOVE_BULLET_PUNCH
    } /* Verdant custom: Route 119 Weather Institute 2 F — Verdant explicit team design */,
    {
    .lvl = -1,
    .species = SPECIES_NINJASK,
    .heldItem = ITEM_CHARTI_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BATON_PASS, MOVE_SUBSTITUTE, MOVE_PROTECT, MOVE_X_SCISSOR
    } /* Verdant custom: Route 119 Weather Institute 2 F — Verdant custom: Route 119 Weather Institute 2 F / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_POLTERGEIST, MOVE_TRICK_ROOM, MOVE_PROTECT, MOVE_POWER_WHIP
    } /* Verdant custom: Route 119 Weather Institute 1 F — Verdant custom: Route 119 Weather Institute 1 F / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_QUIVER_DANCE, MOVE_BUG_BUZZ, MOVE_SUBSTITUTE, MOVE_HIDDEN_POWER
    } /* Verdant custom: Route 120 — Verdant custom: Route 120 / Normal-rule breaker */,
    {
    .lvl = -2,
    .species = SPECIES_ARIADOS,
    .heldItem = ITEM_SITRUS_BERRY,
    ...
    }, */
{
    ...
    } /* Verdant custom: Route 120 — Verdant custom: Route 120 / Tailwind offense */
};
    ...
    }, */
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HIDDEN_POWER, MOVE_PROTECT, MOVE_BUG_BUZZ, MOVE_GIGA_DRAIN
    } /* Verdant custom: Route 120 — Verdant custom: Route 120 / Tailwind offense */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 120 — Verdant custom: Route 120 / Rain pressure */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 120 — Verdant custom: Route 120 / Balanced disruption */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PROTECT, MOVE_WOOD_HAMMER, MOVE_ICE_SHARD, MOVE_BLIZZARD
    } /* Verdant custom: Route 120 — Verdant custom: Route 120 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jennifer[] = {
    ...
    } /* Verdant polish: TRAINER_JENNIFER */,
    {
    .lvl = -2,
    .species = SPECIES_KOMMO_O,
    .heldItem = ITEM_LUM_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CLANGING_SCALES, MOVE_OUTRAGE, MOVE_POISON_JAB, MOVE_DRAGON_DANCE
    } /* Verdant polish: TRAINER_JENNIFER */,
    {
    .lvl = -1,
    .species = SPECIES_WHIMSICOTT,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_MOONBLAST, MOVE_ENERGY_BALL, MOVE_TAILWIND, MOVE_PSYCHIC
    } /* Verdant polish: TRAINER_JENNIFER */,
    {
    .lvl = -1,
    .species = SPECIES_BOUFFALANT,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_HEAD_CHARGE, MOVE_MEGAHORN, MOVE_ROCK_SLIDE, MOVE_HEAD_SMASH
    } /* Verdant polish: TRAINER_JENNIFER */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jenna[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_LEAF_BLADE, MOVE_SUCKER_PUNCH, MOVE_LOW_KICK, MOVE_TAILWIND
    } /* Verdant polish: TRAINER_JENNA */,
    {
    .lvl = -2,
    .species = SPECIES_SEVIPER,
    .heldItem = ITEM_SALAC_BERRY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_POISON_JAB, MOVE_ICE_PUNCH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JENNA */,
    {
    .lvl = -2,
    .species = SPECIES_CLOYSTER,
...
static const struct TrainerMonItemCustomMoves sParty_Lorenzo[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_RAIN_DANCE, MOVE_SURF, MOVE_GIGA_DRAIN, MOVE_FAKE_OUT
    } /* Verdant polish: TRAINER_LORENZO */,
    {
    .lvl = -2,
    .species = SPECIES_ZANGOOSE,
    .heldItem = ITEM_TOXIC_ORB,
...
/*     {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BUG_BUZZ, MOVE_HURRICANE, MOVE_SLEEP_POWDER, MOVE_SUBSTITUTE
    } /* Verdant custom: Route 120 — Verdant custom: Route 120 / Bug swarm utility */
};
...
static const struct TrainerMonItemCustomMoves sParty_Jeffrey4[] = {
    ...
    } /* Verdant polish: TRAINER_JEFFREY_4 */,
    {
    .lvl = -3,
    .species = SPECIES_VESPIQUEN,
    .heldItem = ITEM_FLYING_GEM,
...
static const struct TrainerMonItemCustomMoves sParty_Jared[] = { // With Ashley
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SWORDS_DANCE, MOVE_AERIAL_ACE, MOVE_BATON_PASS, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JARED */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HEAT_WAVE, MOVE_AIR_SLASH, MOVE_WHIRLWIND, MOVE_NASTY_PLOT
    } /* Verdant custom: Fortree City Gym — Verdant custom: Fortree City Gym / Tailwind offense */
};
...
static const struct TrainerMonItemCustomMoves sParty_Humberto[] = {
    ...
    } /* Verdant polish: TRAINER_HUMBERTO */,
    {
    .lvl = 0,
    .species = SPECIES_MANDIBUZZ,
    .heldItem = ITEM_LEFTOVERS,
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_FOUL_PLAY, MOVE_TAILWIND, MOVE_ROOST, MOVE_SUBSTITUTE
    } /* Verdant polish: TRAINER_HUMBERTO */,
    {
    .lvl = 0,
    .species = SPECIES_HAWLUCHA,
...
static const struct TrainerMonItemCustomMoves sParty_Flint[] = { // with Edwardo
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_BUG_BUZZ, MOVE_HURRICANE, MOVE_HEAT_WAVE, MOVE_DETECT
    } /* Verdant polish: TRAINER_FLINT */,
    {
    .lvl = 0,
    .species = SPECIES_MANTINE,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FLY, MOVE_PROTECT, MOVE_EXTREME_SPEED, MOVE_DRAGON_DANCE
    } /* Verdant polish: TRAINER_FLINT */
};
...
static const struct TrainerMonItemCustomMoves sParty_Edwardo[] = { // with Flint
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_BRAVE_BIRD, MOVE_DOUBLE_EDGE, MOVE_CLOSE_COMBAT, MOVE_U_TURN
    } /* Verdant polish: TRAINER_EDWARDO */,
    {
    .lvl = 0,
    .species = SPECIES_HONCHKROW,
    .heldItem = ITEM_DARK_GEM,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_STRENGTH_SAP, MOVE_ACROBATICS, MOVE_TAILWIND, MOVE_RAGE_POWDER
    } /* Verdant polish: TRAINER_EDWARDO */
};
...
static const struct TrainerMonItemCustomMoves sParty_Winona1[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_TAILWIND, MOVE_TAUNT, MOVE_HURRICANE, MOVE_ICY_WIND
    } /* Verdant doubles: lead speed control */,
    {
    .lvl = 0,
    ...
    } /* Verdant doubles: spread pressure */,
    {
    .lvl = 0,
    .species = SPECIES_CELESTEELA,
    .heldItem = ITEM_LEFTOVERS,
    ...
    } /* Verdant doubles: Mega secondary mode */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DRAGON_ASCENT, MOVE_V_CREATE, MOVE_EXTREME_SPEED, MOVE_PROTECT
    } /* Verdant doubles: rare ace */
};
...
/*     {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PROTECT, MOVE_DRAGON_DANCE, MOVE_GRAV_APPLE, MOVE_DRAGON_RUSH
    } /* Verdant custom: Route 121 — Verdant custom: Route 121 / Balanced disruption */
};
    ...
    }, */
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_POLLEN_PUFF, MOVE_PROTECT, MOVE_HELPING_HAND, MOVE_ENERGY_BALL
    } /* Verdant custom: Route 121 — Verdant custom: Route 121 / Balanced disruption */,
    {
    .lvl = -3,
    .species = SPECIES_SHAYMIN_SKY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HIDDEN_POWER, MOVE_SUBSTITUTE, MOVE_SEED_FLARE, MOVE_EARTH_POWER
    } /* Verdant custom: Route 121 — Verdant custom: Route 121 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_WILL_O_WISP, MOVE_SLUDGE_BOMB, MOVE_HELPING_HAND, MOVE_PROTECT
    } /* Verdant custom: Route 121 — Verdant hand-authored competitive core */,
    {
    .lvl = 0,
    .species = SPECIES_REGIGIGAS,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_CRUSH_GRIP, MOVE_DRAIN_PUNCH, MOVE_KNOCK_OFF, MOVE_PROTECT
    } /* Verdant custom: Route 121 — Verdant hand-authored competitive core */
};
...
static const struct TrainerMonItemCustomMoves sParty_Walter3[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CRUNCH, MOVE_WILD_CHARGE, MOVE_PLAY_ROUGH, MOVE_ROAR
    } /* Verdant polish: TRAINER_WALTER_3 */,
    {
    .lvl = -2,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NONE,
...
static const struct TrainerMonItemCustomMoves sParty_Walter4[] = {
    ...
    } /* Verdant polish: TRAINER_WALTER_4 */,
    {
    .lvl = -2,
    .species = SPECIES_LINOONE,
    .heldItem = ITEM_NONE,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SUBSTITUTE, MOVE_AIR_SLASH, MOVE_PROTECT, MOVE_THUNDERBOLT
    } /* Verdant custom: Route 121 — Verdant custom: Route 121 / Electric terrain */
};
...
static const struct TrainerMonItemCustomMoves sParty_Marcel[] = { // With Cristin
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ENERGY_BALL, MOVE_DARK_PULSE, MOVE_TAILWIND, MOVE_HEAT_WAVE
    } /* Verdant polish: TRAINER_MARCEL */,
    {
    .lvl = 0,
    .species = SPECIES_ZEBSTRIKA,
    .heldItem = ITEM_FIRE_GEM,
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_LEECH_SEED, MOVE_SYNTHESIS, MOVE_KNOCK_OFF, MOVE_STUN_SPORE
    } /* Verdant custom: Route 121 — Verdant custom: Route 121 / Sun offense */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HIGH_JUMP_KICK, MOVE_KNOCK_OFF, MOVE_HELPING_HAND, MOVE_TROP_KICK
    } /* Verdant custom: Route 121 — Verdant custom: Route 121 / Sun offense */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SHADOW_BALL, MOVE_SNARL, MOVE_WILL_O_WISP, MOVE_PROTECT
    } /* Verdant custom: Mt Pyre 2 F — Verdant explicit team design */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SHADOW_SNEAK, MOVE_GUNK_SHOT, MOVE_POLTERGEIST, MOVE_PROTECT
    } /* Verdant custom: Mt Pyre 2 F — Verdant explicit team design */,
    {
    .lvl = -1,
    .species = SPECIES_SPIRITOMB,
    ...
    } /* Verdant custom: Mt Pyre 2 F — Verdant custom: Mt Pyre 2 F / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Gabrielle2[] = {
    ...
    } /* Verdant polish: TRAINER_GABRIELLE_2 */,
    {
    .lvl = -1,
    .species = SPECIES_HATTERENE,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_TRICK_ROOM, MOVE_PSYCHIC, MOVE_DAZZLING_GLEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_2 */,
    {
    .lvl = 0,
    .species = SPECIES_DHELMISE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_POWER_WHIP, MOVE_ANCHOR_SHOT, MOVE_POLTERGEIST, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_GABRIELLE_2 */,
    {
    .lvl = 0,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_SHADOW_BALL, MOVE_EARTH_POWER, MOVE_STRENGTH_SAP, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_2 */,
    {
    .lvl = 1,
    .species = SPECIES_BANETTE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_SHADOW_CLAW, MOVE_SUCKER_PUNCH, MOVE_WILL_O_WISP, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_2 */,
    {
    .lvl = 1,
    .species = SPECIES_MARSHADOW,
...
static const struct TrainerMonItemCustomMoves sParty_Gabrielle3[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_PERISH_SONG, MOVE_ICY_WIND, MOVE_MUDDY_WATER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_3 */,
    {
    .lvl = 0,
    .species = SPECIES_GENGAR,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SHADOW_BALL, MOVE_SLUDGE_BOMB, MOVE_DISABLE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_3 */,
    {
    .lvl = 0,
    .species = SPECIES_SABLEYE,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_IMPISH,
    .moves = MOVE_FAKE_OUT, MOVE_QUASH, MOVE_WILL_O_WISP, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_3 */,
    {
    .lvl = 1,
    .species = SPECIES_GOTHITELLE,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_FAKE_OUT, MOVE_PSYCHIC, MOVE_HEAL_PULSE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_3 */,
    {
    .lvl = 1,
    .species = SPECIES_JELLICENT,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_WATER_SPOUT, MOVE_SHADOW_BALL, MOVE_TRICK_ROOM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_3 */,
    {
    .lvl = 2,
    .species = SPECIES_LUNALA,
...
static const struct TrainerMonItemCustomMoves sParty_Gabrielle4[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SHADOW_BALL, MOVE_DRACO_METEOR, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_4 */,
    {
    .lvl = 0,
    .species = SPECIES_LUNALA,
    .heldItem = ITEM_POWER_HERB,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SPIKES, MOVE_LIGHT_SCREEN, MOVE_ICE_BEAM, MOVE_TAUNT
    } /* Verdant custom: Mt Pyre 3 F — Verdant custom: Mt Pyre 3 F / Trick Room control */
};
...
/*     {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PERISH_SONG, MOVE_MEAN_LOOK, MOVE_SHADOW_BALL, MOVE_PROTECT
    } /* Verdant custom: Mt Pyre 6 F — Verdant hand-authored competitive core */,
    {
    .lvl = -3,
    .species = SPECIES_POLITOED,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_PERISH_SONG, MOVE_ENCORE, MOVE_SCALD, MOVE_PROTECT
    } /* Verdant custom: Mt Pyre 6 F — Verdant hand-authored competitive core */
};
    ...
    },
{
    ...
    } /* Verdant custom: Mt Pyre Summit — Verdant custom: Mt Pyre Summit / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_SHELL_SMASH, MOVE_SHADOW_BALL, MOVE_STORED_POWER
    } /* Verdant custom: Mt Pyre Summit — Verdant custom: Mt Pyre Summit / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SURGING_STRIKES, MOVE_U_TURN, MOVE_THUNDER_PUNCH, MOVE_CLOSE_COMBAT
    } /* Verdant custom: Mt Pyre Summit — Verdant custom: Mt Pyre Summit / Rain pressure */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CRUNCH, MOVE_SWORDS_DANCE, MOVE_POISON_JAB, MOVE_TOXIC_SPIKES
    } /* Verdant custom: Mt Pyre Summit — Verdant custom: Mt Pyre Summit / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_MattMtPyre[] = {
    ...
    } /* Verdant polish: TRAINER_MATT_MT_PYRE */,
    {
    .lvl = 0,
    .species = SPECIES_DHELMISE,
    .heldItem = ITEM_ASSAULT_VEST,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_WATERFALL, MOVE_CRUNCH, MOVE_ICE_PUNCH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MATT_MT_PYRE */
};
...
static const struct TrainerMonItemCustomMoves sParty_Wendy[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_AIR_SLASH, MOVE_HYDRO_PUMP, MOVE_TAILWIND, MOVE_ROOST
    } /* Verdant polish: TRAINER_WENDY */,
    {
    .lvl = -1,
    .species = SPECIES_HYDREIGON,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DARK_PULSE, MOVE_HEAT_WAVE, MOVE_EARTH_POWER, MOVE_FIRE_BLAST
    } /* Verdant polish: TRAINER_WENDY */,
    {
    .lvl = -1,
    .species = SPECIES_MIENSHAO,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HIDDEN_POWER, MOVE_CALM_MIND, MOVE_WILL_O_WISP, MOVE_THUNDERBOLT
    } /* Verdant polish: TRAINER_WENDY */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SPIRIT_SHACKLE, MOVE_LEAF_STORM, MOVE_KNOCK_OFF, MOVE_TAILWIND
    } /* Verdant custom: Route 123 — Verdant custom: Route 123 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Fernando2[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BOOMBURST, MOVE_HEAT_WAVE, MOVE_U_TURN, MOVE_TAUNT
    } /* Verdant polish: TRAINER_FERNANDO_2 */,
    {
    .lvl = 0,
    .species = SPECIES_TOXTRICITY,
    .heldItem = ITEM_CHOICE_SPECS,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_WILD_CHARGE, MOVE_FLARE_BLITZ, MOVE_LOW_KICK, MOVE_QUICK_ATTACK
    } /* Verdant polish: TRAINER_FERNANDO_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Fernando3[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BOOMBURST, MOVE_DRACO_METEOR, MOVE_HURRICANE, MOVE_FLAMETHROWER
    } /* Verdant polish: TRAINER_FERNANDO_3 */,
    {
    .lvl = 1,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_CHOICE_SPECS,
...
static const struct TrainerMonItemCustomMoves sParty_Fernando4[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_RELIC_SONG, MOVE_PSYCHIC, MOVE_HYPER_VOICE, MOVE_FOCUS_BLAST
    } /* Verdant polish: TRAINER_FERNANDO_4 */,
    {
    .lvl = 1,
    .species = SPECIES_TOXTRICITY,
    .heldItem = ITEM_CHOICE_SPECS,
...
/*     {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_GIGA_DRAIN, MOVE_HIDDEN_POWER, MOVE_PROTECT, MOVE_LEECH_SEED
    } /* Verdant custom: Route 123 — Verdant custom: Route 123 / Psychic terrain */
};
...
/*     {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PHOTON_GEYSER, MOVE_HEAT_WAVE, MOVE_THUNDER_WAVE, MOVE_MOONGEIST_BEAM
    } /* Verdant custom: Route 123 — Verdant custom: Route 123 / Psychic terrain */
};
...
/*     {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_PROTECT, MOVE_THUNDER_WAVE, MOVE_REFLECT, MOVE_LIGHT_SCREEN
    } /* Verdant custom: Route 123 — Verdant custom: Route 123 / Psychic terrain */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_STEALTH_ROCK, MOVE_TOXIC, MOVE_SPIKES, MOVE_TAUNT
    } /* Verdant custom: Route 123 — Verdant custom: Route 123 / Psychic terrain */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_EARTH_POWER, MOVE_HIDDEN_POWER, MOVE_SUBSTITUTE, MOVE_SEED_FLARE
    } /* Verdant custom: Route 123 — Verdant explicit team design */
};
...
static const struct TrainerMonItemCustomMoves sParty_Cameron3[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_TRICK_ROOM, MOVE_ROCK_SLIDE, MOVE_ZEN_HEADBUTT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CAMERON_3 */,
    {
    .lvl = 0,
    .species = SPECIES_LUNATONE,
    .heldItem = ITEM_POWER_HERB,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_METEOR_BEAM, MOVE_PSYCHIC, MOVE_MOONBLAST, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CAMERON_3 */,
    {
    .lvl = 1,
    .species = SPECIES_STAKATAKA,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_PHOTON_GEYSER, MOVE_EARTH_POWER, MOVE_DAZZLING_GLEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CAMERON_3 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Cameron4[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_EXPANDING_FORCE, MOVE_MOONBLAST, MOVE_DAZZLING_GLEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CAMERON_4 */,
    {
    .lvl = 0,
    .species = SPECIES_CRESSELIA,
    .heldItem = ITEM_MENTAL_HERB,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_TRICK_ROOM, MOVE_HELPING_HAND, MOVE_ICY_WIND, MOVE_MOONLIGHT
    } /* Verdant polish: TRAINER_CAMERON_4 */,
    {
    .lvl = 1,
    .species = SPECIES_SLOWBRO,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_EXPANDING_FORCE, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CAMERON_4 */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PSYSHOCK, MOVE_SHADOW_BALL, MOVE_PROTECT, MOVE_MOONLIGHT
    } /* Verdant polish: TRAINER_CAMERON_4 */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PROTECT, MOVE_U_TURN, MOVE_KNOCK_OFF, MOVE_PLAY_ROUGH
    } /* Verdant custom: Magma Hideout 1 F — Verdant custom: Magma Hideout 1 F / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_RAPID_SPIN, MOVE_WATERFALL, MOVE_HONE_CLAWS, MOVE_TOXIC
    } /* Verdant custom: Magma Hideout 1 F — Verdant custom: Magma Hideout 1 F / Sand and spread */
};
    ...
    },
{
    ...
    } /* Verdant custom: Magma Hideout 2 F 1 R — Verdant custom: Magma Hideout 2 F 1 R / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Grunt43[] = {
    ...
    } /* Verdant polish: TRAINER_GRUNT_MAGMA_HIDEOUT_6 */,
    {
    .lvl = -1,
    .species = SPECIES_HEATRAN,
    .heldItem = ITEM_SHUCA_BERRY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_OVERHEAT, MOVE_FAKE_OUT, MOVE_PROTECT, MOVE_CLOSE_COMBAT
    } /* Verdant polish: TRAINER_GRUNT_MAGMA_HIDEOUT_6 */
};
    ...
    },
{
    ...
    } /* Verdant custom: Magma Hideout 2 F 2 R — Verdant custom: Magma Hideout 2 F 2 R / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SHADOW_BALL, MOVE_FIRE_BLAST, MOVE_PROTECT, MOVE_HIDDEN_POWER
    } /* Verdant custom: Magma Hideout 3 F 1 R — Verdant explicit team design */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_LIGHT_SCREEN, MOVE_DAZZLING_GLEAM, MOVE_PROTECT, MOVE_FOLLOW_ME
    } /* Verdant custom: Magma Hideout 3 F 2 R — Verdant custom: Magma Hideout 3 F 2 R / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_PROTECT, MOVE_HELPING_HAND, MOVE_WILD_CHARGE
    } /* Verdant custom: Magma Hideout 4 F — Verdant custom: Magma Hideout 4 F / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DUAL_WINGBEAT, MOVE_PROTECT, MOVE_ROCK_SLIDE, MOVE_TAILWIND
    } /* Verdant custom: Magma Hideout 2 F 1 R — Verdant custom: Magma Hideout 2 F 1 R / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SLUDGE_WAVE, MOVE_STEALTH_ROCK, MOVE_SURF, MOVE_EARTH_POWER
    } /* Verdant custom: Magma Hideout 3 F 1 R — Verdant custom: Magma Hideout 3 F 1 R / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_TabithaMagmaHideout[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_POWER_GEM, MOVE_EARTH_POWER, MOVE_WEATHER_BALL, MOVE_SUNNY_DAY
    } /* Verdant polish: TRAINER_TABITHA_MAGMA_HIDEOUT */,
    {
    .lvl = 1,
    .species = SPECIES_DARMANITAN,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_IRON_HEAD, MOVE_HIGH_HORSEPOWER, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE
    } /* Verdant polish: TRAINER_TABITHA_MAGMA_HIDEOUT */,
    {
    .lvl = 1,
    .species = SPECIES_COALOSSAL,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SURF, MOVE_DRAGON_DARTS, MOVE_WILL_O_WISP, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TABITHA_MAGMA_HIDEOUT */,
    {
    .lvl = 1,
    .species = SPECIES_GASTRODON,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SCALD, MOVE_EARTH_POWER, MOVE_YAWN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TABITHA_MAGMA_HIDEOUT */
};
...
static const struct TrainerMonItemCustomMoves sParty_CourtneyMagmaHideout[] = {
    ...
    } /* Verdant polish: TRAINER_COURTNEY_MAGMA_HIDEOUT */,
    {
    .lvl = 1,
    .species = SPECIES_KROOKODILE,
    .heldItem = ITEM_ASSAULT_VEST,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_V_CREATE, MOVE_BLUE_FLARE, MOVE_PROTECT, MOVE_BOLT_STRIKE
    } /* Verdant polish: TRAINER_COURTNEY_MAGMA_HIDEOUT */,
    {
    .lvl = 1,
    .species = SPECIES_LANDORUS,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FOCUS_BLAST, MOVE_ROCK_SLIDE, MOVE_PROTECT, MOVE_EARTH_POWER
    } /* Verdant polish: TRAINER_COURTNEY_MAGMA_HIDEOUT */,
    {
    .lvl = 1,
    .species = SPECIES_CHANDELURE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SHADOW_BALL, MOVE_HEAT_WAVE, MOVE_TRICK, MOVE_HIDDEN_POWER
    } /* Verdant polish: TRAINER_COURTNEY_MAGMA_HIDEOUT */
};
...
static const struct TrainerMonItemCustomMoves sParty_MaxieMagmaHideout[] = {
    ...
    } /* Verdant polish: TRAINER_MAXIE_MAGMA_HIDEOUT */,
    {
    .lvl = 1,
    .species = SPECIES_LYCANROC_DUSK,
    .heldItem = ITEM_ROCK_GEM,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_EARTH_POWER, MOVE_FIRE_BLAST, MOVE_SOLAR_BEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_MAXIE_MAGMA_HIDEOUT */
};
    ...
    },
{
    ...
    } /* Verdant custom: Aqua Hideout 1 F — Verdant explicit team design */
};
    ...
    },
{
    ...
    } /* Verdant custom: Aqua Hideout B 1 F — Verdant custom: Aqua Hideout B 1 F / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Grunt3[] = {
    ...
    } /* Verdant polish: TRAINER_GRUNT_AQUA_HIDEOUT_3 */,
    {
    .lvl = -1,
    .species = SPECIES_URSHIFU_RAPID_STRIKE_STYLE,
    .heldItem = ITEM_CHOICE_BAND,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PROTECT, MOVE_SHELL_SMASH, MOVE_LIQUIDATION, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_GRUNT_AQUA_HIDEOUT_3 */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_SUCKER_PUNCH, MOVE_HIDDEN_POWER, MOVE_THUNDER_WAVE, MOVE_SUBSTITUTE
    } /* Verdant custom: Aqua Hideout B 1 F — Verdant custom: Aqua Hideout B 1 F / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Grunt22[] = {
    ...
    } /* Verdant polish: TRAINER_GRUNT_AQUA_HIDEOUT_6 */,
    {
    .lvl = -1,
    .species = SPECIES_TOXAPEX,
    .heldItem = ITEM_NONE,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_AQUA_JET, MOVE_WATERFALL, MOVE_SUPERPOWER, MOVE_CRUNCH
    } /* Verdant polish: TRAINER_GRUNT_AQUA_HIDEOUT_6 */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_GRASS_KNOT, MOVE_NASTY_PLOT, MOVE_PARTING_SHOT, MOVE_DARK_PULSE
    } /* Verdant custom: Aqua Hideout B 1 F — Verdant custom: Aqua Hideout B 1 F / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER, MOVE_SHADOW_BALL, MOVE_NASTY_PLOT
    } /* Verdant custom: Aqua Hideout B 2 F — Verdant custom: Aqua Hideout B 2 F / Balanced disruption */
};
    ...
    },
{
    ...
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_X_SCISSOR, MOVE_WILD_CHARGE, MOVE_CRUNCH, MOVE_ACROBATICS
    } /* Verdant custom: Route 124 — Verdant custom: Route 124 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_PALPITOAD,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_STEALTH_ROCK, MOVE_HIDDEN_POWER, MOVE_HYDRO_PUMP, MOVE_EARTH_POWER
    } /* Verdant custom: Route 124 — Verdant custom: Route 124 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SCALE_SHOT, MOVE_GLARE, MOVE_PROTECT, MOVE_SUCKER_PUNCH
    } /* Verdant custom: Route 124 — Verdant custom: Route 124 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_RECOVER, MOVE_ICE_BEAM, MOVE_TRI_ATTACK
    } /* Verdant custom: Route 124 — Verdant custom: Route 124 / Balanced disruption */,
    {
    .lvl = 0,
    .species = SPECIES_FLAAFFY,
...
static const struct TrainerMonItemCustomMoves sParty_Ernest2[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FIRST_IMPRESSION, MOVE_LIQUIDATION, MOVE_LEECH_LIFE, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_ERNEST_2 */,
    {
    .lvl = 1,
    .species = SPECIES_CONKELDURR,
    .heldItem = ITEM_FLAME_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DRAIN_PUNCH, MOVE_FACADE, MOVE_MACH_PUNCH, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_ERNEST_2 */,
    {
    .lvl = 2,
    .species = SPECIES_FERALIGATR,
...
static const struct TrainerMonItemCustomMoves sParty_Ernest3[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DRAIN_PUNCH, MOVE_LEECH_LIFE, MOVE_ICE_PUNCH, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_ERNEST_3 */,
    {
    .lvl = 1,
    .species = SPECIES_URSHIFU_RAPID_STRIKE_STYLE,
    .heldItem = ITEM_CHOICE_BAND,
    ...
    },
{
    ...
    } /* Verdant custom: Route 125 — Verdant custom: Route 125 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_DRAGONAIR,
    .heldItem = ITEM_NONE,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HYDRO_PUMP, MOVE_ICY_WIND, MOVE_PROTECT, MOVE_FLASH_CANNON
    } /* Verdant custom: Route 125 — Verdant custom: Route 125 / Rain pressure */
};
...
static const struct TrainerMonItemCustomMoves sParty_Auron[] = { // With Presley
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDERBOLT, MOVE_FLAMETHROWER, MOVE_ELECTROWEB, MOVE_SIGNAL_BEAM
    } /* Verdant polish: TRAINER_AURON */,
    {
    .lvl = -1,
    .species = SPECIES_LUCARIO,
    .heldItem = ITEM_DARK_GEM,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_TOXIC, MOVE_ACID_ARMOR, MOVE_SCALD, MOVE_ICE_BEAM
    } /* Verdant polish: TRAINER_AURON */,
    {
    .lvl = -1,
    .species = SPECIES_CORSOLA,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_FOCUS_BLAST, MOVE_DRACO_METEOR, MOVE_PROTECT, MOVE_SLUDGE_BOMB
    } /* Verdant custom: Route 126 — Verdant custom: Route 126 / Balanced disruption */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_TOXIC, MOVE_ROOST, MOVE_KNOCK_OFF, MOVE_TAUNT
    } /* Verdant custom: Route 126 — Verdant custom: Route 126 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Pablo2[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_LIQUIDATION, MOVE_CLOSE_COMBAT, MOVE_PSYCHIC_FANGS, MOVE_CRUNCH
    } /* Verdant polish: TRAINER_PABLO_2 */,
    {
    .lvl = 1,
    .species = SPECIES_QWILFISH,
    .heldItem = ITEM_BLACK_SLUDGE,
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_WATERFALL, MOVE_POISON_JAB, MOVE_AQUA_JET, MOVE_SWORDS_DANCE
    } /* Verdant polish: TRAINER_PABLO_2 */,
    {
    .lvl = 2,
    .species = SPECIES_SHARPEDO,
...
static const struct TrainerMonItemCustomMoves sParty_Pablo3[] = {
    ...
    } /* Verdant polish: TRAINER_PABLO_3 */,
    {
    .lvl = 1,
    .species = SPECIES_URSHIFU_RAPID_STRIKE_STYLE,
    .heldItem = ITEM_CHOICE_BAND,
...
static const struct TrainerMonItemCustomMoves sParty_Pablo4[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_WATER_SPOUT, MOVE_ORIGIN_PULSE, MOVE_THUNDER, MOVE_ICE_BEAM
    } /* Verdant polish: TRAINER_PABLO_4 */,
    {
    .lvl = 1,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SPACIAL_REND, MOVE_HYDRO_PUMP, MOVE_THUNDER, MOVE_EARTH_POWER
    } /* Verdant polish: TRAINER_PABLO_4 */,
    {
    .lvl = 2,
    .species = SPECIES_KINGDRA,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_HYDRO_PUMP, MOVE_DRACO_METEOR, MOVE_HURRICANE, MOVE_FLASH_CANNON
    } /* Verdant polish: TRAINER_PABLO_4 */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_WISH, MOVE_SHADOW_BALL, MOVE_HIDDEN_POWER, MOVE_PROTECT
    } /* Verdant custom: Route 126 — Verdant custom: Route 126 / Balanced disruption */,
    {
    .lvl = -3,
    .species = SPECIES_OCTILLERY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_ENERGY_BALL, MOVE_ICE_BEAM, MOVE_PROTECT, MOVE_HYDRO_PUMP
    } /* Verdant custom: Route 126 — Verdant custom: Route 126 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_NAIVE,
    .moves = MOVE_CLOSE_COMBAT, MOVE_ICE_BEAM, MOVE_U_TURN, MOVE_PROTECT
    } /* Verdant custom: Route 127 — Verdant explicit team design */,
    {
    .lvl = -2,
    .species = SPECIES_SWANNA,
    .heldItem = ITEM_WATER_GEM,
    ...
    } /* Verdant custom: Route 127 — Verdant custom: Route 127 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_ROCK_SLIDE, MOVE_CRABHAMMER, MOVE_SUBSTITUTE, MOVE_AGILITY
    } /* Verdant custom: Route 127 — Verdant explicit team design */,
    {
    .lvl = -2,
    .species = SPECIES_CRABOMINABLE,
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FOLLOW_ME, MOVE_DAZZLING_GLEAM, MOVE_PROTECT, MOVE_AIR_SLASH
    } /* Verdant custom: Route 127 — Verdant custom: Route 127 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SLACK_OFF, MOVE_FIRE_BLAST, MOVE_TRICK_ROOM, MOVE_SCALD
    } /* Verdant custom: Route 127 — Verdant custom: Route 127 / Balanced disruption */,
    {
    .lvl = -1,
    .species = SPECIES_SEAKING,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_KNOCK_OFF, MOVE_SWORDS_DANCE, MOVE_PROTECT, MOVE_WATERFALL
    } /* Verdant custom: Route 127 — Verdant custom: Route 127 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_PROTECT, MOVE_ICICLE_SPEAR, MOVE_HYDRO_PUMP, MOVE_SHELL_SMASH
    } /* Verdant custom: Route 128 — Verdant custom: Route 128 / Trick Room control */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 128 — Verdant custom: Route 128 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DRAGON_TAIL, MOVE_BODY_SLAM, MOVE_TOXIC, MOVE_EARTHQUAKE
    } /* Verdant custom: Route 128 — Verdant custom: Route 128 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_MANDIBUZZ,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_KNOCK_OFF, MOVE_BRAVE_BIRD, MOVE_TAUNT, MOVE_ROOST
    } /* Verdant custom: Route 128 — Verdant custom: Route 128 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HURRICANE, MOVE_POLLEN_PUFF, MOVE_PROTECT, MOVE_QUIVER_DANCE
    } /* Verdant custom: Route 128 — Verdant custom: Route 128 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_CORSOLA_GALARIAN,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HAZE, MOVE_NIGHT_SHADE, MOVE_STRENGTH_SAP, MOVE_WILL_O_WISP
    } /* Verdant custom: Route 128 — Verdant custom: Route 128 / Balanced disruption */
};
...
/*     {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PROTECT, MOVE_TAILWIND, MOVE_PSYCHIC, MOVE_HEAT_WAVE
    } /* Verdant custom: Route 128 — Verdant custom: Route 128 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_PROTECT, MOVE_KNOCK_OFF, MOVE_SCALD, MOVE_HELPING_HAND
    } /* Verdant custom: Route 128 — Verdant custom: Route 128 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_DIANCIE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_TRICK_ROOM, MOVE_PROTECT, MOVE_BODY_PRESS, MOVE_DIAMOND_STORM
    } /* Verdant custom: Route 128 — Verdant custom: Route 128 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Chase[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PSYSHOCK, MOVE_PROTECT, MOVE_SCALD, MOVE_FIRE_BLAST
    } /* Verdant custom: individual diversity replacement for TRAINER_CHASE */,
{
    .lvl = -2,
    .species = SPECIES_BRAVIARY,
    .spread = SPREAD_31_IV_80_EV,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_SUPERPOWER, MOVE_STEALTH_ROCK, MOVE_ICE_PUNCH
    } /* Verdant custom: Route 129 — Verdant custom: Route 129 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_CARRACOSTA,
    .heldItem = ITEM_WHITE_HERB,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_WATERFALL, MOVE_SHELL_SMASH, MOVE_AQUA_JET
    } /* Verdant custom: Route 129 — Verdant custom: Route 129 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Tisha[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_TAUNT, MOVE_ROOST, MOVE_PLUCK, MOVE_RETURN
    } /* Verdant polish: TRAINER_TISHA */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 130 — Verdant custom: Route 130 / Balanced disruption */,
    {
    .lvl = -2,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HEAL_PULSE, MOVE_THUNDERBOLT, MOVE_MOONBLAST, MOVE_PROTECT
    } /* Verdant custom: Route 130 — Verdant custom: Route 130 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FREEZE_DRY, MOVE_AURORA_VEIL, MOVE_PROTECT, MOVE_BLIZZARD
    } /* Verdant custom: Route 130 — Verdant custom: Route 130 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_ZEKROM,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BOLT_STRIKE, MOVE_HONE_CLAWS, MOVE_OUTRAGE, MOVE_DRACO_METEOR
    } /* Verdant custom: Route 130 — Verdant custom: Route 130 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYDRO_PUMP, MOVE_THUNDER_WAVE, MOVE_FIRE_BLAST, MOVE_SPACIAL_REND
    } /* Verdant custom: Route 131 — Verdant custom: Route 131 / Balanced disruption */,
    {
    .lvl = -2,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_DRAGON_DANCE, MOVE_STONE_EDGE, MOVE_WATERFALL
    } /* Verdant custom: Route 131 — Verdant custom: Route 131 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ICE_BEAM, MOVE_PROTECT, MOVE_DRACO_METEOR, MOVE_ROOST
    } /* Verdant custom: Route 131 — Verdant custom: Route 131 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Susie[] = { // Ace, with Herman
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HURRICANE, MOVE_HEAT_WAVE, MOVE_TAILWIND, MOVE_U_TURN
    } /* Verdant polish: TRAINER_SUSIE */,
    {
    .lvl = -1,
    .species = SPECIES_PROBOPASS,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_THUNDER_WAVE, MOVE_FOUL_PLAY, MOVE_MOONLIGHT, MOVE_SNARL
    } /* Verdant polish: TRAINER_SUSIE */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SUPERPOWER, MOVE_TOXIC, MOVE_WATERFALL, MOVE_AQUA_JET
    } /* Verdant custom: Route 131 — Verdant custom: Route 131 / Rain pressure */,
    {
    .lvl = -2,
    .species = SPECIES_BLASTOISE,
    .heldItem = ITEM_BLASTOISINITE,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_DARK_PULSE, MOVE_MUDDY_WATER, MOVE_AURA_SPHERE, MOVE_PROTECT
    } /* Verdant custom: Route 131 — Verdant custom: Route 131 / Rain pressure */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 132 — Verdant custom: Route 132 / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_CASTFORM,
    .heldItem = ITEM_CHOICE_SPECS,
...
static const struct TrainerMonItemCustomMoves sParty_Ronald[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_80_EV,
    .moves = MOVE_SPLASH, MOVE_THRASH, MOVE_OUTRAGE, MOVE_HYDRO_PUMP
    } /* Verdant polish: TRAINER_RONALD */
};
...
static const struct TrainerMonItemCustomMoves sParty_Makayla[] = { // with Jonathon
    ...
    } /* Verdant polish: TRAINER_MAKAYLA */,
    {
    .lvl = -1,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HIGH_JUMP_KICK, MOVE_ZEN_HEADBUTT, MOVE_ICE_PUNCH, MOVE_SWORDS_DANCE
    } /* Verdant polish: TRAINER_MAKAYLA */,
    {
    .lvl = -1,
    .species = SPECIES_FLAREON,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PROTECT, MOVE_ROCK_SLIDE, MOVE_SUPERPOWER, MOVE_ICICLE_CRASH
    } /* Verdant polish: TRAINER_MAKAYLA */
};
    ...
    },
{
    ...
    } /* Verdant custom: Route 133 — Verdant explicit team design */,
    {
    .lvl = -3,
    .species = SPECIES_ARCTOZOLT,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_BOLT_BEAK, MOVE_ICICLE_CRASH, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant custom: Route 133 — Verdant hand-authored competitive core */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_AIR_SLASH, MOVE_ROOST, MOVE_PROTECT, MOVE_THUNDERBOLT
    } /* Verdant custom: Route 133 — Verdant custom: Route 133 / Tailwind offense */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_RECOVER, MOVE_PROTECT, MOVE_EARTHQUAKE, MOVE_AVALANCHE
    } /* Verdant custom: Route 133 — Verdant custom: Route 133 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PROTECT, MOVE_ELECTROWEB, MOVE_BLIZZARD, MOVE_THUNDERBOLT
    } /* Verdant custom: Route 133 — Verdant custom: Route 133 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_ICY_WIND, MOVE_FAKE_OUT, MOVE_FREEZE_DRY, MOVE_ENCORE
    } /* Verdant custom: Route 133 — Verdant custom: Route 133 / Trick Room control */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PROTECT, MOVE_AQUA_JET, MOVE_KNOCK_OFF, MOVE_CRABHAMMER
    } /* Verdant custom: Route 133 — Verdant custom: Route 133 / Balanced disruption */,
    {
    .lvl = -3,
    .species = SPECIES_SWALOT,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_SUBSTITUTE, MOVE_ICE_BEAM, MOVE_ROOST, MOVE_DRAGON_TAIL
    } /* Verdant custom: Route 133 — Verdant custom: Route 133 / Balanced disruption */,
    {
    .lvl = -3,
    .species = SPECIES_SNEASEL,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_LOW_KICK, MOVE_SWORDS_DANCE, MOVE_NIGHT_SLASH, MOVE_ICE_PUNCH
    } /* Verdant custom: Route 133 — Verdant custom: Route 133 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_ICE_BEAM, MOVE_HIDDEN_POWER, MOVE_MUDDY_WATER
    } /* Verdant custom: Route 134 — Verdant custom: Route 134 / Balanced disruption */,
    {
    .lvl = -3,
    .species = SPECIES_TAPU_LELE,
    .heldItem = ITEM_PSYCHIC_SEED,
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_RECOVER, MOVE_TOXIC, MOVE_STOCKPILE, MOVE_EARTHQUAKE
    } /* Verdant custom: Route 134 — Verdant custom: Route 134 / Fake Out and pressure */,
    {
    .lvl = -3,
    .species = SPECIES_SNORUNT,
    .heldItem = ITEM_EXPERT_BELT,
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_CRUNCH, MOVE_ICE_BEAM, MOVE_HIDDEN_POWER, MOVE_ICE_SHARD
    } /* Verdant custom: Route 134 — Verdant custom: Route 134 / Fake Out and pressure */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HYDRO_PUMP, MOVE_HIDDEN_POWER, MOVE_ICE_BEAM, MOVE_ENCORE
    } /* Verdant custom: Route 134 — Verdant custom: Route 134 / Balanced disruption */,
    {
    .lvl = -3,
    .species = SPECIES_CHINCHOU,
...
static const struct TrainerMonItemCustomMoves sParty_Alex[] = { // with Kelvin
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HURRICANE, MOVE_ICE_BEAM, MOVE_SURF, MOVE_TAILWIND
    } /* Verdant custom: individual diversity replacement for TRAINER_ALEX */,
{
    .lvl = -3,
    .species = SPECIES_TOGEKISS,
    .ability = 1, // Serene Grace
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HIDDEN_POWER, MOVE_SEED_BOMB, MOVE_WATER_SPOUT, MOVE_FIRE_BLAST
    } /* Verdant custom: Route 134 — Verdant custom: Route 134 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza1[] = { // Inverse Battle!
    ...
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_EXPANDING_FORCE, MOVE_SCALD, MOVE_ICE_BEAM, MOVE_PROTECT
    } /* Verdant doubles: Mega slow cannon */,
    {
    .lvl = 0,
    .species = SPECIES_LUNALA,
    .heldItem = ITEM_POWER_HERB,
    ...
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_MOONGEIST_BEAM, MOVE_METEOR_BEAM, MOVE_DAZZLING_GLEAM, MOVE_WIDE_GUARD
    } /* Verdant doubles: rare spread guard */,
    {
    .lvl = 1,
    .species = SPECIES_VICTINI,
    .heldItem = ITEM_WEAKNESS_POLICY,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_V_CREATE, MOVE_ZEN_HEADBUTT, MOVE_BOLT_STRIKE, MOVE_PROTECT
    } /* Verdant doubles: physical breaker */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_GLACIAL_LANCE, MOVE_HIGH_HORSEPOWER, MOVE_ZEN_HEADBUTT, MOVE_PROTECT
    } /* Verdant doubles: rare Trick Room ace */
};
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza4[] = { // unused for now
    ...
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_FOLLOW_ME, MOVE_HELPING_HAND, MOVE_EXPANDING_FORCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TATE_AND_LIZA_4 */,
    {
    .lvl = 1,
    .species = SPECIES_MEWTWO,
    .heldItem = ITEM_MEWTWONITE_Y,
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_EXPANDING_FORCE, MOVE_AURA_SPHERE, MOVE_ICE_BEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TATE_AND_LIZA_4 */,
    {
    .lvl = 2,
    .species = SPECIES_STAKATAKA,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_IRON_HEAD, MOVE_ICY_WIND, MOVE_FOLLOW_ME, MOVE_HELPING_HAND
    } /* Verdant polish: TRAINER_TATE_AND_LIZA_4 */,
    {
    .lvl = 3,
    .species = SPECIES_HOOPA_UNBOUND,
...
static const struct TrainerMonItemCustomMoves sParty_TateAndLiza5[] = { // unused for now
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_EXPANDING_FORCE, MOVE_MOONBLAST, MOVE_DAZZLING_GLEAM, MOVE_FOCUS_BLAST
    } /* Verdant polish: TRAINER_TATE_AND_LIZA_5 */,
    {
    .lvl = 2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_TRICK_ROOM, MOVE_FLASH_CANNON, MOVE_DRACO_METEOR, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TATE_AND_LIZA_5 */,
    {
    .lvl = 3,
    .species = SPECIES_PALKIA,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_IRON_HEAD, MOVE_FOLLOW_ME, MOVE_PROTECT, MOVE_BODY_SLAM
    } /* Verdant custom: Mossdeep City Gym — Verdant explicit team design */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PROTECT, MOVE_KNOCK_OFF, MOVE_PSYCHO_BOOST, MOVE_EXTREME_SPEED
    } /* Verdant custom: Mossdeep City Gym — Verdant custom: Mossdeep City Gym / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_STEALTH_ROCK, MOVE_YAWN, MOVE_U_TURN, MOVE_PROTECT
    } /* Verdant custom: Mossdeep City Gym — Verdant explicit team design */,
    {
    .lvl = 0,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_TRICK_ROOM, MOVE_PSYCHIC, MOVE_HELPING_HAND, MOVE_POLLEN_PUFF
    } /* Verdant custom: Mossdeep City Gym — Verdant explicit team design */
};
...
static const struct TrainerMonItemCustomMoves sParty_Samantha[] = { // with Blake
    ...
    } /* Verdant polish: TRAINER_SAMANTHA */,
    {
    .lvl = -2,
    .species = SPECIES_GARDEVOIR,
    .heldItem = ITEM_EXPERT_BELT,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_FLEUR_CANNON, MOVE_TRICK_ROOM, MOVE_PROTECT, MOVE_FLASH_CANNON
    } /* Verdant polish: TRAINER_SAMANTHA */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_U_TURN, MOVE_ICE_BEAM, MOVE_PSYCHIC, MOVE_TRICK
    } /* Verdant polish: TRAINER_SAMANTHA */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_COSMIC_POWER, MOVE_TELEPORT, MOVE_SPLASH, MOVE_PROTECT
    } /* Verdant custom: Mossdeep City Gym — Verdant explicit team design */,
    {
    .lvl = -2,
    .species = SPECIES_MR_MIME,
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_PSYCHIC, MOVE_TRICK_ROOM, MOVE_FOCUS_BLAST
    } /* Verdant custom: Mossdeep City Gym — Verdant custom: Mossdeep City Gym / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_GRUMPIG,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_ELECTRIC_TERRAIN, MOVE_THUNDERBOLT, MOVE_SUCKER_PUNCH, MOVE_PROTECT
    } /* Verdant custom: Mossdeep City Gym — Verdant explicit team design */,
    {
    .lvl = 0,
    .species = SPECIES_TAPU_KOKO,
    ...
    } /* Verdant custom: Mossdeep City Gym — Verdant hand-authored competitive core */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_RETURN, MOVE_FLAMETHROWER, MOVE_SURF
    } /* Verdant custom: Mossdeep City Gym — Verdant custom: Mossdeep City Gym / Balanced disruption */,
    {
    .lvl = -2,
    .species = SPECIES_COMFEY,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_TRICK_ROOM, MOVE_DAZZLING_GLEAM, MOVE_PSYCHIC
    } /* Verdant custom: Mossdeep City Gym — Verdant explicit team design */,
    {
    .lvl = 0,
    .species = SPECIES_INDEEDEE_FEMALE,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PROTECT, MOVE_FOLLOW_ME, MOVE_EXPANDING_FORCE, MOVE_HEAL_PULSE
    } /* Verdant custom: Mossdeep City Gym — Verdant explicit team design */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_EARTHQUAKE, MOVE_SWORDS_DANCE, MOVE_PHOTON_GEYSER, MOVE_KNOCK_OFF
    } /* Verdant custom: Mossdeep City Gym — Verdant explicit team design */,
    {
    .lvl = -2,
    .species = SPECIES_MEOWSTIC_FEMALE,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_TRICK_ROOM, MOVE_BULLDOZE, MOVE_WILL_O_WISP, MOVE_HELPING_HAND
    } /* Verdant custom: Mossdeep City Gym — Verdant hand-authored competitive core */,
    {
    .lvl = -2,
    .species = SPECIES_RHYPERIOR,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_ROCK_SLIDE, MOVE_HIGH_HORSEPOWER, MOVE_HEAVY_SLAM, MOVE_PROTECT
    } /* Verdant custom: Mossdeep City Gym — Verdant hand-authored competitive core */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_QUIET,
    .moves = MOVE_HYPER_VOICE, MOVE_DRACO_METEOR, MOVE_FLAMETHROWER, MOVE_PROTECT
    } /* Verdant custom: Mossdeep City Gym — Verdant hand-authored competitive core */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_COSMIC_POWER, MOVE_PSYCHIC, MOVE_TELEPORT, MOVE_PROTECT
    } /* Verdant custom: Mossdeep City Gym — Verdant explicit team design */,
    {
    .lvl = -2,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PSYCHIC, MOVE_FIRE_BLAST, MOVE_THUNDERBOLT, MOVE_EXPLOSION
    } /* Verdant custom: Mossdeep City Gym — Verdant custom: Mossdeep City Gym / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_PROTECT, MOVE_SUNSTEEL_STRIKE, MOVE_DRAGON_DANCE, MOVE_PHOTON_GEYSER
    } /* Verdant custom: Mossdeep City Space Center 1 F — Verdant custom: Mossdeep City Space Center 1 F / Sun offense */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_THUNDER_WAVE, MOVE_DAZZLING_GLEAM, MOVE_REFLECT, MOVE_LIGHT_SCREEN
    } /* Verdant custom: Mossdeep City Space Center 1 F — Verdant custom: Mossdeep City Space Center 1 F / Balanced disruption */
};
    ...
    },
{
    ...
    } /* Verdant custom: Mossdeep City Space Center 1 F — Verdant custom: Mossdeep City Space Center 1 F / Sand and spread */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HIDDEN_POWER, MOVE_PSYSHOCK, MOVE_RECOVER, MOVE_TRICK_ROOM
    } /* Verdant custom: Mossdeep City Space Center 2 F — Verdant custom: Mossdeep City Space Center 2 F / Balanced disruption */
};
    ...
    },
{
    ...
    } /* Verdant custom: Mossdeep City Space Center 2 F — Verdant custom: Mossdeep City Space Center 2 F / Sand and spread */,
    {
    .lvl = -1,
    .species = SPECIES_DURANT,
    .heldItem = ITEM_OCCA_BERRY,
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ROCK_SLIDE, MOVE_IRON_HEAD, MOVE_X_SCISSOR, MOVE_HONE_CLAWS
    } /* Verdant custom: Mossdeep City Space Center 2 F — Verdant custom: Mossdeep City Space Center 2 F / Sand and spread */
};
    ...
    },
{
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ICY_WIND, MOVE_PSYSHOCK, MOVE_THUNDER_WAVE, MOVE_PROTECT
    } /* Verdant custom: Mossdeep City Space Center 2 F — Verdant explicit team design */,
    {
    .lvl = 1,
    .species = SPECIES_HEATRAN,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_ERUPTION, MOVE_EARTH_POWER, MOVE_PROTECT, MOVE_MAGMA_STORM
    } /* Verdant custom: Mossdeep City Space Center 2 F — Verdant explicit team design */,
    {
    .lvl = 1,
    .species = SPECIES_MALAMAR,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SUPERPOWER, MOVE_KNOCK_OFF, MOVE_PROTECT, MOVE_ZEN_HEADBUTT
    } /* Verdant custom: Mossdeep City Space Center 2 F — Verdant hand-authored competitive core */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FLARE_BLITZ, MOVE_SUNSTEEL_STRIKE, MOVE_CLOSE_COMBAT, MOVE_PSYCHIC_FANGS
    } /* Verdant custom: Mossdeep City Space Center 2 F — Verdant explicit team design */,
    {
    .lvl = 1,
    .species = SPECIES_HEATRAN,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FIRE_BLAST, MOVE_QUIVER_DANCE, MOVE_GIGA_DRAIN, MOVE_ROOST
    } /* Verdant custom: Mossdeep City Space Center 2 F — Verdant explicit team design */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_EXTREME_SPEED, MOVE_STEALTH_ROCK, MOVE_THUNDERBOLT, MOVE_SPIKES
    } /* Verdant custom: Mossdeep City Space Center 2 F — Verdant explicit team design */
};
    ...
    },
{
    ...
    } /* Verdant custom: Seafloor Cavern Room 1 — Verdant custom: Seafloor Cavern Room 1 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_SHELL_SIDE_ARM, MOVE_FIRE_BLAST, MOVE_TRICK_ROOM, MOVE_PROTECT
    } /* Verdant custom: Seafloor Cavern Room 1 — Verdant custom: Seafloor Cavern Room 1 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PROTECT, MOVE_KNOCK_OFF, MOVE_AURA_WHEEL, MOVE_VOLT_SWITCH
    } /* Verdant custom: Seafloor Cavern Room 4 — Verdant custom: Seafloor Cavern Room 4 / Balanced disruption */
};
    ...
    },
{
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_KNOCK_OFF, MOVE_TOXIC_SPIKES, MOVE_GUNK_SHOT, MOVE_FIRE_BLAST
    } /* Verdant custom: Seafloor Cavern Room 3 — Verdant custom: Seafloor Cavern Room 3 / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Connie[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYDRO_PUMP, MOVE_PSYCHIC, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CONNIE */,
    {
    .lvl = -1,
    .species = SPECIES_LUMINEON,
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SURF, MOVE_ICE_BEAM, MOVE_TAUNT, MOVE_PROTECT
    } /* Verdant custom: Sootopolis City Gym B 1 F — Verdant custom: Sootopolis City Gym B 1 F / Rain pressure */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_LIQUIDATION, MOVE_PROTECT, MOVE_SHELL_SMASH, MOVE_ROCK_SLIDE
    } /* Verdant custom: Sootopolis City Gym B 1 F — Verdant custom: Sootopolis City Gym B 1 F / Rain pressure */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PROTECT, MOVE_MOONBLAST, MOVE_HYPER_VOICE, MOVE_PSYCHIC
    } /* Verdant custom: Sootopolis City Gym B 1 F — Verdant custom: Sootopolis City Gym B 1 F / Rain pressure */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_GLACIAL_LANCE, MOVE_SWORDS_DANCE, MOVE_TRICK_ROOM, MOVE_HIGH_HORSEPOWER
    } /* Verdant custom: Sootopolis City Gym B 1 F — Verdant custom: Sootopolis City Gym B 1 F / Trick Room control */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_MOONBLAST, MOVE_TAUNT, MOVE_SCALD, MOVE_CALM_MIND
    } /* Verdant custom: Sootopolis City Gym B 1 F — Verdant explicit team design */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SURF, MOVE_PROTECT, MOVE_HELPING_HAND, MOVE_ICY_WIND
    } /* Verdant custom: Sootopolis City Gym B 1 F — Verdant custom: Sootopolis City Gym B 1 F / Rain pressure */
};
...
static const struct TrainerMonItemCustomMoves sParty_Juan1[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PERISH_SONG, MOVE_HELPING_HAND, MOVE_MUDDY_WATER, MOVE_PROTECT
    } /* Verdant doubles: trap lead */,
    {
    .lvl = 0,
    .species = SPECIES_GOTHITELLE,
    .heldItem = ITEM_SITRUS_BERRY,
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_WATER_SPOUT, MOVE_ORIGIN_PULSE, MOVE_THUNDER, MOVE_ICE_BEAM
    } /* Verdant doubles: rare rain nuke */,
    {
    .lvl = 0,
    .species = SPECIES_GASTRODON,
    .heldItem = ITEM_LEFTOVERS,
    ...
    } /* Verdant doubles: Water deterrent */,
    {
    .lvl = 1,
    .species = SPECIES_PALKIA,
    .heldItem = ITEM_ASSAULT_VEST,
...
static const struct TrainerMonItemCustomMoves sParty_Juan2[] = { // singles
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_HYDRO_PUMP, MOVE_HURRICANE, MOVE_DRACO_METEOR, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JUAN_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_JohnAndJay1[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDERBOLT, MOVE_GRASS_KNOT, MOVE_ENCORE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOHN_AND_JAY_1 */,
    {
    .lvl = 3,
    .species = SPECIES_MINUN,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_FAKE_TEARS, MOVE_HELPING_HAND, MOVE_THUNDERBOLT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOHN_AND_JAY_1 */,
    {
    .lvl = 4,
    .species = SPECIES_VOLBEAT,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_TAIL_GLOW, MOVE_BUG_BUZZ, MOVE_ENCORE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOHN_AND_JAY_1 */,
    {
    .lvl = 4,
    .species = SPECIES_ILLUMISE,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_STRUGGLE_BUG, MOVE_DAZZLING_GLEAM, MOVE_WISH, MOVE_HELPING_HAND
    } /* Verdant polish: TRAINER_JOHN_AND_JAY_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_JohnAndJay2[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BUG_BUZZ, MOVE_ACID_SPRAY, MOVE_ENERGY_BALL, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOHN_AND_JAY_2 */,
    {
    .lvl = 3,
    .species = SPECIES_ESCAVALIER,
    .heldItem = ITEM_OCCA_BERRY,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_MEGAHORN, MOVE_IRON_HEAD, MOVE_DRILL_RUN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOHN_AND_JAY_2 */,
    {
    .lvl = 4,
    .species = SPECIES_PLUSLE,
...
static const struct TrainerMonItemCustomMoves sParty_JohnAndJay3[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_TAIL_GLOW, MOVE_BUG_BUZZ, MOVE_ENCORE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOHN_AND_JAY_3 */,
    {
    .lvl = 3,
    .species = SPECIES_ILLUMISE,
    .heldItem = ITEM_LEFTOVERS,
...
static const struct TrainerMonItemCustomMoves sParty_JohnAndJay4[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDERBOLT, MOVE_GRASS_KNOT, MOVE_ENCORE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOHN_AND_JAY_4 */,
    {
    .lvl = 2,
    .species = SPECIES_MINUN,
    .heldItem = ITEM_SITRUS_BERRY,
...
static const struct TrainerMonItemCustomMoves sParty_Nicolas1[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_LEAF_STORM, MOVE_DRAGON_PULSE, MOVE_FLAMETHROWER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_NICOLAS_1 */,
    {
    .lvl = 2,
    .species = SPECIES_DRACOZOLT,
    .heldItem = ITEM_WIDE_LENS,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLUDGE_BOMB, MOVE_DRACO_METEOR, MOVE_FLAMETHROWER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_NICOLAS_1 */,
    {
    .lvl = 4,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DRAGON_DANCE, MOVE_THROAT_CHOP, MOVE_DRAGON_CLAW, MOVE_PROTECT
    } /* Verdant polish: TRAINER_NICOLAS_1 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Nicolas2[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HAZE, MOVE_DRACO_METEOR, MOVE_SLUDGE_BOMB, MOVE_PROTECT
    } /* Verdant polish: TRAINER_NICOLAS_2 */,
    {
    .lvl = 1,
    .species = SPECIES_EXEGGUTOR_ALOLAN,
    .heldItem = ITEM_SITRUS_BERRY,
...
static const struct TrainerMonItemCustomMoves sParty_Nicolas3[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLUDGE_BOMB, MOVE_DRACO_METEOR, MOVE_FLAMETHROWER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_NICOLAS_3 */,
    {
    .lvl = 3,
    .species = SPECIES_DRAGALGE,
    .heldItem = ITEM_BLACK_SLUDGE,
...
static const struct TrainerMonItemCustomMoves sParty_Nicolas4[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_LEAF_STORM, MOVE_DRAGON_PULSE, MOVE_FLAMETHROWER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_NICOLAS_4 */,
    {
    .lvl = 2,
    .species = SPECIES_DRACOZOLT,
    .heldItem = ITEM_WIDE_LENS,
    ...
    },
{
    ...
    } /* Verdant custom: Victory Road 1 F — Verdant explicit team design */
};
...
static const struct TrainerMonItemCustomMoves sParty_Hope[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_STONE_EDGE, MOVE_STEALTH_ROCK, MOVE_SUPERPOWER, MOVE_EARTHQUAKE
    } /* Verdant polish: TRAINER_HOPE */
};
    ...
    },
{
    ...
    } /* Verdant custom: Victory Road B 1 F — Verdant custom: Victory Road B 1 F / Bug swarm utility */
};
    ...
    },
{
    ...
    } /* Verdant custom: Victory Road B 1 F — Verdant explicit team design */
};
...
static const struct TrainerMonItemCustomMoves sParty_Julie[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PSYCHIC, MOVE_SHADOW_BALL, MOVE_AURA_SPHERE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JULIE */,
    {
    .lvl = 0,
    .species = SPECIES_TYRANTRUM,
...
static const struct TrainerMonItemCustomMoves sParty_Owen[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_CLOSE_COMBAT, MOVE_CRUNCH, MOVE_PSYCHIC_FANGS, MOVE_BEHEMOTH_BASH
    } /* Verdant polish: TRAINER_OWEN */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PROTECT, MOVE_BRICK_BREAK, MOVE_IRON_HEAD, MOVE_SUCKER_PUNCH
    } /* Verdant custom: Victory Road B 2 F — Verdant custom: Victory Road B 2 F / Balanced disruption */
};
    ...
    },
{
    ...
    } /* Verdant custom: Victory Road B 2 F — Verdant explicit team design */
};
...
static const struct TrainerMonItemCustomMoves sParty_Vito[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DOUBLE_EDGE, MOVE_BRAVE_BIRD, MOVE_JUMP_KICK, MOVE_TAILWIND
    } /* Verdant polish: TRAINER_VITO */,
    {
    .lvl = -1,
    .species = SPECIES_ELECTIVIRE,
...
static const struct TrainerMonItemCustomMoves sParty_Michelle[] = {
    ...
    } /* Verdant polish: TRAINER_MICHELLE */,
    {
    .lvl = -1,
    .species = SPECIES_MEGANIUM,
    .heldItem = ITEM_LEFTOVERS,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYPER_VOICE, MOVE_PSYSHOCK, MOVE_MYSTICAL_FIRE, MOVE_TRICK_ROOM
    } /* Verdant polish: TRAINER_MICHELLE */
};
    ...
    },
{
    ...
    } /* Verdant custom: Victory Road B 1 F — Verdant custom: Victory Road B 1 F / Balanced disruption */
};
...
static const struct TrainerMonItemCustomMoves sParty_Halle[] = { // with Mitchell
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLUDGE_BOMB, MOVE_DRACO_METEOR, MOVE_NASTY_PLOT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_HALLE */
};
...
static const struct TrainerMonItemCustomMoves sParty_Edgar[] = {
    ...
    .ability = 0,
    .spread = SPREAD_HP_GRASS_TIMID,
    .moves = MOVE_VOLT_SWITCH, MOVE_FLAMETHROWER, MOVE_ELECTROWEB, MOVE_PROTECT
    } /* Verdant polish: TRAINER_EDGAR */
};
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_EXTREME_SPEED, MOVE_DRAGON_ASCENT, MOVE_DRAGON_CLAW, MOVE_PROTECT
    } /* Verdant custom: Victory Road 1 F — Verdant custom: Victory Road 1 F / Tailwind offense */
};
    ...
    },
{
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PROTECT, MOVE_FLASH_CANNON, MOVE_THUNDER_WAVE, MOVE_DRACO_METEOR
    } /* Verdant custom: Victory Road 1 F — Verdant custom: Victory Road 1 F / Normal-rule breaker */
};
    ...
    },
{
    ...
    } /* Verdant custom: SSTidal Corridor | SSTidal Rooms — Verdant custom: SSTidal Corridor | SSTidal Rooms / Normal-rule breaker */,
    {
    .lvl = -2,
    .species = SPECIES_PRIMEAPE,
    .heldItem = ITEM_LUM_BERRY,
    ...
    },
{
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_ICE_BEAM, MOVE_HELPING_HAND, MOVE_WATER_PULSE, MOVE_MUDDY_WATER
    } /* Verdant custom: SSTidal Corridor | SSTidal Rooms — Verdant custom: SSTidal Corridor | SSTidal Rooms / Rain pressure */,
    {
    .lvl = -2,
    .species = SPECIES_RELICANTH,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_DOUBLE_EDGE, MOVE_PROTECT, MOVE_ROCK_SLIDE, MOVE_WATERFALL
    } /* Verdant custom: SSTidal Corridor | SSTidal Rooms — Verdant custom: SSTidal Corridor | SSTidal Rooms / Rain pressure */
};
...
static const struct TrainerMonItemCustomMoves sParty_Colton[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_FAKE_OUT, MOVE_ICY_WIND, MOVE_FOUL_PLAY, MOVE_PARTING_SHOT
    } /* Verdant polish: TRAINER_COLTON */,
    {
    .lvl = 2,
    .species = SPECIES_INCINEROAR,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HYPER_VOICE, MOVE_HELPING_HAND, MOVE_THUNDER_WAVE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_COLTON */,
    {
    .lvl = 3,
    .species = SPECIES_ABSOL,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_KNOCK_OFF, MOVE_PLAY_ROUGH, MOVE_SUCKER_PUNCH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_COLTON */
};
...
static const struct TrainerMonItemCustomMoves sParty_Sidney[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_OBLIVION_WING, MOVE_DARK_PULSE, MOVE_SNARL, MOVE_SUCKER_PUNCH
    } /* Verdant doubles: rare aura anchor */,
    {
    .lvl = 0,
    .species = SPECIES_DARKRAI,
    .heldItem = ITEM_FOCUS_SASH,
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DARK_PULSE, MOVE_HYPNOSIS, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant doubles: speed and sleep */,
    {
    .lvl = 0,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_WICKED_BLOW, MOVE_CLOSE_COMBAT, MOVE_AQUA_JET, MOVE_U_TURN
    } /* Verdant doubles: Protect breaker */,
    {
    .lvl = 1,
    .species = SPECIES_HOOPA_UNBOUND,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HYPERSPACE_FURY, MOVE_ZEN_HEADBUTT, MOVE_GUNK_SHOT, MOVE_PROTECT
    } /* Verdant doubles: rare wallbreaker */,
    {
    .lvl = 2,
    .species = SPECIES_ABSOL,
    .heldItem = ITEM_ABSOLITE,
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_NIGHT_SLASH, MOVE_PLAY_ROUGH, MOVE_SUCKER_PUNCH, MOVE_PROTECT
    } /* Verdant doubles: Mega priority ace */
};
...
static const struct TrainerMonItemCustomMoves sParty_Phoebe[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SLUDGE_BOMB, MOVE_SHADOW_BALL, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant doubles: Mega trap lead */,
    {
    .lvl = 0,
    .species = SPECIES_MARSHADOW,
    .heldItem = ITEM_FOCUS_SASH,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SPECTRAL_THIEF, MOVE_CLOSE_COMBAT, MOVE_SHADOW_SNEAK, MOVE_COACHING
    } /* Verdant doubles: anti-setup lead */,
    {
    .lvl = 0,
    .species = SPECIES_LUNALA,
    .heldItem = ITEM_POWER_HERB,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_MOONGEIST_BEAM, MOVE_METEOR_BEAM, MOVE_WIDE_GUARD, MOVE_TRICK_ROOM
    } /* Verdant doubles: room and spread guard */,
    {
    .lvl = 0,
    .species = SPECIES_GIRATINA,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_SHADOW_FORCE, MOVE_DRAGON_CLAW, MOVE_BULLDOZE, MOVE_PROTECT
    } /* Verdant doubles: rare bulky control */,
    {
    .lvl = 1,
    .species = SPECIES_SHEDINJA,
    .heldItem = ITEM_SAFETY_GOGGLES,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ALLY_SWITCH, MOVE_SHADOW_SNEAK, MOVE_WILL_O_WISP, MOVE_PROTECT
    } /* Verdant doubles: gimmick puzzle */,
    {
    .lvl = 2,
    .species = SPECIES_CALYREX_SHADOW_RIDER,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ASTRAL_BARRAGE, MOVE_PSYCHIC, MOVE_DRAINING_KISS, MOVE_PROTECT
    } /* Verdant doubles: rare spread ace */
};
...
static const struct TrainerMonItemCustomMoves sParty_Glacia[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_AURORA_VEIL, MOVE_BLIZZARD, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant doubles: veil lead */,
    {
    .lvl = 0,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_BLIZZARD, MOVE_DRACO_METEOR, MOVE_EARTH_POWER, MOVE_PROTECT
    } /* Verdant doubles: rare lead cannon */,
    {
    .lvl = 0,
    .species = SPECIES_FROSLASS,
    .heldItem = ITEM_FOCUS_SASH,
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ICY_WIND, MOVE_WILL_O_WISP, MOVE_TAUNT, MOVE_DESTINY_BOND
    } /* Verdant doubles: tempo disruptor */,
    {
    .lvl = 0,
    .species = SPECIES_ARTICUNO,
    .heldItem = ITEM_LEFTOVERS,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_FREEZE_DRY, MOVE_HURRICANE, MOVE_TAILWIND, MOVE_ROOST
    } /* Verdant doubles: rare fast-mode setter */,
    {
    .lvl = 1,
    .species = SPECIES_GLASTRIER,
    .heldItem = ITEM_ASSAULT_VEST,
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_ICICLE_CRASH, MOVE_HIGH_HORSEPOWER, MOVE_CLOSE_COMBAT, MOVE_HEAVY_SLAM
    } /* Verdant doubles: rare slow-mode sweeper */,
    {
    .lvl = 2,
    .species = SPECIES_ABOMASNOW,
    .heldItem = ITEM_ABOMASITE,
    ...
    } /* Verdant doubles: Mega weather ace */
};
...
static const struct TrainerMonItemCustomMoves sParty_Drake[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DRACO_METEOR, MOVE_FLASH_CANNON, MOVE_FIRE_BLAST, MOVE_THUNDER
    } /* Verdant doubles: rare lead tank */,
    {
    .lvl = 0,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_THOUSAND_ARROWS, MOVE_COIL, MOVE_REST, MOVE_SLEEP_TALK
    } /* Verdant doubles: endurance check */,
    {
    .lvl = 0,
    .species = SPECIES_RESHIRAM,
    .heldItem = ITEM_CHOICE_SCARF,
    ...
    } /* Verdant doubles: setup snowball */,
    {
    .lvl = 1,
    .species = SPECIES_RAYQUAZA,
    .heldItem = ITEM_WHITE_HERB,
    ...
    } /* Verdant doubles: priority breaker */,
    {
    .lvl = 2,
    .species = SPECIES_SALAMENCE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DOUBLE_EDGE, MOVE_EARTHQUAKE, MOVE_ROOST, MOVE_DRAGON_DANCE
    } /* Verdant doubles: Mega ace */
};
...
static const struct TrainerMonItemCustomMoves sParty_Wallace[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_WATER_SPOUT, MOVE_ORIGIN_PULSE, MOVE_THUNDER, MOVE_ICE_BEAM
    } /* Verdant doubles: rare lead nuke */,
    {
    .lvl = 0,
    .species = SPECIES_ZAPDOS,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HURRICANE, MOVE_THUNDER, MOVE_TAILWIND, MOVE_ROOST
    } /* Verdant doubles: lead speed control */,
    {
    .lvl = 0,
    .species = SPECIES_FERROTHORN,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_MUDDY_WATER, MOVE_MOONBLAST, MOVE_ICE_BEAM, MOVE_RECOVER
    } /* Verdant doubles: Mega champion ace */
};
...
static const struct TrainerMonItemCustomMoves sParty_Anabel[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_BODY_SLAM, MOVE_HIGH_HORSEPOWER, MOVE_YAWN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_ANABEL */,
    {
    .lvl = 5,
    .species = SPECIES_RAIKOU,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_CALM_MIND, MOVE_THUNDERBOLT, MOVE_HIDDEN_POWER, MOVE_EXTRASENSORY
    } /* Verdant polish: TRAINER_ANABEL */,
    {
    .lvl = 5,
    .species = SPECIES_ENTEI,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SACRED_FIRE, MOVE_STOMPING_TANTRUM, MOVE_FLARE_BLITZ, MOVE_PROTECT
    } /* Verdant polish: TRAINER_ANABEL */,
    {
    .lvl = 5,
    .species = SPECIES_SUICUNE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PROTECT, MOVE_ICE_BEAM, MOVE_TAILWIND, MOVE_SCALD
    } /* Verdant polish: TRAINER_ANABEL */,
    {
    .lvl = 5,
    .species = SPECIES_LATIAS,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DRAGON_PULSE, MOVE_PROTECT, MOVE_AURA_SPHERE, MOVE_MIST_BALL
    } /* Verdant polish: TRAINER_ANABEL */,
    {
    .lvl = 5,
    .species = SPECIES_CRESSELIA,
...
static const struct TrainerMonItemCustomMoves sParty_Tucker[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_DRACO_METEOR, MOVE_TAILWIND, MOVE_PROTECT, MOVE_PSYSHOCK
    } /* Verdant polish: TRAINER_TUCKER */,
    {
    .lvl = 5,
    .species = SPECIES_ARTICUNO,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SCORCHING_SANDS, MOVE_PROTECT, MOVE_HURRICANE, MOVE_HEAT_WAVE
    } /* Verdant polish: TRAINER_TUCKER */,
    {
    .lvl = 5,
    .species = SPECIES_SALAMENCE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_DRACO_METEOR, MOVE_EARTHQUAKE, MOVE_ROOST, MOVE_OUTRAGE
    } /* Verdant polish: TRAINER_TUCKER */,
    {
    .lvl = 5,
    .species = SPECIES_KYUREM,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ICE_BEAM, MOVE_EARTH_POWER, MOVE_DRAGON_PULSE, MOVE_FOCUS_BLAST
    } /* Verdant polish: TRAINER_TUCKER */
};
...
static const struct TrainerMonItemCustomMoves sParty_Spenser[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_STRANGE_STEAM, MOVE_SLUDGE_BOMB, MOVE_TAUNT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SPENSER */,
    {
    .lvl = 5,
    .species = SPECIES_SLAKING,
    .heldItem = ITEM_CHOICE_BAND,
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HIGH_HORSEPOWER, MOVE_KNOCK_OFF, MOVE_GIGA_IMPACT, MOVE_DOUBLE_EDGE
    } /* Verdant polish: TRAINER_SPENSER */,
    {
    .lvl = 5,
    .species = SPECIES_REGIGIGAS,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SUBSTITUTE, MOVE_RETURN, MOVE_WIDE_GUARD, MOVE_ROCK_SLIDE
    } /* Verdant polish: TRAINER_SPENSER */,
    {
    .lvl = 5,
    .species = SPECIES_WEEZING,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_PROTECT, MOVE_SLUDGE_BOMB, MOVE_TOXIC, MOVE_EXPLOSION
    } /* Verdant polish: TRAINER_SPENSER */,
    {
    .lvl = 5,
    .species = SPECIES_ORANGURU,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_PSYCHIC, MOVE_INSTRUCT, MOVE_PROTECT, MOVE_FOCUS_BLAST
    } /* Verdant polish: TRAINER_SPENSER */,
    {
    .lvl = 5,
    .species = SPECIES_COFAGRIGUS,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_TRICK_ROOM, MOVE_BODY_PRESS, MOVE_SHADOW_BALL, MOVE_WILL_O_WISP
    } /* Verdant polish: TRAINER_SPENSER */
};
...
static const struct TrainerMonItemCustomMoves sParty_Greta[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CLOSE_COMBAT, MOVE_STONE_EDGE, MOVE_SWORDS_DANCE, MOVE_SUBSTITUTE
    } /* Verdant polish: TRAINER_GRETA */,
    {
    .lvl = 5,
    .species = SPECIES_COBALION,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_IRON_HEAD, MOVE_THUNDER_WAVE, MOVE_SUBSTITUTE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GRETA */,
    {
    .lvl = 5,
    .species = SPECIES_BUZZWOLE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SPECTRAL_THIEF, MOVE_SHADOW_SNEAK, MOVE_PROTECT, MOVE_CLOSE_COMBAT
    } /* Verdant polish: TRAINER_GRETA */
};
...
static const struct TrainerMonItemCustomMoves sParty_Noland[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_METEOR_MASH, MOVE_ZEN_HEADBUTT, MOVE_BULLET_PUNCH, MOVE_STOMPING_TANTRUM
    } /* Verdant polish: TRAINER_NOLAND */,
    {
    .lvl = 5,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HIDDEN_POWER, MOVE_ICE_BEAM, MOVE_TRI_ATTACK, MOVE_NASTY_PLOT
    } /* Verdant polish: TRAINER_NOLAND */,
    {
    .lvl = 5,
    .species = SPECIES_ROTOM,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ELECTROWEB, MOVE_THUNDERBOLT, MOVE_PROTECT, MOVE_SHADOW_BALL
    } /* Verdant polish: TRAINER_NOLAND */,
    {
    .lvl = 5,
    .species = SPECIES_DARKRAI,
...
static const struct TrainerMonItemCustomMoves sParty_Lucy[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPEED_JOLLY,
    .moves = MOVE_TAILWIND, MOVE_SUPER_FANG, MOVE_TAUNT, MOVE_ROOST
    } /* Verdant polish: TRAINER_LUCY */,
    {
    .lvl = 5,
    .species = SPECIES_SEVIPER,
    .heldItem = ITEM_SITRUS_BERRY,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ENCORE, MOVE_FAKE_OUT, MOVE_SLUDGE_BOMB, MOVE_HEAT_WAVE
    } /* Verdant polish: TRAINER_LUCY */,
    {
    .lvl = 5,
    .species = SPECIES_MILOTIC,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SCALD, MOVE_ICY_WIND, MOVE_PROTECT, MOVE_DRAGON_TAIL
    } /* Verdant polish: TRAINER_LUCY */,
    {
    .lvl = 5,
    .species = SPECIES_STEELIX,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_PROTECT, MOVE_STEALTH_ROCK, MOVE_EARTHQUAKE, MOVE_HEAVY_SLAM
    } /* Verdant polish: TRAINER_LUCY */
};
...
static const struct TrainerMonItemCustomMoves sParty_Brandon[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_CRUSH_GRIP, MOVE_HIGH_HORSEPOWER, MOVE_DRAIN_PUNCH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BRANDON */,
    {
    .lvl = 5,
    .species = SPECIES_REGIROCK,
    .heldItem = ITEM_CHESTO_BERRY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_THUNDERBOLT, MOVE_ICE_BEAM, MOVE_PROTECT, MOVE_THUNDER_WAVE
    } /* Verdant polish: TRAINER_BRANDON */,
    {
    .lvl = 5,
...
static const struct TrainerMonItemCustomMoves sParty_Red[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_0_EV,
    .moves = MOVE_FLAMETHROWER, MOVE_DRAGON_PULSE, MOVE_SLASH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_RED */
};
...
static const struct TrainerMonItemCustomMoves sParty_BrendanLinkPlaceholder[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_PROTECT, MOVE_FIRE_PUNCH, MOVE_SWORDS_DANCE, MOVE_PRECIPICE_BLADES
    } /* Verdant polish: TRAINER_BRENDAN_PLACEHOLDER */
};
...
static const struct TrainerMonItemCustomMoves sParty_MayLinkPlaceholder[] = {
    ...
    } /* Verdant polish: TRAINER_MAY_PLACEHOLDER */
};
...
static const struct TrainerMonItemCustomMoves sParty_LucyLavaridge[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDER, MOVE_BUG_BUZZ, MOVE_ENERGY_BALL, MOVE_STICKY_WEB
    } /* Verdant polish: TRAINER_LUCY_LAVARIDGE */,
    {
    .lvl = 2,
    .species = SPECIES_AMBIPOM,
    .heldItem = ITEM_NORMAL_GEM,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_MOONBLAST, MOVE_DAZZLING_GLEAM, MOVE_FLAMETHROWER, MOVE_THUNDERBOLT
    } /* Verdant polish: TRAINER_LUCY_LAVARIDGE */,
    {
    .lvl = 4,
    .species = SPECIES_ABSOL,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SUCKER_PUNCH, MOVE_KNOCK_OFF, MOVE_PLAY_ROUGH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_LUCY_LAVARIDGE */
};
...
static const struct TrainerMonItemCustomMoves sParty_GretaSlateport[] = {
    ...
    } /* Verdant polish: TRAINER_GRETA_SLATEPORT */,
    {
    .lvl = 0,
    .species = SPECIES_BRELOOM,
    .heldItem = ITEM_TOXIC_ORB,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_VOLT_SWITCH, MOVE_DAZZLING_GLEAM, MOVE_ELECTROWEB, MOVE_GRASS_KNOT
    } /* Verdant polish: TRAINER_GRETA_SLATEPORT */
};
...
static const struct TrainerMonItemCustomMoves sParty_Buffel[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_AIR_SLASH, MOVE_TAILWIND, MOVE_THUNDER_WAVE, MOVE_ROOST
    } /* Verdant polish: TRAINER_BUFFEL */,
    {
    .lvl = 0,
    .species = SPECIES_GARDEVOIR,
...
static const struct TrainerMonItemCustomMoves sParty_Sidney3[] = { // legendaries
    ...
    } /* Verdant polish: TRAINER_SIDNEY_3 */,
    {
    .lvl = 1,
    .species = SPECIES_DARKRAI,
    .heldItem = ITEM_WIDE_LENS,
...
static const struct TrainerMonItemCustomMoves sParty_Cynthia2[] = {
    ...
    } /* Verdant polish: TRAINER_CYNTHIA_2 */,
    {
    .lvl = 5,
    .species = SPECIES_ROSERADE,
    .heldItem = ITEM_CHOICE_SCARF,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_EARTHQUAKE, MOVE_DRAGON_CLAW, MOVE_SCALE_SHOT, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CYNTHIA_2 */
};
...
static const struct TrainerMonItemCustomMoves sParty_LeafAlteringCave[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_SPEED_TIMID,
    .moves = MOVE_FLAMETHROWER, MOVE_WILL_O_WISP, MOVE_CALM_MIND, MOVE_DRAINING_KISS
    } /* Verdant polish: TRAINER_LEAF_ALTERING_CAVE */,
    {
    .lvl = 5,
    .species = SPECIES_KANGASKHAN,
    .heldItem = ITEM_KANGASKHANITE,
...
static const struct TrainerMonItemCustomMoves sParty_Bernie5[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SURF, MOVE_DRACO_METEOR, MOVE_WILL_O_WISP, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BERNIE_5 */,
    {
    .lvl = 0,
    .species = SPECIES_COALOSSAL,
    .heldItem = ITEM_WEAKNESS_POLICY,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HEAT_WAVE, MOVE_ROCK_SLIDE, MOVE_SOLAR_BEAM, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BERNIE_5 */,
    {
    .lvl = 1,
    .species = SPECIES_TORKOAL,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_HEAT_WAVE, MOVE_BODY_PRESS, MOVE_YAWN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BERNIE_5 */,
    {
    .lvl = 1,
    .species = SPECIES_LILLIGANT,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HEAT_WAVE, MOVE_BUG_BUZZ, MOVE_RAGE_POWDER, MOVE_PROTECT
    } /* Verdant polish: TRAINER_BERNIE_5 */,
    {
    .lvl = 2,
    .species = SPECIES_VICTINI,
...
static const struct TrainerMonItemCustomMoves sParty_Nob5[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CLOSE_COMBAT, MOVE_ACROBATICS, MOVE_ROCK_SLIDE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_NOB_5 */,
    {
    .lvl = 2,
    .species = SPECIES_URSHIFU_RAPID_STRIKE_STYLE,
...
static const struct TrainerMonItemCustomMoves sParty_Cyndy5[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_FOLLOW_ME, MOVE_HELPING_HAND, MOVE_EXPANDING_FORCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CYNDY_5 */,
    {
    .lvl = 0,
    .species = SPECIES_KOMMO_O,
    .heldItem = ITEM_THROAT_SPRAY,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_MODEST,
    .moves = MOVE_SHELL_SMASH, MOVE_HYDRO_PUMP, MOVE_SECRET_SWORD, MOVE_ICE_BEAM
    } /* Verdant polish: TRAINER_CYNDY_5 */,
    {
    .lvl = 1,
    .species = SPECIES_WHIMSICOTT,
...
static const struct TrainerMonItemCustomMoves sParty_Timothy5[] = {
    ...
    .spread = SPREAD_31_IV_HP_DEF_SPDEF_SASSY,
    .moves = MOVE_TRICK_ROOM, MOVE_BULLDOZE, MOVE_WILL_O_WISP, MOVE_HELPING_HAND
    } /* Verdant polish: TRAINER_TIMOTHY_5 */,
    {
    .lvl = 0,
    .species = SPECIES_RHYPERIOR,
    .heldItem = ITEM_WEAKNESS_POLICY,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_BRAVE,
    .moves = MOVE_HEAT_CRASH, MOVE_CLOSE_COMBAT, MOVE_HEAD_SMASH, MOVE_PROTECT
    } /* Verdant polish: TRAINER_TIMOTHY_5 */,
    {
    .lvl = 2,
    .species = SPECIES_CALYREX_ICE_RIDER,
...
static const struct TrainerMonItemCustomMoves sParty_Sawyer5[] = {
    ...
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_ROCK_SLIDE, MOVE_CRUNCH, MOVE_LOW_KICK, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SAWYER_5 */,
    {
    .lvl = 0,
    .species = SPECIES_EXCADRILL,
    .heldItem = ITEM_EXCADRITE,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FUSION_BOLT, MOVE_ICICLE_SPEAR, MOVE_DRAGON_CLAW, MOVE_PROTECT
    } /* Verdant polish: TRAINER_SAWYER_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Shelby5[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FAKE_OUT, MOVE_CLOSE_COMBAT, MOVE_KNOCK_OFF, MOVE_STONE_EDGE
    } /* Verdant polish: TRAINER_SHELBY_5 */,
    {
    .lvl = 2,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_MEDICHAMITE,
...
static const struct TrainerMonItemCustomMoves sParty_Diana5[] = {
    ...
    } /* Verdant polish: TRAINER_DIANA_5 */,
    {
    .lvl = 1,
    .species = SPECIES_VOLCARONA,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_GIGA_DRAIN, MOVE_EARTH_POWER, MOVE_DAZZLING_GLEAM, MOVE_SYNTHESIS
    } /* Verdant polish: TRAINER_DIANA_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Ethan5[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_HONE_CLAWS, MOVE_BRAVE_BIRD, MOVE_DOUBLE_EDGE, MOVE_SUPERPOWER
    } /* Verdant polish: TRAINER_ETHAN_5 */,
    {
    .lvl = 1,
    .species = SPECIES_SANDSLASH,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Andres5[] = {
    ...
    } /* Verdant polish: TRAINER_ANDRES_5 */,
    {
    .lvl = 1,
    .species = SPECIES_DRACOZOLT,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BOLT_BEAK, MOVE_DRAGON_CLAW, MOVE_FIRE_FANG, MOVE_EARTHQUAKE
    } /* Verdant polish: TRAINER_ANDRES_5 */,
    {
    .lvl = 2,
    .species = SPECIES_EXCADRILL,
...
static const struct TrainerMonItemCustomMoves sParty_Nicolas5[] = {
    ...
    } /* Verdant polish: TRAINER_NICOLAS_5 */,
    {
    .lvl = 1,
    .species = SPECIES_REGIDRAGO,
    .heldItem = ITEM_DRAGON_FANG,
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_ADAMANT,
    .moves = MOVE_DRAGON_CLAW, MOVE_EXTREME_SPEED, MOVE_EARTHQUAKE, MOVE_FIRE_PUNCH
    } /* Verdant polish: TRAINER_NICOLAS_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_JohnAndJay5[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_FOLLOW_ME, MOVE_HELPING_HAND, MOVE_EXPANDING_FORCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JOHN_AND_JAY_5 */,
    {
    .lvl = 0,
    .species = SPECIES_MEDICHAM,
    .heldItem = ITEM_MEDICHAMITE,
...
static const struct TrainerMonItemCustomMoves sParty_Katelyn5[] = {
    ...
    } /* Verdant polish: TRAINER_KATELYN_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Isaiah5[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYDRO_PUMP, MOVE_PSYSHOCK, MOVE_THUNDERBOLT, MOVE_ICE_BEAM
    } /* Verdant polish: TRAINER_ISAIAH_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Koji5[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_CLANGING_SCALES, MOVE_CLANGOROUS_SOUL, MOVE_AURA_SPHERE, MOVE_FLAMETHROWER
    } /* Verdant polish: TRAINER_KOJI_5 */,
    {
    .lvl = 1,
    .species = SPECIES_MARSHADOW,
    .heldItem = ITEM_LIFE_ORB,
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CLOSE_COMBAT, MOVE_ACROBATICS, MOVE_ROCK_SLIDE, MOVE_SWORDS_DANCE
    } /* Verdant polish: TRAINER_KOJI_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Pablo5[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_WATER_SPOUT, MOVE_ORIGIN_PULSE, MOVE_THUNDER, MOVE_ICE_BEAM
    } /* Verdant polish: TRAINER_PABLO_5 */,
    {
    .lvl = 1,
    .species = SPECIES_BARRASKEWDA,
    .heldItem = ITEM_LIFE_ORB,
...
static const struct TrainerMonItemCustomMoves sParty_Ernest5[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_RAIN_DANCE, MOVE_THUNDER, MOVE_HURRICANE, MOVE_FOCUS_BLAST
    } /* Verdant polish: TRAINER_ERNEST_5 */,
    {
    .lvl = 1,
    .species = SPECIES_URSHIFU_RAPID_STRIKE_STYLE,
    .heldItem = ITEM_CHOICE_BAND,
...
static const struct TrainerMonItemCustomMoves sParty_Jenny5[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HYPER_VOICE, MOVE_MOONBLAST, MOVE_ICE_BEAM, MOVE_ENERGY_BALL
    } /* Verdant polish: TRAINER_JENNY_5 */,
    {
    .lvl = 1,
    .species = SPECIES_MANAPHY,
    .heldItem = ITEM_LEFTOVERS,
...
static const struct TrainerMonItemCustomMoves sParty_LilaAndRoy5[] = {
    ...
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_TAILWIND, MOVE_HURRICANE, MOVE_SCALD, MOVE_PROTECT
    } /* Verdant polish: TRAINER_LILA_AND_ROY_5 */,
    {
    .lvl = 0,
    .species = SPECIES_LANTURN,
    .heldItem = ITEM_ASSAULT_VEST,
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_DISCHARGE, MOVE_SCALD, MOVE_ICY_WIND, MOVE_DAZZLING_GLEAM
    } /* Verdant polish: TRAINER_LILA_AND_ROY_5 */,
    {
    .lvl = 1,
    .species = SPECIES_SWAMPERT,
...
static const struct TrainerMonItemCustomMoves sParty_Cameron5[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_ROCK_POLISH, MOVE_ROCK_SLIDE, MOVE_ZEN_HEADBUTT, MOVE_FLARE_BLITZ
    } /* Verdant polish: TRAINER_CAMERON_5 */,
    {
    .lvl = 2,
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_ALAKAZITE,
...
static const struct TrainerMonItemCustomMoves sParty_Jacki5[] = {
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_METEOR_BEAM, MOVE_PSYCHIC, MOVE_MOONBLAST, MOVE_EARTH_POWER
    } /* Verdant polish: TRAINER_JACKI_5 */,
    {
    .lvl = 2,
    .species = SPECIES_ALAKAZAM,
    .heldItem = ITEM_ALAKAZITE,
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_PSYSHOCK, MOVE_FOCUS_BLAST, MOVE_SHADOW_BALL, MOVE_DAZZLING_GLEAM
    } /* Verdant polish: TRAINER_JACKI_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Fernando5[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_OVERDRIVE, MOVE_BOOMBURST, MOVE_SLUDGE_WAVE, MOVE_VOLT_SWITCH
    } /* Verdant polish: TRAINER_FERNANDO_5 */,
    {
    .lvl = 1,
    .species = SPECIES_REGIELEKI,
    .heldItem = ITEM_FOCUS_SASH,
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDERBOLT, MOVE_ELECTROWEB, MOVE_VOLT_SWITCH, MOVE_RAPID_SPIN
    } /* Verdant polish: TRAINER_FERNANDO_5 */,
    {
    .lvl = 2,
    .species = SPECIES_RAICHU,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_FAKE_OUT, MOVE_VOLT_TACKLE, MOVE_EXTREME_SPEED, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_FERNANDO_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Gabrielle5[] = {
    ...
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_HYPER_VOICE, MOVE_MOONBLAST, MOVE_ICY_WIND, MOVE_PROTECT
    } /* Verdant polish: TRAINER_GABRIELLE_5 */,
    {
    .lvl = 0,
    .species = SPECIES_TOXTRICITY,
    .heldItem = ITEM_CHOICE_SPECS,
...
static const struct TrainerMonItemCustomMoves sParty_Cristin5[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_SUPERPOWER, MOVE_SUCKER_PUNCH, MOVE_TEETER_DANCE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_CRISTIN_5 */,
    {
    .lvl = 1,
    .species = SPECIES_EXPLOUD,
    .heldItem = ITEM_CHOICE_SPECS,
...
static const struct TrainerMonItemCustomMoves sParty_Walter5[] = {
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BELLY_DRUM, MOVE_EXTREME_SPEED, MOVE_THROAT_CHOP, MOVE_SEED_BOMB
    } /* Verdant polish: TRAINER_WALTER_5 */,
    {
    .lvl = 1,
    .species = SPECIES_GOLDUCK,
    .heldItem = ITEM_LIFE_ORB,
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYDRO_PUMP, MOVE_ICE_BEAM, MOVE_PSYSHOCK, MOVE_FOCUS_BLAST
    } /* Verdant polish: TRAINER_WALTER_5 */,
    {
    .lvl = 2,
    .species = SPECIES_MANECTRIC,
...
static const struct TrainerMonItemCustomMoves sParty_Jeffrey5[] = {
    ...
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_STICKY_WEB, MOVE_TAILWIND, MOVE_POLLEN_PUFF, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JEFFREY_5 */,
    {
    .lvl = 0,
    .species = SPECIES_ARAQUANID,
    .heldItem = ITEM_SITRUS_BERRY,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HEAT_WAVE, MOVE_BUG_BUZZ, MOVE_GIGA_DRAIN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JEFFREY_5 */,
    {
    .lvl = 1,
    .species = SPECIES_GOLISOPOD,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_ICY_WIND, MOVE_HURRICANE, MOVE_BUG_BUZZ, MOVE_PROTECT
    } /* Verdant polish: TRAINER_JEFFREY_5 */,
    {
    .lvl = 2,
    .species = SPECIES_GENESECT,
...
static const struct TrainerMonItemCustomMoves sParty_Robert5[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_TAILWIND, MOVE_PSYCHIC, MOVE_HEAT_WAVE, MOVE_ROOST
    } /* Verdant polish: TRAINER_ROBERT_5 */,
    {
    .lvl = 2,
    .species = SPECIES_ALTARIA,
    .heldItem = ITEM_ALTARIANITE,
...
static const struct TrainerMonItemCustomMoves sParty_Jackson5[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_ATK_ADAMANT,
    .moves = MOVE_FAKE_OUT, MOVE_SHADOW_SNEAK, MOVE_DRAIN_PUNCH, MOVE_KNOCK_OFF
    } /* Verdant polish: TRAINER_JACKSON_5 */,
    {
    .lvl = 2,
    .species = SPECIES_SCEPTILE,
    .heldItem = ITEM_SCEPTILITE,
    .ability = 1,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_LEAF_STORM, MOVE_DRAGON_PULSE, MOVE_FOCUS_BLAST, MOVE_HIDDEN_POWER
    } /* Verdant polish: TRAINER_JACKSON_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Catherine5[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_SEED_FLARE, MOVE_AIR_SLASH, MOVE_EARTH_POWER, MOVE_PSYCHIC
    } /* Verdant polish: TRAINER_CATHERINE_5 */,
    {
    .lvl = 2,
    .species = SPECIES_VENUSAUR,
    .heldItem = ITEM_VENUSAURITE,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPATK_MODEST,
    .moves = MOVE_GIGA_DRAIN, MOVE_SLUDGE_BOMB, MOVE_EARTH_POWER, MOVE_SYNTHESIS
    } /* Verdant polish: TRAINER_CATHERINE_5 */
};
...
static const struct TrainerMonItemCustomMoves sParty_KiraAndDan5[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_TAIL_GLOW, MOVE_BUG_BUZZ, MOVE_THUNDER_WAVE, MOVE_PROTECT
    } /* Verdant polish: TRAINER_KIRA_AND_DAN_5 */,
    {
    .lvl = 0,
    .species = SPECIES_ILLUMISE,
    .heldItem = ITEM_SITRUS_BERRY,
    .ability = 2,
    .spread = SPREAD_31_IV_HP_SPDEF_CALM,
    .moves = MOVE_TAILWIND, MOVE_HELPING_HAND, MOVE_DAZZLING_GLEAM, MOVE_ENCORE
    } /* Verdant polish: TRAINER_KIRA_AND_DAN_5 */,
    {
    .lvl = 1,
    .species = SPECIES_PHEROMOSA,
    ...
    .ability = 0,
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_CLOSE_COMBAT, MOVE_TRIPLE_AXEL, MOVE_U_TURN, MOVE_PROTECT
    } /* Verdant polish: TRAINER_KIRA_AND_DAN_5 */,
    {
    .lvl = 2,
    .species = SPECIES_BUZZWOLE,
...
static const struct TrainerMonItemCustomMoves sParty_Thalia5[] = {
    ...
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_HYDRO_PUMP, MOVE_DRAINING_KISS, MOVE_LOVELY_KISS, MOVE_ICE_BEAM
    } /* Verdant polish: TRAINER_THALIA_5 */,
    {
    .lvl = 1,
    .species = SPECIES_MANAPHY,
    .heldItem = ITEM_LEFTOVERS,
...
static const struct TrainerMonItemCustomMoves sParty_Cory5[] = {
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_SPATK_SPEED_TIMID,
    .moves = MOVE_THUNDER, MOVE_HURRICANE, MOVE_HEAT_WAVE, MOVE_ROOST
    } /* Verdant polish: TRAINER_CORY_5 */,
    {
    .lvl = 2,
    .species = SPECIES_SWAMPERT,
...
static const struct TrainerMonItemCustomMoves sParty_Cindy6[] = { // Unused
    ...
    .spread = SPREAD_31_IV_ATK_SPEED_JOLLY,
    .moves = MOVE_BELLY_DRUM, MOVE_EXTREME_SPEED, MOVE_THROAT_CHOP, MOVE_SEED_BOMB
    } /* Verdant polish: TRAINER_CINDY_6 */
};
...
static const struct TrainerMonItemCustomMoves sParty_Kaylee[] = { // Unused
    ...
    .ability = 2,
    .spread = SPREAD_31_IV_HP_DEF_BOLD,
    .moves = MOVE_SCALD, MOVE_ICE_BEAM, MOVE_HYPNOSIS, MOVE_PERISH_SONG
    } /* Verdant polish: TRAINER_KAYLEE */,
    {
    .lvl = 2,
    .species = SPECIES_DRACOVISH,
    .heldItem = ITEM_CHOICE_SCARF,

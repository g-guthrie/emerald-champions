const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_GRAVELER]	 = {{EVO_TRADE, 0, SPECIES_GOLEM},
                            {EVO_FRIENDSHIP, 0, SPECIES_GOLEM}},
    ...
    [SPECIES_MILCERY]               = {{EVO_ITEM, 0, SPECIES_ALCREMIE},
    ...
    [SPECIES_GRAVELER_ALOLAN]	 = {{EVO_FRIENDSHIP, 0, SPECIES_GOLEM_ALOLAN},
    ...
    [SPECIES_MEGANIUM]   = {{EVO_MEGA_EVOLUTION, ITEM_MEGANIUMITE, SPECIES_MEGANIUM_MEGA}},
    [SPECIES_FERALIGATR] = {{EVO_MEGA_EVOLUTION, ITEM_FERALIGITE, SPECIES_FERALIGATR_MEGA}},
    [SPECIES_EMBOAR]     = {{EVO_MEGA_EVOLUTION, ITEM_EMBOARITE, SPECIES_EMBOAR_MEGA}},
    [SPECIES_RAICHU]     = {{EVO_MEGA_EVOLUTION, ITEM_RAICHUNITE_X, SPECIES_RAICHU_MEGA_X},
                            {EVO_MEGA_EVOLUTION, ITEM_RAICHUNITE_Y, SPECIES_RAICHU_MEGA_Y}},
    [SPECIES_DRAGONITE]  = {{EVO_MEGA_EVOLUTION, ITEM_DRAGONINITE, SPECIES_DRAGONITE_MEGA}},
    [SPECIES_EXCADRILL]  = {{EVO_MEGA_EVOLUTION, ITEM_EXCADRITE, SPECIES_EXCADRILL_MEGA}},
    [SPECIES_MALAMAR]    = {{EVO_MEGA_EVOLUTION, ITEM_MALAMARITE, SPECIES_MALAMAR_MEGA}},
    [SPECIES_CHANDELURE] = {{EVO_MEGA_EVOLUTION, ITEM_CHANDELURITE, SPECIES_CHANDELURE_MEGA}},
    [SPECIES_HAWLUCHA]   = {{EVO_MEGA_EVOLUTION, ITEM_HAWLUCHANITE, SPECIES_HAWLUCHA_MEGA}},
    [SPECIES_GRENINJA]   = {{EVO_MEGA_EVOLUTION, ITEM_GRENINJITE, SPECIES_GRENINJA_MEGA}},
#include "verdant_gen9_evolutions.h"
};

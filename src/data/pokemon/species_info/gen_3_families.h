...
const struct SpeciesInfo gSpeciesInfoGen3[] =
{
    ...
    [SPECIES_TREECKO] =
    {
        ...
        .abilities = { ABILITY_OVERGROW, ABILITY_CHLOROPLAST, ABILITY_UNBURDEN },
...
#define RALTS_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_PSYCHIC)
    ...
    [SPECIES_FEEBAS] =
    {
        ...
        // Contests and Pokeblocks are removed, so Beauty can never be raised; the Prism Scale is the route to MILOTIC.
        .evolutions = EVOLUTION({EVO_TRADE, 0, SPECIES_MILOTIC, CONDITIONS({IF_HOLD_ITEM, ITEM_PRISM_SCALE})},
    ...
    [SPECIES_FROSLASS] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_FAST,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FAIRY, EGG_GROUP_MINERAL),
        .abilities = { ABILITY_SNOW_CLOAK, ABILITY_WHITEOUT, ABILITY_CURSED_BODY },
        .bodyColor = BODY_COLOR_WHITE,

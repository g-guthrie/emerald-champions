...
const struct SpeciesInfo gSpeciesInfoGen8[] =
{
    ...
    [SPECIES_MILCERY] =
    {
        ...
        // Emerald Champions removes acquisition grind: the Leveler advances
        // Milcery into its canonical Vanilla Cream form at the first useful
        // campaign threshold. Cosmetic Sweet/spin combinations remain engine
        // data, but are not required to complete the species family.

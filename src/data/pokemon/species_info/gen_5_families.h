...
const struct SpeciesInfo gSpeciesInfoGen5[] =
{
    ...
    [SPECIES_OSHAWOTT] =
    {
        ...
        .growthRate = GROWTH_MEDIUM_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_FIELD),
        .abilities = { ABILITY_TORRENT, ABILITY_KEEN_EDGE, ABILITY_SHELL_ARMOR },
...
#define COTTONEE_FAMILY_TYPE2 (P_UPDATED_TYPES >= GEN_6 ? TYPE_FAIRY : TYPE_GRASS)
    ...
    [SPECIES_DEINO] =
    {
        ...
        .abilities = { ABILITY_HUSTLE, ABILITY_RAMPAGE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,
        .speciesName = _("Deino"),
        .cryId = CRY_DEINO,
    ...
    [SPECIES_HYDREIGON] =
    {
        ...
        .growthRate = GROWTH_SLOW,
        .eggGroups = MON_EGG_GROUPS(EGG_GROUP_DRAGON),
        .abilities = { ABILITY_LEVITATE, ABILITY_RAMPAGE, ABILITY_NONE },
        .bodyColor = BODY_COLOR_BLUE,

const u32 *const gItemIconTable[][2] =
{
    ...
    [ITEM_LUNAR_WING] = {gItemIcon_LunarWing, gItemIconPalette_LunarWing},
    // TMs / HMs
// TMs / HMs
    [ITEM_TM01_FOCUS_PUNCH]= {gItemIcon_TM, gItemIconPalette_FightingTMHM},
    [ITEM_TM02_DRAGON_CLAW] = {gItemIcon_TM, gItemIconPalette_DragonTMHM},
    [ITEM_TM03_WATER_PULSE] = {gItemIcon_TM, gItemIconPalette_WaterTMHM},
    [ITEM_TM04_CALM_MIND] = {gItemIcon_TM, gItemIconPalette_PsychicTMHM},
    [ITEM_TM05_ROAR] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM06_TOXIC] = {gItemIcon_TM, gItemIconPalette_PoisonTMHM},
    [ITEM_TM07_HAIL] = {gItemIcon_TM, gItemIconPalette_IceTMHM},
    [ITEM_TM08_BULK_UP] = {gItemIcon_TM, gItemIconPalette_FightingTMHM},
    [ITEM_TM09_BULLET_SEED] = {gItemIcon_TM, gItemIconPalette_GrassTMHM},
    [ITEM_TM10_HIDDEN_POWER] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM11_SUNNY_DAY] = {gItemIcon_TM, gItemIconPalette_FireTMHM},
    [ITEM_TM12_TAUNT] = {gItemIcon_TM, gItemIconPalette_DarkTMHM},
    [ITEM_TM13_ICE_BEAM] = {gItemIcon_TM, gItemIconPalette_IceTMHM},
    [ITEM_TM14_BLIZZARD] = {gItemIcon_TM, gItemIconPalette_IceTMHM},
    [ITEM_TM15_HYPER_BEAM] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM16_LIGHT_SCREEN] = {gItemIcon_TM, gItemIconPalette_PsychicTMHM},
    [ITEM_TM17_PROTECT] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM18_RAIN_DANCE] = {gItemIcon_TM, gItemIconPalette_WaterTMHM},
    [ITEM_TM19_GIGA_DRAIN] = {gItemIcon_TM, gItemIconPalette_GrassTMHM},
    [ITEM_TM20_SAFEGUARD] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM21_FRUSTRATION] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM22_SOLARBEAM] = {gItemIcon_TM, gItemIconPalette_GrassTMHM},
    [ITEM_TM23_IRON_TAIL] = {gItemIcon_TM, gItemIconPalette_SteelTMHM},
    [ITEM_TM24_THUNDERBOLT] = {gItemIcon_TM, gItemIconPalette_ElectricTMHM},
    [ITEM_TM25_THUNDER] = {gItemIcon_TM, gItemIconPalette_ElectricTMHM},
    [ITEM_TM26_EARTHQUAKE] = {gItemIcon_TM, gItemIconPalette_GroundTMHM},
    [ITEM_TM27_RETURN] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM28_DIG] = {gItemIcon_TM, gItemIconPalette_GroundTMHM},
    [ITEM_TM29_PSYCHIC] = {gItemIcon_TM, gItemIconPalette_PsychicTMHM},
    [ITEM_TM30_SHADOW_BALL] = {gItemIcon_TM, gItemIconPalette_GhostTMHM},
    [ITEM_TM31_BRICK_BREAK] = {gItemIcon_TM, gItemIconPalette_FightingTMHM},
    [ITEM_TM32_DOUBLE_TEAM] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM33_REFLECT] = {gItemIcon_TM, gItemIconPalette_PsychicTMHM},
    [ITEM_TM34_SLUDGE_WAVE] = {gItemIcon_TM, gItemIconPalette_PoisonTMHM},
    [ITEM_TM35_FLAMETHROWER] = {gItemIcon_TM, gItemIconPalette_FireTMHM},
    [ITEM_TM36_SLUDGE_BOMB] = {gItemIcon_TM, gItemIconPalette_PoisonTMHM},
    [ITEM_TM37_SANDSTORM] = {gItemIcon_TM, gItemIconPalette_RockTMHM},
    [ITEM_TM38_FIRE_BLAST] = {gItemIcon_TM, gItemIconPalette_FireTMHM},
    [ITEM_TM39_ROCK_TOMB] = {gItemIcon_TM, gItemIconPalette_RockTMHM},
    [ITEM_TM40_AERIAL_ACE] = {gItemIcon_TM, gItemIconPalette_FlyingTMHM},
    [ITEM_TM41_TORMENT] = {gItemIcon_TM, gItemIconPalette_DarkTMHM},
    [ITEM_TM42_FACADE] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM43_SECRET_POWER] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM44_REST] = {gItemIcon_TM, gItemIconPalette_PsychicTMHM},
    [ITEM_TM45_ATTRACT] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM46_THIEF] = {gItemIcon_TM, gItemIconPalette_DarkTMHM},
    [ITEM_TM47_STEEL_WING] = {gItemIcon_TM, gItemIconPalette_SteelTMHM},
    [ITEM_TM48_SKILL_SWAP] = {gItemIcon_TM, gItemIconPalette_PsychicTMHM},
    [ITEM_TM49_SLEEP_TALK] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM50_OVERHEAT] = {gItemIcon_TM, gItemIconPalette_FireTMHM},
	[ITEM_TM51_ROOST] = {gItemIcon_TM, gItemIconPalette_FlyingTMHM},
    [ITEM_TM52_FOCUS_BLAST] = {gItemIcon_TM, gItemIconPalette_FightingTMHM},
    [ITEM_TM53_ENERGY_BALL] = {gItemIcon_TM, gItemIconPalette_GrassTMHM},
    [ITEM_TM54_PSYSHOCK] = {gItemIcon_TM, gItemIconPalette_PsychicTMHM},
    [ITEM_TM55_SCALD] = {gItemIcon_TM, gItemIconPalette_WaterTMHM},
    [ITEM_TM56_LEECH_LIFE] = {gItemIcon_TM, gItemIconPalette_BugTMHM},
    [ITEM_TM57_CHARGE_BEAM] = {gItemIcon_TM, gItemIconPalette_ElectricTMHM},
    [ITEM_TM58_ENDURE] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM59_DRAGON_PULSE] = {gItemIcon_TM, gItemIconPalette_DragonTMHM},
    [ITEM_TM60_DRAIN_PUNCH] = {gItemIcon_TM, gItemIconPalette_FightingTMHM},
    [ITEM_TM61_WILL_O_WISP] = {gItemIcon_TM, gItemIconPalette_FireTMHM},
    [ITEM_TM62_ACROBATICS] = {gItemIcon_TM, gItemIconPalette_FlyingTMHM},
    [ITEM_TM63_ROCK_SLIDE] = {gItemIcon_TM, gItemIconPalette_RockTMHM},
    [ITEM_TM64_EXPLOSION] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM65_SHADOW_CLAW] = {gItemIcon_TM, gItemIconPalette_GhostTMHM},
    [ITEM_TM66_PAYBACK] = {gItemIcon_TM, gItemIconPalette_DarkTMHM},
    [ITEM_TM67_RECYCLE] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM68_GIGA_IMPACT] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM69_ROCK_POLISH] = {gItemIcon_TM, gItemIconPalette_RockTMHM},
    [ITEM_TM70_AURORA_VEIL] = {gItemIcon_TM, gItemIconPalette_IceTMHM},
    [ITEM_TM71_STONE_EDGE] = {gItemIcon_TM, gItemIconPalette_RockTMHM},
    [ITEM_TM72_VOLT_SWITCH] = {gItemIcon_TM, gItemIconPalette_ElectricTMHM},
    [ITEM_TM73_THUNDER_WAVE] = {gItemIcon_TM, gItemIconPalette_ElectricTMHM},
    [ITEM_TM74_GYRO_BALL] = {gItemIcon_TM, gItemIconPalette_SteelTMHM},
    [ITEM_TM75_SWORDS_DANCE] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM76_STEALTH_ROCK] = {gItemIcon_TM, gItemIconPalette_RockTMHM},
    [ITEM_TM77_STRUGGLE_BUG] = {gItemIcon_TM, gItemIconPalette_BugTMHM},
    [ITEM_TM78_BULLDOZE] = {gItemIcon_TM, gItemIconPalette_GroundTMHM},
    [ITEM_TM79_FREEZE_DRY] = {gItemIcon_TM, gItemIconPalette_IceTMHM},
    [ITEM_TM80_VENOSHOCK] = {gItemIcon_TM, gItemIconPalette_PoisonTMHM},
    [ITEM_TM81_X_SCISSOR] = {gItemIcon_TM, gItemIconPalette_BugTMHM},
    [ITEM_TM82_DRAGON_TAIL] = {gItemIcon_TM, gItemIconPalette_DragonTMHM},
    [ITEM_TM83_FLAME_CHARGE] = {gItemIcon_TM, gItemIconPalette_FireTMHM},
    [ITEM_TM84_POISON_JAB] = {gItemIcon_TM, gItemIconPalette_PoisonTMHM},
    [ITEM_TM85_DREAM_EATER] = {gItemIcon_TM, gItemIconPalette_PsychicTMHM},
    [ITEM_TM86_GRASS_KNOT] = {gItemIcon_TM, gItemIconPalette_GrassTMHM},
    [ITEM_TM87_SMACK_DOWN] = {gItemIcon_TM, gItemIconPalette_RockTMHM},
    [ITEM_TM88_LOW_SWEEP] = {gItemIcon_TM, gItemIconPalette_FightingTMHM},
    [ITEM_TM89_U_TURN] = {gItemIcon_TM, gItemIconPalette_BugTMHM},
    [ITEM_TM90_SUBSTITUTE] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
	[ITEM_TM91_FLASH_CANNON] = {gItemIcon_TM, gItemIconPalette_SteelTMHM},
    [ITEM_TM92_TRICK_ROOM] = {gItemIcon_TM, gItemIconPalette_PsychicTMHM},
    [ITEM_TM93_WILD_CHARGE] = {gItemIcon_TM, gItemIconPalette_ElectricTMHM},
    [ITEM_TM94_SUCKER_PUNCH] = {gItemIcon_TM, gItemIconPalette_DarkTMHM},
    [ITEM_TM95_SNARL] = {gItemIcon_TM, gItemIconPalette_DarkTMHM},
    [ITEM_TM96_AVALANCHE] = {gItemIcon_TM, gItemIconPalette_IceTMHM},
    [ITEM_TM97_DARK_PULSE] = {gItemIcon_TM, gItemIconPalette_DarkTMHM},
    [ITEM_TM98_FALSE_SWIPE] = {gItemIcon_TM, gItemIconPalette_NormalTMHM},
    [ITEM_TM99_DAZZLING_GLEAM] = {gItemIcon_TM, gItemIconPalette_FairyTMHM},
    [ITEM_TM100_CURSE]  = {gItemIcon_TM, gItemIconPalette_GhostTMHM},
    [ITEM_HM01_CUT] = {gItemIcon_HM, gItemIconPalette_SteelTMHM},
    [ITEM_HM02_FLY] = {gItemIcon_HM, gItemIconPalette_FlyingTMHM},
    [ITEM_HM03_SURF] = {gItemIcon_HM, gItemIconPalette_WaterTMHM},
    [ITEM_HM04_STRENGTH] = {gItemIcon_HM, gItemIconPalette_RockTMHM},
    [ITEM_HM05_FLASH] = {gItemIcon_HM, gItemIconPalette_NormalTMHM},
    [ITEM_HM06_ROCK_SMASH] = {gItemIcon_HM, gItemIconPalette_FightingTMHM},
    [ITEM_HM07_WATERFALL] = {gItemIcon_HM, gItemIconPalette_WaterTMHM},
    [ITEM_HM08_DIVE] = {gItemIcon_HM, gItemIconPalette_WaterTMHM},
    ...
    [ITEM_MILOTICITE] = {gItemIcon_Miloticite, gItemIconPalette_Miloticite},
    ...
    [ITEM_MEGANIUMITE] = {gItemIcon_Meganiumite, gItemIconPalette_Meganiumite},
    [ITEM_FERALIGITE] = {gItemIcon_Feraligite, gItemIconPalette_Feraligite},
    [ITEM_EMBOARITE] = {gItemIcon_Emboarite, gItemIconPalette_Emboarite},
    [ITEM_RAICHUNITE_X] = {gItemIcon_RaichuniteX, gItemIconPalette_RaichuniteX},
    [ITEM_RAICHUNITE_Y] = {gItemIcon_RaichuniteY, gItemIconPalette_RaichuniteY},
    [ITEM_DRAGONINITE] = {gItemIcon_Dragoninite, gItemIconPalette_Dragoninite},
    [ITEM_EXCADRITE] = {gItemIcon_Excadrite, gItemIconPalette_Excadrite},
    [ITEM_MALAMARITE] = {gItemIcon_Malamarite, gItemIconPalette_Malamarite},
    [ITEM_CHANDELURITE] = {gItemIcon_Chandelurite, gItemIconPalette_Chandelurite},
    [ITEM_HAWLUCHANITE] = {gItemIcon_Hawluchanite, gItemIconPalette_Hawluchanite},
    [ITEM_GRENINJITE] = {gItemIcon_Greninjite, gItemIconPalette_Greninjite},
    ...
    [ITEM_LEVELER] = {gItemIcon_RareCandy, gItemIconPalette_RareCandy},
    ...
    [ITEM_CRACKED_POT] = {gItemIcon_CrackedPot, gItemIconPalette_CrackedPot},
    ...
    [ITEM_GALARICA_CUFF] = {gItemIcon_GalaricaCuff, gItemIconPalette_GalaricaCuff},
    [ITEM_GALARICA_WREATH] = {gItemIcon_GalaricaWreath, gItemIconPalette_GalaricaWreath},
    [ITEM_HEAVY_DUTY_BOOTS] = {gItemIcon_HeavyDutyBoots, gItemIconPalette_HeavyDutyBoots},
    [ITEM_ICEROOT_CARROT] = {gItemIcon_IcerootCarrot, gItemIconPalette_IcerootCarrot},

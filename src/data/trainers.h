const struct Trainer gTrainers[] = {
    ...
    [TRAINER_TIANA] =
    {
        ...
        .items = {},
        .doubleBattle = TRUE,
        .aiFlags = AI_FLAG_CHECK_BAD_MOVE | AI_FLAG_TRY_TO_FAINT | AI_FLAG_CHECK_VIABILITY | AI_FLAG_CHECK_FOE | AI_FLAG_SMART_SWITCHING | AI_FLAG_SPEED_CONTROL | AI_FLAG_FIELD_CONTROL,

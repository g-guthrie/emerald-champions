...
static const u8 sCursedBodyDescription[] = _("May disable moves used on it.");
...
static const u8 sMagicianDescription[] = _("Steals a hit target's item.");
...
const u8 gAbilityNames[ABILITIES_COUNT][ABILITY_NAME_LENGTH + 1] =
{
    ...
    [ABILITY_PRIMORDIAL_SEA] = _("Primal Sea"),
    ...
    [ABILITY_ELECTRIC_SURGE] = _("ElectroSurge"),

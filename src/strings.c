...
const u8 gText_TrainerCardLevelCap[] = _("Level cap");
...
const u8 gText_BattleTowerDesc[] = _("Central arena of the CIRCUIT.\nBring six for Double Battles!");
const u8 gText_BattleDomeDesc[] = _("Once home to grand tournaments.\nNow a CIRCUIT registration desk.");
const u8 gText_BattlePalaceDesc[] = _("A quiet palace by the water.\nRegister here for the CIRCUIT.");
const u8 gText_BattleArenaDesc[] = _("A gathering place for challengers.\nRegister here for the CIRCUIT.");
const u8 gText_BattleFactoryDesc[] = _("The old rental-battle facility.\nBring your own six to the CIRCUIT.");
const u8 gText_BattlePikeDesc[] = _("A familiar serpent-shaped hall.\nRegister here for the CIRCUIT.");
const u8 gText_BattlePyramidDesc[] = _("A landmark built for adventure.\nRegister here for the CIRCUIT.");

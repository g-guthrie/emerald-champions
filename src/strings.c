...
const u8 gText_ShopFree[] = _("Free");
const u8 gText_YouWantedVar1NoCharge[] = _("You wanted {STR_VAR_1}?\nThere's no charge. Will that be okay?");
const u8 gText_Var1AndYouWantedVar2NoCharge[] = _("{STR_VAR_1}? And you wanted {STR_VAR_2}?\nThere's no charge.");
...
const u8 gText_NextFusionMon[] = _("Choose a Pokémon to fuse with.");
...
const u8 gText_CantUseUntilNewBadge[] = _("This skill needs its license\nand the matching Badge.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_DoWhatWithPokemon[] = _("Do what with this Pokémon?");
...
const u8 gText_DelRegist[] = _("Delete");
...
const u8 gText_IsThisQuizOK[] = _("Is this quiz okay?");
...
const u8 gText_TrainerCardBadges[] = _("Badges");
const u8 gText_TrainerCardLeadersDefeated[] = _("Leaders defeated");
const u8 gText_TrainerCardMegasWitnessed[] = _("Megas witnessed");
const u8 gText_TrainerCardCircuitBestStreak[] = _("Circuit best streak");
const u8 gText_TrainerCardLevelCap[] = _("Badge Lv.");
...
const u8 gText_PokeblocksWithFriends[] = _("Pokéblocks w/Friends");
...
const u8 gText_BattleArenaDesc[] = _("The Battle Arena is closed.\nNo challenges are held here.");
...
const u8 gText_FrontierFacilityAreInelegible[] = _(" are ineligible");
...
const u8 gText_TheseThreePkmnOkay[] = _("Are these three Pokémon okay?");
const u8 gText_Yes2[] = _("Yes");
const u8 gText_No2[] = _("No");
const u8 gText_CantSelectSamePkmn[] = _("Choose a different Pokémon.");
...
const u8 gText_PkmnForSwap[] = _("Pokémon for Swap");
...
const u8 gText_SamePkmnInPartyAlready[] = _("That's already in your party.");

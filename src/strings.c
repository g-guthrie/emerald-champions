...
const u8 gText_LevelerNoEffect[] = _("Every Pokémon in the party is\nalready at the current level cap.{PAUSE_UNTIL_PRESS}");
...
const u8 gText_DifficultyMedium[] = _("{COLOR GREEN}{SHADOW LIGHT_GREEN}Medium");
...
const u8 gText_SavingVersionNum[] = _("E. Champs");

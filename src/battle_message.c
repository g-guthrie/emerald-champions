...
const u8 *const gBattleStringsTable[STRINGID_COUNT] =
{
    ...
    [STRINGID_PKMNGAINEDEXP]                        = COMPOUND_STRING("{B_BUFF1} gained\nExp. Points, and so did the team!\p"),
    ...
    [STRINGID_TEAMGAINEDEXP]                        = COMPOUND_STRING("{B_BUFF1} and {B_BUFF2} gained\nExp. Points, and so did the team!\p"),
    [STRINGID_ECTEAMGAINEDEXP]                      = COMPOUND_STRING("Your team gained Exp. Points!\p"),

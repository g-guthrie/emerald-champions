...
const struct RegionMapLocation gRegionMapEntries[] = {
    ...
    [MAPSEC_SEASPRAY_CAVE] = {
        .x = 0,
        .y = 4,
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("SEASPRAY CAVE"),
    },
    [MAPSEC_EMBER_PATH] = {
        .x = 6,
        .y = 3,
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("EMBER PATH"),
    },
    [MAPSEC_ASHEN_WOODS] = {
        .x = 6,
        .y = 3,
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("ASHEN WOODS"),
    },
    [MAPSEC_SANDSTREWN_RUINS] = {
        .x = 8,
        .y = 2,
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("SANDSTREWN RUINS"),
    },
    [MAPSEC_DEWFORD_MEADOW] = {
        ...
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("DEWFORD MEADOW"),
    },
    [MAPSEC_DEWFORD_MANOR] = {
        .x = 1,
        .y = 14,
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("DEWFORD MANOR"),
    },
    [MAPSEC_VERDANTURF_MEADOW] = {
        ...
        .width = 1,
        .height = 1,
        .name = COMPOUND_STRING("VERDANTURF MEADOW"),
    },
};

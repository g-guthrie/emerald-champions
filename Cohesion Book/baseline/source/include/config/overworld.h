...
#define OW_CHOOSE_FROM_PC_AND_PARTY     FALSE      // Keep field services in Emerald's native party-first flow; PC preparation remains available at the PC itself.
...
#define OW_PC_RELEASE_ITEM          GEN_3 // Preserve Inclement behavior.
...
// Trainer Rematches
#define OW_TRAINER_REMATCHES         FALSE // Emerald Champions uses the Battle Frontier, not Match Call escalation, for repeatable endgame battles.

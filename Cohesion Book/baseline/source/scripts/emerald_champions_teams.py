...
level cap and is materialized verbatim. At battle creation, ordinary field
doubles receive the badge-relative floor in src/difficulty.c before the global
difficulty offset. Gyms and the opening singles keep their authored levels.

...
[Regional experience](../06-sea-and-crisis.md) · [Map source](../../baseline/source/data/maps/ShoalCave_HighTideInnerRoom/map.json) · [Scripts](../../baseline/source/data/maps/ShoalCave_HighTideInnerRoom/scripts.inc)

## Current map contract

`MAP_SHOAL_CAVE_HIGH_TIDE_INNER_ROOM` · `LAYOUT_SHOAL_CAVE_HIGH_TIDE_INNER_ROOM` · `WEATHER_NONE` · `MUS_MT_PYRE`

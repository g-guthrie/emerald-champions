...
[Regional experience](../10-support.md) · [Map source](../../baseline/source/data/maps/UnusedContestHall6/map.json)

## Current map contract

`MAP_UNUSED_CONTEST_HALL6` · `LAYOUT_UNUSED_CONTEST_HALL6` · `WEATHER_NONE` · `MUS_GSC_PEWTER`

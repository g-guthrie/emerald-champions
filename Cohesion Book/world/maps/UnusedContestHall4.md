...
[Regional experience](../10-support.md) · [Map source](../../baseline/source/data/maps/UnusedContestHall4/map.json)

## Current map contract

`MAP_UNUSED_CONTEST_HALL4` · `LAYOUT_UNUSED_CONTEST_HALL4` · `WEATHER_NONE` · `MUS_GSC_PEWTER`

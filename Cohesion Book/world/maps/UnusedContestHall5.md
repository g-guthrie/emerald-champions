...
[Regional experience](../10-support.md) · [Map source](../../baseline/source/data/maps/UnusedContestHall5/map.json)

## Current map contract

`MAP_UNUSED_CONTEST_HALL5` · `LAYOUT_UNUSED_CONTEST_HALL5` · `WEATHER_NONE` · `MUS_GSC_PEWTER`

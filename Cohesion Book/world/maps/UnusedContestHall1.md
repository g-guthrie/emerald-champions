...
[Regional experience](../10-support.md) · [Map source](../../baseline/source/data/maps/UnusedContestHall1/map.json)

## Current map contract

`MAP_UNUSED_CONTEST_HALL1` · `LAYOUT_UNUSED_CONTEST_HALL1` · `WEATHER_NONE` · `MUS_GSC_PEWTER`

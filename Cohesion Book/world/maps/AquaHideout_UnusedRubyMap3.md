...
[Regional experience](../10-support.md) · [Map source](../../baseline/source/data/maps/AquaHideout_UnusedRubyMap3/map.json) · [Scripts](../../baseline/source/data/maps/AquaHideout_UnusedRubyMap3/scripts.inc)

## Current map contract

`MAP_AQUA_HIDEOUT_UNUSED_RUBY_MAP3` · `LAYOUT_AQUA_HIDEOUT_UNUSED_RUBY_MAP3` · `WEATHER_NONE` · `MUS_AQUA_MAGMA_HIDEOUT`

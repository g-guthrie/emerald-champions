...
[Regional experience](../10-support.md) · [Map source](../../baseline/source/data/maps/Route104_Prototype/map.json) · [Scripts](../../baseline/source/data/maps/Route104_Prototype/scripts.inc)

## Current map contract

`MAP_ROUTE104_PROTOTYPE` · `LAYOUT_ROUTE104_PROTOTYPE` · `WEATHER_SUNNY` · `MUS_ROUTE104`

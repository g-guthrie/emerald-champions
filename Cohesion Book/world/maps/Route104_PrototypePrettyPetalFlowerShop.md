...
[Regional experience](../10-support.md) · [Map source](../../baseline/source/data/maps/Route104_PrototypePrettyPetalFlowerShop/map.json) · [Scripts](../../baseline/source/data/maps/Route104_PrototypePrettyPetalFlowerShop/scripts.inc)

## Current map contract

`MAP_ROUTE104_PROTOTYPE_PRETTY_PETAL_FLOWER_SHOP` · `LAYOUT_ROUTE104_PRETTY_PETAL_FLOWER_SHOP` · `WEATHER_NONE` · `MUS_ROUTE104`

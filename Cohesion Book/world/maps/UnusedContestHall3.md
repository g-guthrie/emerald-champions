...
[Regional experience](../10-support.md) · [Map source](../../baseline/source/data/maps/UnusedContestHall3/map.json)

## Current map contract

`MAP_UNUSED_CONTEST_HALL3` · `LAYOUT_UNUSED_CONTEST_HALL3` · `WEATHER_NONE` · `MUS_GSC_PEWTER`
